package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         this.var_137 = new ByteArray();
         this.var_108 = 0;
         while(this.var_108 < this.psize)
         {
            _loc2_ = uint(65536 * Math.random());
            var _loc3_:* = this.var_108++;
            this.var_137[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            this.var_137[_loc4_ = this.var_108++] = _loc2_ & 255;
         }
         this.var_108 = 0;
         this.seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc2_:* = this.var_108++;
         this.var_137[_loc2_] ^= param1 & 255;
         var _loc3_:* = this.var_108++;
         this.var_137[_loc3_] ^= param1 >> 8 & 255;
         var _loc4_:*;
         this.var_137[_loc4_ = this.var_108++] = this.var_137[_loc4_] ^ param1 >> 16 & 255;
         var _loc5_:*;
         this.var_137[_loc5_ = this.var_108++] = this.var_137[_loc5_] ^ param1 >> 24 & 255;
         this.var_108 %= this.psize;
         this.var_2321 = true;
      }
      ...
      public function nextByte() : int
      {
         if(!this.ready)
         {
            ...
            this.state.init(this.var_137);
            this.var_137.length = 0;
            this.var_108 = 0;
            this.ready = true;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_137[_loc1_] = Math.random() * 256;
            _loc1_++;
         }
         this.var_137.length = 0;
         this.var_137 = null;
