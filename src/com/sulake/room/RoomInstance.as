package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_228.length)
            {
               _loc3_ = this.var_228.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1303.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1303.push(param1);
         }
      ...
      {
         if(this.var_1304.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1304.push(param1);
         }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_569.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_569[_loc2_]);
      ...
      {
         return this.var_228.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_228.getValue(_loc2_) != null)
         {
            return this.var_228.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_228.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_228.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_228.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_228.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
