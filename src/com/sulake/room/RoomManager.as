package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1005:int = 2;
      ...
      private var var_2710:IRoomContentLoader;
      
      private var var_596:IRoomObjectFactory = null;
      
      private var var_484:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1115:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_597 = [];
         this.var_569 = [];
         events.addEventListener(RoomContentLoadedEvent.const_320,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_473,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_680,this.onContentLoaded);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_112.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_112.getWithIndex(_loc2_) as IRoomInstance;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_596 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_596 == null || this.var_484 == null)
         {
            return;
         }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_597.indexOf(_loc5_) < 0)
            {
               this.var_47.loadObjectContent(_loc5_,events);
               this.var_597.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1005;
         return true;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_569.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_569.push(param1);
         var _loc3_:int = this.var_112.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_112.getWithIndex(_loc3_) as RoomInstance;
            if(_loc4_ != null)
            {
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         if(this.var_112.getValue(param1) != null)
         {
            return null;
         }
         var _loc3_:RoomInstance = new RoomInstance(param1,this);
         this.var_112.add(String(param1),_loc3_);
         var _loc4_:int = this.var_569.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_569[_loc4_];
      ...
      {
         return this.var_112.getValue(param1) as IRoomInstance;
      }
      
      public function disposeRoom(param1:String) : Boolean
      {
         var _loc2_:IRoomInstance = this.var_112.remove(param1) as IRoomInstance;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_484.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_484.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_596.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_596 != null)
         {
            return this.var_596.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_654)
         {
            return;
         }
         if(this.var_47 == null)
         {
            this._state = const_654;
            return;
         }
         if(this.var_47.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_597.indexOf(param1);
            if(_loc2_ >= 0)
            {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_47 == null || this.var_484 == null)
         {
            return;
         }
         ...
         var _loc5_:* = null;
         var _loc6_:int = this.var_112.length - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.var_112.getWithIndex(_loc6_) as RoomInstance;
            _loc8_ = this.var_112.getKey(_loc6_);
            if(_loc7_ != null)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_484.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_484.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_596.createRoomObjectLogic(_loc18_);
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_112.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = this.var_112.getWithIndex(_loc2_) as RoomInstance;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
