package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_597:Number = 64;
      
      public static const const_919:Number = 32;
      ...
      private var var_1784:Number = 1.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1125 = new Vector3d();
         this.var_1783 = 1;
         this.var_1782 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1784 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_75.x * this.var_391,this.var_75.y * this.var_393,this.var_75.z * this.var_392);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_241.x,this.var_241.y,this.var_241.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_391 != param1 * this.var_1783)
         {
            this.var_391 = param1 * this.var_1783;
            ++this.var_147;
         }
      }
      ...
      {
         if(this.var_393 != param1 * this.var_1782)
         {
            this.var_393 = param1 * this.var_1782;
            ++this.var_147;
         }
      }
      ...
      {
         if(this.var_392 != param1 * this.var_1784)
         {
            this.var_392 = param1 * this.var_1784;
            ++this.var_147;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_75.x /= this.var_391;
         this.var_75.y /= this.var_393;
         this.var_75.z /= this.var_392;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_241.x;
         var _loc3_:Number = this.var_241.y;
         var _loc4_:Number = this.var_241.z;
         this.var_241.assign(param1);
         if(this.var_241.x != _loc2_ || this.var_241.y != _loc3_ || this.var_241.z != _loc4_)
         {
            ++this.var_147;
         }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_494 != null)
         {
            ...
            this.var_494.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_494.add(_loc3_,_loc4_);
            ++this.var_147;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_494 != null)
         {
            ...
            return this.var_494.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1125.assign(_loc22_);
         }
         else
         {
            this.var_1125.assign(_loc17_);
         }
         ++this.var_147;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_391;
         _loc2_.y *= this.var_393;
         _loc2_.z *= this.var_392;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1125);
         if(_loc3_ < this.var_2676 || _loc3_ > this.var_2675)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_393;
            _loc2_.z *= this.var_392;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1125);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_75.x * this.var_391,this.var_75.y * this.var_393,this.var_75.z * this.var_392);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_159;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_391,param2.y * this.var_393,param2.z * this.var_392);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_391,param3.y * this.var_393,param3.z * this.var_392);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_391,param4.y * this.var_393,param4.z * this.var_392);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_919;
         }
         else
         {
            this.scale = const_597;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_597;
      }
