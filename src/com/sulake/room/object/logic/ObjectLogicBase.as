package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_327:IRoomObjectController;
      ...
      {
         if(this.var_327 == param1)
         {
            return;
         }
         if(this.var_327 != null)
         {
            this.var_327.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_327 = param1;
            this.var_327.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_327 != null)
            {
               this.var_327.setLocation(param1.loc);
               this.var_327.setDirection(param1.dir);
            }
         }
      }
   }
