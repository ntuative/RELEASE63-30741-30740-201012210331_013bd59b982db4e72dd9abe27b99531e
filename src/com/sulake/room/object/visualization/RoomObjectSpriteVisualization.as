package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_173.length > 0)
            {
               _loc1_ = this.var_173[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(this.var_173.length > param1)
         {
            _loc2_ = this.var_173[this.var_173.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_173.length)
         {
