package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1272:int = 128;
      
      private var var_1273:Boolean = false;
      
      private var var_2662:Point;
      ...
      {
         if(param1 != this.var_1599 || param2 != this.var_1598)
         {
      ...
      {
         if(this.var_1272 > 255 || bitmapData == null)
         {
            return false;
         }
