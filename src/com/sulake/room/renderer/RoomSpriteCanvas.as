package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_457:Point;
      
      private var var_226:BitmapDataCache;
      
      private var var_564:RoomObjectCache;
      
      private var var_458:Array;
      
      private var var_563:Array;
      
      private var var_1300:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2195:Number = -1.0E7;
      
      private var var_2193:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_225 = new Sprite();
         this.var_225.mouseEnabled = false;
         this.var_53 = new Sprite();
         this.var_53.name = "canvas";
         this.var_53.mouseEnabled = false;
         this.var_225.addChild(this.var_53);
         ...
         this.var_226 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         ...
         this.var_564 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_457.x -= param1 - this.var_561;
         this.var_561 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_457.y -= param1 - this.var_560;
         this.var_560 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_871 = true;
            if(this.var_119 != null && !this.var_225.contains(this.var_119))
            {
               this.var_225.addChild(this.var_119);
               this.var_53.mask = this.var_119;
            }
         }
         else if(!param1 && this.var_871)
         {
            this.var_871 = false;
            if(this.var_119 != null && this.var_225.contains(this.var_119))
            {
               this.var_225.removeChild(this.var_119);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_225.numChildren > 0)
            {
               this.var_225.removeChildAt(0);
            }
            this.var_225 = null;
         }
         this.var_53 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_563.length)
            {
               this.cleanSprite(this.var_563[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_563 = [];
         }
      ...
      {
         this.var_564.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(param1 == this.var_2194)
         {
            return;
         }
         this.var_226.compress();
         ...
         if(this.var_681 != this.var_2191 || this._ht != this.var_2192)
         {
            _loc9_ = true;
         }
         if(this.var_53.x != this.var_561 || this.var_53.y != this.var_560)
         {
            this.var_53.x = this.var_561;
            this.var_53.y = this.var_560;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_458.sortOn("z",0 | 0);
         if(_loc5_ < this.var_458.length)
         {
            this.var_458.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_458[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2191 = this.var_681;
         this.var_2192 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_564.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_564.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_561;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_560;
                  if(_loc19_ < this.var_681 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_458.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_561;
                     _loc17_.y = _loc20_ - this.var_560;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_563.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_682 || this.var_682 == 0)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_458.length)
         {
            return null;
         }
         return this.var_458[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_226.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_226.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_226.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            if(name.length > 0)
            {
               this.var_226.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_561;
         param2 -= this.var_560;
         this.var_457.x = param1;
         this.var_457.y = param2;
      ...
      {
         var _loc11_:Number = param1 - this.var_681 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1632,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_562.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_562.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2195 || param2 != this.var_2193)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_562.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_562.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_312 != null && param1 != null)
         {
            this.var_312.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_312 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_312.getKey(_loc1_);
            _loc3_ = this.var_312.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1300.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1045 == 0)
         {
            this.checkMouseHits(this.var_457.x,this.var_457.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1045 = 0;
         ++this.var_1632;
      }
