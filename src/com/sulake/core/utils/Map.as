package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_115)
            {
               delete this.var_115[_loc1_];
            }
            this.var_115 = null;
         }
         this._length = 0;
      ...
      {
         var _loc2_:Object = this.var_115[param1];
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         if(this._singleWrite)
         {
            if(this.var_115[param1] != null)
            {
               Core.error("Trying to write to a single write Map. Key: " + param1 + ", value: " + param2,true,Core.const_926);
            }
         }
         this.var_115[param1] = param2;
