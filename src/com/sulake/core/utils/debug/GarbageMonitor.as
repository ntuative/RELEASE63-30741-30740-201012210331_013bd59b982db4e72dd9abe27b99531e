package com.sulake.core.utils.debug
{
   ...
   public class GarbageMonitor implements IDisposable
   {
      ...
      {
         super();
         this.var_822 = new Dictionary(true);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for each(_loc1_ in this.var_822)
            {
               delete this.var_822[_loc1_];
            }
            this.var_822 = null;
            this._disposed = true;
         }
      ...
      {
         this.var_822[param1] = param2 == null ? param1.toString() : param2;
      }
      ...
      public function get list() : Array
      {
         ...
         for each(_loc2_ in this.var_822)
         {
            _loc1_.push(_loc2_);
         }
         return _loc1_;
