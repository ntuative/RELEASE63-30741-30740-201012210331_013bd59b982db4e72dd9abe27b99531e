package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1149:Map = new Map();
      
      private static var var_749:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_749.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_749.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_749.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_749.remove(param1);
         var_749.add(param1,param2);
      }
      
      public static function setParameter(param1:String, param2:String) : void
      {
         var_1149[param1] = param2;
      }
