package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      public static const const_728:String = "WKE_KEY_UP";
      ...
      private var var_720:KeyboardEvent;
      ...
      {
         _type = param1;
         this.var_720 = KeyboardEvent(param2);
         super(param1,param3,param4,param5,false);
      }
      
      public function get charCode() : uint
      {
         return this.var_720.charCode;
      }
      
      public function get keyCode() : uint
      {
         return this.var_720.keyCode;
      }
      
      public function get keyLocation() : uint
      {
         return this.var_720.keyLocation;
      }
      
      public function get altKey() : Boolean
      {
         return this.var_720.altKey;
      }
      
      public function get shiftKey() : Boolean
      {
         return this.var_720.shiftKey;
      }
      
      override public function clone() : Event
      {
         return new WindowKeyboardEvent(_type,this.var_720,window,related,bubbles,cancelable);
      }
