package com.sulake.core.window.services
{
   ...
   public class WindowToolTipAgent extends WindowMouseOperator implements IToolTipAgentService
   {
      ...
      {
         this.var_1175 = new Point();
         this.var_1173 = new Point(20,20);
         this.var_1429 = 500;
         super(param1);
      }
      ...
      override public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         if(param1 && !param1.disposed)
         {
            ...
            getMousePositionRelativeTo(param1,_mouse,this.var_1175);
      ...
      override public function operate(param1:int, param2:int) : void
      {
         if(_window && true)
         {
            _mouse.x = param1;
            _mouse.y = param2;
            getMousePositionRelativeTo(_window,_mouse,this.var_1175);
            if(this.var_254 != null && !this.var_254.disposed)
            {
               this.var_254.x = param1 + this.var_1173.x;
               this.var_254.y = param2 + this.var_1173.y;
            }
         }
      }
      ...
      protected function showToolTip(param1:TimerEvent) : void
      {
         ...
         if(_window && true)
         {
            if(this.var_254 == null || this.var_254.disposed)
            {
               this.var_254 = _window.context.create("undefined::ToolTip",this.var_1174,WindowType.const_378,_window.style,0 | 0,null,null,null,0,null,null) as IToolTipWindow;
            }
            _loc2_ = new Point();
            _window.getGlobalPosition(_loc2_);
            this.var_254.x = _loc2_.x + this.var_1175.x + this.var_1173.x;
            this.var_254.y = _loc2_.y + this.var_1175.y + this.var_1173.y;
         }
      }
