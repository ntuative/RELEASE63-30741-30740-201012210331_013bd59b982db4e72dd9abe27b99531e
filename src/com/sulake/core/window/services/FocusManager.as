package com.sulake.core.window.services
{
   ...
   public class FocusManager extends ChildEntityArrayReader implements IFocusManagerService
   {
      ...
      public function FocusManager(param1:DisplayObject)
      {
         ...
         this.var_190.addEventListener(Event.ACTIVATE,this.onActivateEvent);
         this.var_190.addEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
         this.var_190.addEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
         this.var_190.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
         super();
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            this.var_190.removeEventListener(Event.ACTIVATE,this.onActivateEvent);
            this.var_190.removeEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
            this.var_190.removeEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
            this.var_190.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
            this.var_190 = null;
            this._disposed = true;
            var_31 = null;
         }
