package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_628);
         this._window.offset(this.var_628.x - this._offset.x,this.var_628.y - this._offset.y);
      }
