package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_344:String = "regular";
      ...
      private static var var_216:IEventDispatcher;
      
      private static const TAG_OPEN:String = "{";
      
      private static const const_554:String = "}";
      
      private static const const_1208:String = "/*";
      
      private static const const_1209:String = "*/";
      ...
      private static function init() : void
      {
         var _loc1_:* = null;
         var_82 = new Map();
         var_216 = new EventDispatcher();
         _loc1_ = new TextStyle();
         _loc1_.name = const_344;
         _loc1_.color = 0;
         _loc1_.fontSize = "9";
      ...
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            var_216.dispatchEvent(new Event(Event.ADDED));
         }
         else
         {
            var_216.dispatchEvent(new Event(Event.CHANGE));
         }
      }
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_82[const_344],var_82[ITALIC],var_82[BOLD]];
            var_82.reset();
            var_82[const_344] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         {
            while(_loc5_.indexOf(const_1208) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1209) + 2,_loc5_.length);
            }
