package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1010:String = "_EXCLUDE";
      
      public static const const_1593:String = "_INCLUDE";
      
      public static const const_1643:String = "_TEMP";
      
      private static const const_1142:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1143:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1168);
         this.var_937 = new Dictionary();
         this.var_1424 = new Dictionary();
         ParamCodeTable.fillTables(this.var_937,this.var_1424);
         this.var_1887 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1143,"");
         return param1.replace(const_1142,"");
      }
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         name = unescape(this.method_1(xml,"name",variables));
         style = uint(this.method_1(xml,"style",variables,style.toString()));
         params = uint(this.method_1(xml,"params",variables,params.toString()));
         tag = unescape(this.method_1(xml,"tags",variables,tag));
         rect = new Rectangle();
         rect.x = Number(this.method_1(xml,"x",variables,"0"));
         rect.y = Number(this.method_1(xml,"y",variables,"0"));
         rect.width = Number(this.method_1(xml,"width",variables,"0"));
         rect.height = Number(this.method_1(xml,"height",variables,"0"));
         visible = this.method_1(xml,"visible",variables,visible.toString()) == "true";
         caption = unescape(this.method_1(xml,"caption",variables,caption));
         id = int(this.method_1(xml,"id",variables,id.toString()));
         if(xml.child("params").length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.method_1(node,"name",variables) as String;
               if(this.var_937[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute("name")) + "\"!");
               }
               params |= this.var_937[param];
               i++;
            }
         }
         if(tag != "")
         ...
         window.limits.minWidth = int(this.method_1(xml,"width_min",variables,String(int.MIN_VALUE)));
         window.limits.maxWidth = int(this.method_1(xml,"width_max",variables,String(int.MAX_VALUE)));
         window.limits.minHeight = int(this.method_1(xml,"height_min",variables,String(int.MIN_VALUE)));
         window.limits.maxHeight = int(this.method_1(xml,"height_max",variables,String(int.MAX_VALUE)));
         background = this.method_1(xml,"background",variables,window.background.toString()) == "true";
         blend = Number(this.method_1(xml,"blend",variables,window.blend.toString()));
         clipping = this.method_1(xml,"clipping",variables,window.clipping.toString()) == "true";
         color = this.method_1(xml,"color",variables,window.color.toString());
         treshold = uint(this.method_1(xml,"treshold",variables,window.mouseTreshold.toString()));
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1168[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1010) == -1)
                  {
      ...
      private function buildBitmapFilter(param1:XML) : BitmapFilter
      {
         ...
         switch(_loc2_)
         {
            case "DropShadowFilter":
               _loc3_ = new DropShadowFilter(Number(this.method_1(param1,"distance",null,"0")),Number(this.method_1(param1,"angle",null,"45")),uint(this.method_1(param1,"color",null,"0")),Number(this.method_1(param1,"alpha",null,"1")),Number(this.method_1(param1,"blurX",null,"0")),Number(this.method_1(param1,"blurY",null,"0")),Number(this.method_1(param1,"strength",null,"1")),int(this.method_1(param1,"quality",null,"1")),Boolean(this.method_1(param1,"inner",null,"false") == "true"),Boolean(this.method_1(param1,"knockout",null,"false") == "true"),Boolean(this.method_1(param1,"hideObject",null,"false") == "true"));
         }
         return _loc3_;
      }
   }
