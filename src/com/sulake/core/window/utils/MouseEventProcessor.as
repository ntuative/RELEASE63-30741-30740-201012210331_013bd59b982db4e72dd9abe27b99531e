package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_167;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_77 = param1.var_1162 as WindowController;
         this._lastClickTarget = param1.var_1160 as WindowController;
         this.var_136 = param1.renderer;
         this.var_766 = param1.var_1159;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_626.x || _loc3_.stageY != this.var_626.y)
            {
               this.var_626.x = _loc3_.stageX;
               this.var_626.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_129.groupParameterFilteredChildrenUnderPoint(this.var_626,_loc6_,WindowParam.const_28);
            }
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_77 && !this.var_77.disposed)
                     {
                        ...
                        {
                           this.var_766.mouseEventReceived(_loc3_.type,this.var_77);
                        }
                     }
                  }
         ...
         param1.var_1162 = this.var_77;
         param1.var_1160 = this._lastClickTarget;
         param1.renderer = this.var_136;
         param1.var_1159 = this.var_766;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_518))
         {
