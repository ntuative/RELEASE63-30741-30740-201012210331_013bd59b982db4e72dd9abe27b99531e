package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1245:String = "_SELECTOR";
      
      private static const const_1246:String = "_CONTENT";
       
      
      protected var var_942:ITabSelectorWindow;
      
      protected var var_1907:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_942 = findChildByTag(const_1245) as ITabSelectorWindow;
            if(this.var_942 != null)
            {
               this.var_942.procedure = this.selectorEventProc;
            }
         }
         return this.var_942;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1907 = findChildByTag(const_1246) as IWindowContainer;
         }
      ...
      {
         return !!this.var_735 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_942.numSelectables;
      }
