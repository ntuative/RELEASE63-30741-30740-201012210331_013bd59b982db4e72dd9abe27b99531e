package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const const_1129:String = "_CONTROLS";
      ...
      {
         return findChildByTag(const_1130) as ITextWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(const_1129) as IItemListWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1123,_loc2_,true);
