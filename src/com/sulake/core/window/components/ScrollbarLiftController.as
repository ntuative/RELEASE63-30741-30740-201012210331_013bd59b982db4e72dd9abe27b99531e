package com.sulake.core.window.components
{
   ...
   public class ScrollbarLiftController extends InteractiveController implements IDragBarWindow
   {
      ...
      {
         if(param2.type == WindowNotifyEvent.const_432)
         {
            this._offsetX = x != 0 ? Number(x / Number(0 - width)) : Number(0);
            this.var_1097 = y != 0 ? Number(y / Number(0 - height)) : Number(0);
            if(var_13 != this._scrollBar)
            {
               this._scrollBar.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_298,this,null));
            }
         }
