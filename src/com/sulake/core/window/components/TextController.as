package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1120:Dictionary = createPropertySetterTable();
      ...
      protected static const const_1528:Array = [GridFitType.PIXEL,GridFitType.NONE,GridFitType.SUBPIXEL];
      ...
      protected var var_413:String = "none";
      
      protected var var_511:Boolean = false;
      
      private var var_1242:Boolean = false;
      
      private var var_368:String = "regular";
      
      private var var_194:TextStyle;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_368,this.var_194);
      ...
      private static function setAntiAliasType(param1:TextController, param2:String) : void
      {
         ...
         param1.var_194.antiAliasType = param2;
      ...
      private static function setBold(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.var_194.fontWeight = TextStyle.BOLD;
      }
      ...
      private static function setFontFace(param1:TextController, param2:String) : void
      {
         ...
         param1.defaultTextFormat = _loc3_;
         param1.var_194.fontFamily = param2;
      }
      ...
      private static function setFontSize(param1:TextController, param2:uint) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_194.fontSize = param2;
      }
      ...
      private static function setItalic(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_194.fontStyle = !!param2 ? "null" : TextStyle.NORMAL;
      }
      ...
      private static function setSpacing(param1:TextController, param2:Number) : void
      {
         ...
         param1.setTextFormat(_loc4_);
         param1.defaultTextFormat = _loc3_;
         param1.var_194.letterSpacing = param2;
      }
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_368 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_368,param1.var_194);
            param1.refreshTextImage();
         }
      }
      ...
      private static function setUnderline(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_194.textDecoration = !!param2 ? "null" : TextStyle.NONE;
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_344);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_1008 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_368);
      }
      ...
      {
         this.var_767 = param1;
         this._field.scrollH = this.var_767 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_767 * this.maxScrollH,this.var_509 * this.maxScrollV,width,height);
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!this.var_510)
         {
            if(param2.type == WindowNotifyEvent.const_163)
            {
               this.refreshTextImage();
            }
         }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(this.var_413 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
            else if(this.var_413 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
            else if(this.var_413 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(this.var_413 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:Object = TextStyleManager.getStyle(this.var_368);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_275,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(new PropertyStruct("text_color",this._field.textColor,PropertyStruct.const_162,this._field.textColor != _loc2_.color));
         _loc1_.push(new PropertyStruct("antialias_type",this._field.antiAliasType,PropertyStruct.const_89,this._field.antiAliasType != AntiAliasType.ADVANCED,const_1527));
         ...
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_162,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",this._field.gridFitType,PropertyStruct.const_89,this._field.gridFitType != GridFitType.PIXEL,const_1528));
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_53,this._field.maxChars != 0));
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_224,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("text_style",this.var_368,PropertyStruct.const_89,this.var_368 != TextStyleManager.const_344,STYLE_SHEET_RANGE));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_224,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_50,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("margin_left",this.var_78.left,PropertyStruct.const_53,this.var_78.left != 0));
         _loc1_.push(new PropertyStruct("margin_top",this.var_78.top,PropertyStruct.const_53,this.var_78.top != 0));
         _loc1_.push(new PropertyStruct("margin_right",this.var_78.right,PropertyStruct.const_53,this.var_78.right != 0));
         _loc1_.push(new PropertyStruct("margin_bottom",this.var_78.bottom,PropertyStruct.const_53,this.var_78.bottom != 0));
         _loc1_.push(new PropertyStruct("auto_size",this.var_413,PropertyStruct.const_89,this.var_413 != TextFieldAutoSize.NONE,const_1526));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_224,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
