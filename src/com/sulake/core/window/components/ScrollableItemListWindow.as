package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1052:IItemListWindow;
      
      private var var_377:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_71))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_377)
         {
            this.var_377.removeEventListener(WindowEvent.const_269,this.scrollBarEventProc);
            this.var_377.removeEventListener(WindowEvent.const_208,this.scrollBarEventProc);
            this.var_377 = null;
         }
         if(this.var_1052)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1052)
         {
            this.var_1052 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_377)
         {
            this.var_377 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_377)
            {
               this.var_377.addEventListener(WindowEvent.const_269,this.scrollBarEventProc);
               this.var_377.addEventListener(WindowEvent.const_208,this.scrollBarEventProc);
            }
         }
         return this.var_377;
      }
