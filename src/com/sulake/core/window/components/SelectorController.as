package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      {
         if(param2.type == WindowNotifyEvent.const_218)
         {
         ...
         if(param1 != null)
         {
            if(param1 != this.var_182)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_337,this,this.var_182));
               }
            }
         }
      }
      ...
      {
         return method_2(param1) as ISelectableWindow;
      }
