package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1140:String = "_HEADER";
      
      private static const const_1141:String = "_CONTENT";
      
      private static const const_1139:String = "_SCALER";
      
      private static const const_832:String = "margin_left";
      
      private static const const_833:String = "margin_top";
      
      private static const const_835:String = "margin_right";
      
      private static const const_834:String = "margin_bottom";
       
      
      private var _title:ITextWindow;
      
      private var var_1218:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1218 = findChildByTag(const_1140) as IHeaderWindow;
            if(!this.var_1218)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_154 = findChildByTag(const_1141) as IWindowContainer;
            if(!this.var_154)
            {
      ...
      {
         return findChildByTag(const_1139) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1123,_loc2_,false);
      ...
      {
         return this.content != null && this.var_940 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_280);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_206);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_217);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_206,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_206,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_833,_loc3_.top,PropertyStruct.const_53,_loc2_));
         _loc1_.push(new PropertyStruct(const_835,0 - _loc3_.right,PropertyStruct.const_53,_loc2_));
         _loc1_.push(new PropertyStruct(const_834,0 - _loc3_.bottom,PropertyStruct.const_53,_loc2_));
         return _loc1_;
      }
