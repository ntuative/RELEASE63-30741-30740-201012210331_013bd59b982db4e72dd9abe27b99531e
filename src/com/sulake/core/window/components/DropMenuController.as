package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_1126:String = "_DROPMENU_ITEMLIST";
      ...
      private var var_619:int = -1;
      
      private var var_918:Boolean = false;
      
      private var var_167:DropMenuController;
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_487,this,null,true);
         this.update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_619 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_337,this,null));
         }
      }
      ...
      {
         if(this.var_167 != null && !this.var_167.disposed)
         {
            this.var_167.destroy();
            this.var_167 = null;
         }
         super.dispose();
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_167 == null || this.var_167.disposed)
         {
            this.var_167 = context.create(name + "::submenu","",WindowType.const_412,var_79,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_167.setGlobalRectangle(_loc1_);
         }
         this.var_167.activate();
         return this.var_167;
      }
      ...
      {
         var _loc2_:int = -1;
         var _loc3_:IItemListWindow = getChildByName(DropMenuController.const_1126) as IItemListWindow;
         if(_loc3_ != null)
         {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_167.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_918 = false;
            this.getTitleText().text = this.var_619 < this._itemArray.length && this.var_619 > -1 ? this._itemArray[this.var_619] : caption;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IItemListWindow = param2.getChildByName(DropMenuController.const_1126) as IItemListWindow;
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_413,var_79,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_363,var_79,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_619 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_619).setStateFlag(WindowState.const_47,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_39 || param1.type == WindowTouchEvent.const_484)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_55:
               ...
               break;
            case WindowTouchEvent.const_564:
            case WindowMouseEvent.const_39:
               ...
               break;
            case WindowEvent.const_985:
               if(param2 == this.var_167)
               {
                  this.closeMenuView();
               }
         }
      ...
      public function open() : Boolean
      {
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_928;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_933,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         visible = false;
         _loc1_.type = WindowNotifyEvent.const_1114;
         this.update(this,_loc1_);
         return true;
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1125,this._itemArray,PropertyStruct.const_156,this._itemArray.length > 0));
         return _loc1_;
      }
