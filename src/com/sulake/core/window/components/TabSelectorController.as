package com.sulake.core.window.components
{
   ...
   public class TabSelectorController extends SelectorController implements ITabSelectorWindow
   {
      ...
      {
         if(param2.type == WindowNotifyEvent.const_352)
         {
            this.updateSelectableRegion();
         }
         ...
         else if(param2.type == WindowNotifyEvent.const_298)
         {
            this.updateSelectableRegion();
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("spacing",this._spacing,PropertyStruct.const_53,this._spacing != 0));
         return _loc1_;
      }
