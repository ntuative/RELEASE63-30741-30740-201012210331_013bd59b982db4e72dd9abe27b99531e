package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected static const const_1117:String = "spacing";
      
      protected static const const_1119:String = "scale_to_fit_items";
      
      protected static const const_1116:String = "resize_on_item_update";
      
      protected static const const_1118:String = "auto_arrange_items";
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1524:Boolean = false;
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1525:Boolean = true;
       
      
      protected var var_623:Number;
      
      protected var var_624:Number;
      ...
      protected var var_2688:Number = 0.0;
      
      protected var var_2687:Number = 0.0;
      
      protected var var_936:Boolean = true;
      
      protected var var_507:Boolean = false;
      
      protected var var_1165:Boolean = false;
      
      protected var var_1886:int = 0;
      
      protected var var_1884:int = 0;
      
      protected var var_1166:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_98 = 0;
         this.var_90 = 0;
         this._horizontal = param2 == WindowType.const_323;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_151 = var_420 || !testParamFlag(WindowParam.const_31);
         this._container = var_16.create("_CONTAINER","",WindowType.const_363,WindowStyle.const_701,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_45,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_511,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_273,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_423,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_1165;
      }
      ...
      {
         return new Rectangle(this.var_623 * this.maxScrollH,this.var_624 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_623 = param1;
            this._container.x = -this.var_623 * this.maxScrollH;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_72);
            dispatchEvent(new WindowEvent(WindowEvent.const_470,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_624 = param1;
            this._container.y = -this.var_624 * this.maxScrollV;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_72);
            dispatchEvent(new WindowEvent(WindowEvent.const_470,this,null));
         }
      }
      ...
      {
         this.var_2688 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2687 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_398,param1);
            }
            else
            {
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_511,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_273,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_423,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_183:
               if(this.var_1163)
               {
                  this.var_1166 = this.var_1886 - _loc3_;
                  this.var_1164 = this.var_1884 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1166 != 0 && this.var_98 != 0)
                     {
                        this.scrollH += this.var_1166 / this.var_98;
                     }
                  }
            ...
            case WindowMouseEvent.const_167:
               if(this.var_1163)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1166,0);
                  }
                  else
                  {
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_936 && !this.var_508 && this._container)
         {
            this.var_508 = true;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1117,this._spacing,PropertyStruct.const_53,this._spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1118,this.var_936,PropertyStruct.const_50,this.var_936 != const_1525));
         _loc1_.push(new PropertyStruct(const_1119,this.var_507,PropertyStruct.const_50,this.var_507 != const_1524));
         _loc1_.push(new PropertyStruct(const_1116,this.var_1165,PropertyStruct.const_50,this.var_1165 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1116:
                  ...
                  break;
               case const_1118:
                  this.var_936 = _loc2_.value as Boolean;
                  break;
            }
         }
