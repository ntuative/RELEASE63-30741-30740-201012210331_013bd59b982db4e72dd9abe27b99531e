package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected var var_770:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_634 = _loc13_.blend;
            var_419 = _loc13_.treshold;
            if(var_420 != _loc13_.background)
            {
      ...
      public static function resizeToAccommodateChildren(param1:WindowController, param2:Boolean = true) : void
      {
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  _loc12_ = param1.testParamFlag(WindowParam.const_88);
                  if(_loc12_)
                  {
      ...
      {
         return this.var_770 != null ? this.var_770 : (this.var_13 != null ? this.var_13.procedure : this.nullEventProc);
      }
      ...
      {
         var_420 = param1;
         var_218 = !!var_420 ? uint(var_218 | var_516) : uint(var_218 & 16777215);
      ...
      {
         var_775 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_521,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_516 = param1 & 4278190080;
         var_218 = !!var_420 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_72);
      }
      ...
      {
         var_516 = param1 << 24;
         var_218 = !!var_420 ? uint(var_516 | var_218) : uint(16777215 & var_218);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_72);
      }
      
      public function set blend(param1:Number) : void
      {
         var_634 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_1048);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_475,this,null));
         }
      }
      ...
      {
         var_419 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this.var_13 != param1)
         {
            ...
            if(this.var_13 != null)
            {
               this.var_316 = this.var_13.rectangle.clone();
               var_56.x = var_11.x;
               var_56.y = var_11.y;
               var_56.width = var_11.width;
               var_56.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_460,this,this.var_13));
            }
            else
            {
               this.var_316.x = 0;
               this.var_316.y = 0;
               this.var_316.width = 0;
               this.var_316.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_987,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_811,var_11);
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_79,var_20,var_16,var_11,null,this.var_770,this.properties,var_774.concat(),_id) as WindowController;
         _loc2_.var_419 = var_419;
         _loc2_.var_151 = this.var_151;
         _loc2_._debug = this._debug;
         _loc2_.var_316 = this.var_316.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2238 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_396)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_416)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_971,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_801,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_432,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_163,this,null));
            }
         }
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_39:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1013;
                  ...
                  if((var_20 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_280))
                        {
               ...
               case WindowMouseEvent.const_55:
                  ...
                  if(testParamFlag(WindowParam.const_280))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_163:
                  var_16.invalidate(this,var_11.union(var_56),WindowRedrawFlag.RESIZE);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_455,this,null));
                     if(testParamFlag(WindowParam.const_171,WindowParam.const_151))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_185,WindowParam.const_155))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this.var_13 != null)
                  ...
                  break;
               case WindowNotifyEvent.const_432:
                  var_16.invalidate(this,var_11.union(var_56),WindowRedrawFlag.const_512);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1041,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_298,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_351:
                  if(param1 == this)
                  {
                     ...
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_218,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_475:
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_1009);
                  break;
               ...
               case WindowNotifyEvent.const_521:
                  if(!(var_20 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_16.invalidate(this,var_11,WindowRedrawFlag.const_512);
                     }
                  }
                  else if(var_20 & 0)
                  {
               ...
               case WindowNotifyEvent.const_455:
                  this.var_13.getRegionProperties(null,this.var_316);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1255:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1283:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_625:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1063:
               _loc2_ = "null";
               _loc4_ = true;
               break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_419);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_419);
      }
         ...
         if(this.var_151 && var_419 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1323,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1323,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_125,WindowParam.const_151);
         var _loc2_:* = !testParamFlag(WindowParam.const_117,WindowParam.const_155);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this.var_13.width - this.var_316.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this.var_13.height - this.var_316.height;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_349)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_380)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_462)
         {
            return true;
         }
         _state = WindowState.const_462;
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1033,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_351;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1072;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1063,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_610;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_590;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1038;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1107,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_898;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1324 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_352,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1324 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function method_2(param1:String) : IWindow
      {
         var _loc2_:* = null;
         for each(_loc2_ in this._children)
         {
      ...
      {
         if(var_774.indexOf(param1) > -1)
         {
            return this;
         }
         var _loc2_:WindowController = WindowController(this.method_2(param1));
         if(_loc2_ == null)
         {
            for each(_loc2_ in this._children)
            {
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_813,this,param1));
         return param1;
      }
