package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1573 = new Point();
         this.var_1263 = new Rectangle();
         this.var_269 = new Rectangle();
         this.var_306 = new Dictionary(true);
         this.var_790 = param1;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_664 = null;
            for(_loc1_ in this.var_306)
            {
               delete this.var_306[_loc1_];
            }
            this.var_306 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.getWindowRendererItem(param1).invalidate(param1,this.var_269,WindowRedrawFlag.const_1092);
            if(this.var_664.indexOf(param1) == -1)
            {
               this.var_664.push(param1);
            }
         }
      }
      ...
      {
         var _loc2_:WindowRendererItem = this.var_306[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_306[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_790);
            this.var_306[param1] = _loc2_;
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_664.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_664.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               ...
               this.renderWindowBranch(_loc1_,this.var_269,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1573,this.var_1263))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1573,this.var_1263))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_31))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1263);
