package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1477:uint = 0;
      
      public static const const_811:uint = 1;
      
      public static const const_913:uint = 2;
      
      public static const const_569:uint = 4;
      
      public static const const_1447:uint = 8;
      
      public static const const_1512:uint = 16;
      
      public static const const_1788:uint = 64;
      
      public static const const_1617:uint = 128;
      
      public static const const_973:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_913:
               ...
               break;
            case GraphicContext.const_1447:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1512:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_569:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_973:
               break;
            case GraphicContext.const_1477:
               break;
            default:
         ...
         if(this.var_771)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1895,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1895,16777215);
                  }
                  var_292 += bitmap.width * bitmap.height * 4;
               }
