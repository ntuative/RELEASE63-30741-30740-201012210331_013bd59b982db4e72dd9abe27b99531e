package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_864:uint = 8;
      
      private static const const_1217:String = "skin";
      
      private static const const_1219:String = "bitmap";
      
      private static const const_1218:String = "fill";
      
      private static const const_1215:String = "text";
      
      private static const const_1216:String = "shape";
      
      private static const const_1214:String = "unknown";
      
      private static const const_1213:String = "null";
      ...
      private var var_2324:Dictionary;
      
      private var var_2323:Dictionary;
      
      private var var_2322:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2324 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1707,this.var_2324);
         this.var_2323 = new Dictionary();
         this.var_2322 = new Dictionary();
         StateCodeTable.fillTables(this.var_2323,this.var_2322);
         this.var_470 = new Dictionary();
         this.var_470[const_1217] = BitmapSkinRenderer;
         this.var_470[const_1219] = BitmapDataRenderer;
         this.var_470[const_1218] = FillSkinRenderer;
         this.var_470[const_1215] = TextSkinRenderer;
         this.var_470[const_1216] = ShapeSkinRenderer;
         this.var_470[const_1214] = SkinRenderer;
         this.var_470[const_1213] = NullSkinRenderer;
         if(var_291 == null)
         {
            var_291 = new Array();
            var_291.push(WindowState.const_64);
            var_291.push(WindowState.const_71);
            var_291.push(WindowState.const_83);
            var_291.push(WindowState.const_47);
            var_291.push(WindowState.WINDOW_STATE_HOVERING);
            var_291.push(WindowState.const_76);
            var_291.push(WindowState.const_99);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1707[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_868[param1] == null)
         {
            this.var_868[param1] = new Array(const_864);
         }
         this.var_868[param1][param2] = param3;
         if(this.var_867[param1] == null)
         {
            this.var_867[param1] = new Array(const_864);
         }
         this.var_867[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_868[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_867[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_285)
