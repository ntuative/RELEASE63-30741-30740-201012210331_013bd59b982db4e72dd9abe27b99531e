package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_351:Dictionary;
      
      protected var _templatesByState:Dictionary;
      
      protected var var_513:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_513)
            {
               ISkinLayout(this.var_513[_loc1_]).dispose();
               delete this.var_513[_loc1_];
            }
            this.var_513 = null;
            this.var_414 = null;
            for(_loc1_ in this.var_351)
            {
               ISkinTemplate(this.var_351[_loc1_]).dispose();
               delete this.var_351[_loc1_];
            }
            this.var_351 = null;
      ...
      {
         return this.var_414[param1] != null;
      }
      ...
      {
         var _loc3_:ISkinTemplate = this.var_351[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_513[param1.name] = param1;
         return param1;
      }
      
      public function getLayoutByName(param1:String) : ISkinLayout
      {
         return this.var_513[param1];
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_351[param1.name];
         if(param1 != null)
         {
            for(_loc2_ in this.var_414)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_414[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_513[param1.name];
         }
         return param1;
      }
      ...
      {
         this.var_351[param1.name] = param1;
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_351[param1.name];
         }
         return param1;
      }
   }
