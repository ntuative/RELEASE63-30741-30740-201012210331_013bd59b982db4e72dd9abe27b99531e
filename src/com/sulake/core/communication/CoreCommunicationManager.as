package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1545:IConnectionStateListener;
      ...
      override public function dispose() : void
      {
         ...
         this.var_997 = null;
         this.var_1545 = null;
         for each(_loc2_ in this.var_810)
         {
            while(true)
            {
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_964:
               _loc3_ = new SocketConnection(param1,this,this.var_1545);
               break;
            default:
      ...
      {
         var _loc3_:Array = this.var_810[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_810[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = this.var_810[_loc3_];
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in this.var_1239)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
