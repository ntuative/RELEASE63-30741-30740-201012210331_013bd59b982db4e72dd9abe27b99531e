package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1153:String = "service-libraries";
      
      private static const const_1152:String = "library";
      
      private static const const_1159:String = "component-libraries";
      
      private static const const_1156:String = "library";
      
      private static const const_1158:String = "error_data";
      
      private static const const_1155:String = "error_cat";
      
      private static const const_1151:String = "error_desc";
       
      
      private var var_301:LibraryLoaderQueue;
      
      private var var_654:IEventDispatcher;
      
      private var var_438:uint;
      
      private var var_437:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         {
            this.var_436.push(new Array());
            this.var_536.push(0);
            _loc3_++;
         }
         this.var_1515 = getTimer();
         attachComponent(this,[new IIDCore()]);
         var_415.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            case Core.const_1079:
               debug("Core; using simple frame update handler");
               this.var_437 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_754:
               debug("Core; using complex frame update handler");
               this.var_437 = this.complexFrameUpdateHandler;
               break;
            case Core.const_1418:
               debug("Core; using profiler frame update handler");
               this.var_437 = this.profilerFrameUpdateHandler;
               this.var_221 = new Profiler(this);
               attachComponent(this.var_221,[new IIDProfiler()]);
               var_415.addChild(new ProfilerViewer(this.var_221));
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_437 = this.debugFrameUpdateHandler;
         }
      }
      
      public function getNumberOfFilesPending() : uint
      {
         return this.var_301.length;
      }
      
      public function getNumberOfFilesLoaded() : uint
      {
         return this.var_438 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            while(_loc3_ < CoreComponentContext.const_140)
            {
               _loc2_ = this.var_436[_loc3_] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1158,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1155,String(param3));
         ErrorReportStorage.setParameter(const_1151,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_654 = loadingEventDelegate;
         if(this.var_301 == null)
         {
            this.var_301 = new LibraryLoaderQueue(_debug);
         }
         try
         {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_287,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_287,e);
         }
         try
         {
            node = config.child(const_1159)[0];
            if(node != null)
            {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_287,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1363);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_654)
         {
            this.var_654.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_654)
         {
            ...
            this.var_654.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_654)
                  {
                     this.var_654.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_438 - this.var_301.length,this.var_438,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = this.var_436[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = this.var_436[_loc4_] as Array;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_437(_loc2_,_loc2_ - this.var_1515);
         this.var_1515 = _loc2_;
      }
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_536[criticality] = 0;
            receivers = this.var_436[criticality];
            index = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(criticality < CoreComponentContext.const_140)
         {
            ...
            {
               if(this.var_536[criticality] < criticality)
               {
                  ++this.var_536[criticality];
                  skip = true;
               }
            }
            if(!skip)
