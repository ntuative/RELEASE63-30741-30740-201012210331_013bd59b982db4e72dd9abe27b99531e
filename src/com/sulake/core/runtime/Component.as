package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_381:String = "_INTERNAL_EVENT_UNLOCKED";
      ...
      public static const const_1053:uint = 4;
       
      
      protected var var_684:uint = 0;
      ...
      private var var_454:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_454 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_454.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_454.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1170 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1170);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1431 & const_1053)
         {
            if(_loc3_ == 0)
            {
               if(this.var_454.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_838 = false;
            this._events.dispatchEvent(new LockEvent(const_381,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_684 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_454.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_454.getStructByIndex(_loc8_);
