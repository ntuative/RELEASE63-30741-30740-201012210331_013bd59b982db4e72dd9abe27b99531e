package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_514:Array;
      
      protected var var_939:LoaderContext;
      
      protected var var_416:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_939 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_416 = new AssetLibrary("lib-" + this.var_518++);
         this.var_28.push(this.var_416);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_939;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_518++);
         this.var_514.push(_loc3_);
      ...
      {
         return this.var_416.loadFromResource(param1,param2);
      }
      
      public function unload() : void
      {
         while(this.var_514.length > 0)
         {
            (this.var_514.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_514.length)
            {
               _loc3_ = this.var_514[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  this.var_514.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return this.var_416.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_416.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_416.createAsset(param1,param2);
      }
      ...
      {
         return this.var_416.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_416.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_416.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_28.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_416.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_28.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
