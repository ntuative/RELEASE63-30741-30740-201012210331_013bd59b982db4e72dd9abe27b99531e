package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_938 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_36 = new Loader();
         this.var_939 = new LoaderContext();
         this.var_939.checkPolicyFile = true;
         ...
         {
            this.var_36.load(param2,this.var_939);
         }
      }
      ...
      {
         this.var_938 = param1.url;
         var_289 = 0;
         this.var_36.load(param1,this.var_939);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_289 < var_2627)
            {
               ...
               this.var_36.load(new URLRequest(this.var_938 + (this.var_938.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_289),this.var_939);
               return true;
            }
         }
         return false;
