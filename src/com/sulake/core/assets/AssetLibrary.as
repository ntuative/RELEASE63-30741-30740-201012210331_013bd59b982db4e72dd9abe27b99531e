package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_698:String = "AssetLibraryLoaded";
      
      public static const const_1474:String = "AssetLibraryUnloaded";
      
      public static const const_1339:String = "AssetLibraryLoadError";
      
      private static var var_262:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_435:uint = 0;
      
      private static var var_798:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_435;
         this.var_362 = new Dictionary(false);
         this.var_434 = new Dictionary(false);
         this.var_799 = new Dictionary(false);
         this.var_133 = new Dictionary(false);
         var_798.push(this);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_798.splice(var_798.indexOf(this),1);
            --var_435;
            this.var_434 = null;
            this.var_799 = null;
            this.var_133 = null;
      ...
      {
         if(this._file == param1.url && this.var_796)
         {
            if(!this.var_797 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_653,this.var_534);
            }
            this.var_797 = param2;
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_434)
         {
            _loc2_ = this.var_434[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_434[_loc1_];
         }
         for(_loc1_ in this.var_133)
         {
            delete this.var_133[_loc1_];
         }
         ...
         this.var_796 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1474));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_799[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_434[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_981,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1068,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1056,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_917,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_434[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_434[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_133[struct.assetName] == null)
                  {
                     ++this.var_363;
                     this.var_364.push(struct.assetName);
                  }
                  this.var_133[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_43,e.status);
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_434[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_133[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_364.length ? this.getAssetByName(this.var_364[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_133)
         {
            if(this.var_133[_loc2_] == param1)
            {
               return this.var_364.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_133[param1] != null || (this.var_534 != null ? this.var_534[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_133[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            if(_loc4_)
            {
               ++this.var_363;
               this.var_364.push(param1);
            }
            this.var_133[param1] = param2;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_133)
            {
               if(this.var_133[_loc2_] == param1)
               {
                  this.var_364.splice(this.var_364.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_362.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_362[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_362[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_362)
         {
            _loc3_ = AssetTypeDeclaration(this.var_362[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_362)
         {
            _loc4_ = AssetTypeDeclaration(this.var_362[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_653 = _loc2_.manifest.copy();
         this.var_534 = _loc2_.resource;
         ...
         this.var_796 = true;
         dispatchEvent(new Event(AssetLibrary.const_698));
         dispatchEvent(new Event(AssetLibrary.const_910));
         if(this.var_797)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1339));
         this.var_36 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_653.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_534[param1]);
