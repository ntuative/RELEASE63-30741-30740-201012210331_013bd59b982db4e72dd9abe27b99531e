package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_517:uint = 0;
      
      protected static var var_432:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_432 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_101 is BitmapDataAsset)
         {
            ...
            this.var_1244 = BitmapDataAsset(this.var_101).var_1244;
            this.var_1245 = BitmapDataAsset(this.var_101).var_1245;
            if(this._bitmap != null)
            {
               this.var_101 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1244 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1245 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
