package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_155.state = RoomChatHistoryPulldown.const_246;
         ...
         this.var_43 = param2.createWindow("chatscroller","",HabboWindowType.const_982,HabboWindowStyle.const_37,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_155.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_246);
      }
      ...
      {
         return !!this.var_366 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_155.state == RoomChatHistoryPulldown.const_314 || this.var_155.state == RoomChatHistoryPulldown.const_447;
      }
      ...
      {
         if(!this.var_366 && !this.var_1618)
         {
            this.var_366 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_155.state = RoomChatHistoryPulldown.const_314;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_43 != null)
         {
            ...
            if(param2)
            {
               this.var_43.scrollV = this.var_541;
            }
         }
         if(this.var_155 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_367 > 0 && param2)
         {
            if(this.var_1533)
            {
               if(Math.abs(param1 - this.var_367) <= const_984)
               {
                  return;
               }
               this.var_1533 = false;
            ...
            if(this.var_366)
            {
               ...
               _loc5_ = (param1 - this.var_367) / this.var_43.height;
               _loc3_ = this.var_541 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_367;
               _loc7_ = true;
               _loc8_ = true;
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_43 != null)
         {
            this.var_541 = this.var_43.scrollV;
         }
         if(this.var_43 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_541 - this.var_43.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
