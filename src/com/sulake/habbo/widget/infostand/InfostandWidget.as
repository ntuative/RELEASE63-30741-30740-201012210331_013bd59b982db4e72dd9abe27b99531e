package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1573:String = "infostand_furni_view";
      
      private const const_1572:String = "infostand_pet_view";
      
      private const const_1574:String = "infostand_bot_view";
      
      private var var_1116:InfoStandFurniView;
      
      private var var_165:InfoStandUserView;
      
      private var var_335:InfoStandPetView;
      
      private var var_387:InfoStandBotView;
      ...
      private var var_1358:InfoStandPetData;
      ...
      private const const_1844:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1116 = new InfoStandFurniView(this,this.const_1573,this._catalog);
         this.var_165 = new InfoStandUserView(this,this.const_1571);
         this.var_335 = new InfoStandPetView(this,this.const_1572);
         this.var_387 = new InfoStandBotView(this,this.const_1574);
         this.var_1367 = new InfostandUserData();
         this.var_451 = new InfostandFurniData();
         this.var_1358 = new InfoStandPetData();
         this.var_145 = new Timer(this.const_1844);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_295,this.onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_803,this.onFurniInfo);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_295,this.onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_803,this.onFurniInfo);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_348,this.var_335.getCurrentPetId()));
      }
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_335.update(this.petData);
      ...
      {
         this.var_335.updateEnabledTrainingCommands(param1.id,param1.enabledCommands);
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_165.setTags(param1.tags,this.var_2474);
         }
      }
      ...
      private function onUserFigureUpdate(param1:RoomWidgetUserFigureUpdateEvent) : void
      {
         ...
         {
            this.var_387.image = param1.image;
         }
         else
         {
            this.var_165.image = param1.image;
            this.var_165.motto = param1.customInfo;
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(this.userData.isBot())
            {
               this.var_387.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_295:
               ...
               if(this.var_335 != null && this.var_335.window != null && this.var_335.window.visible)
               {
                  _loc2_ = param1.id == this.var_1358.roomIndex;
                  break;
               }
