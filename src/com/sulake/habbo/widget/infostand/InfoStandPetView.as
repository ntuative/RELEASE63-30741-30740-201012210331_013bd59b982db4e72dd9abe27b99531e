package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_180:PetCommandTool;
      ...
      private const const_1840:int = 16;
      
      private const const_1839:uint = 11184810;
      
      private const const_1842:uint = 6710886;
      
      private const const_1834:uint = 3355443;
      
      private const const_1836:String = "level";
      
      private const const_1837:String = "experience";
      
      private const const_1841:String = "energy";
      
      private const const_1835:String = "nutrition";
      ...
      {
         if(this.var_50 == null || this.var_192 == null || this.var_63 == null)
         {
            return;
         }
         ...
         this.var_192.height = this.var_50.height + 20;
         this._window.width = Math.max(this.var_192.width,this.var_63.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_192.width < this.var_63.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1836,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1837,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1841,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1835,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_622 = param1.id;
         this.var_1358.remove(param1.id);
         this.var_1358.add(param1.id,param1);
         if(this.var_180 && this.var_180.isVisible() && param1.isOwnPet)
         {
            this.var_180.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         this.var_180.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1838,this.const_1840,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1839);
      ...
      private function openTrainView() : void
      {
         if(this.var_180 == null)
         {
            this.var_180 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this.var_1358.getValue(this.var_622) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_180.showWindow(true);
            this.var_180.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_50 = this.var_192.findChildByName("infostand_element_list") as IItemListWindow;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_180 && this.var_180.getPetId() == this.var_622)
               {
                  this.var_180.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_404,this._widget.petData.ownerId);
