package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_848:int = 16;
      
      private static const const_1192:int = 40;
      
      private static const const_1552:int = 5;
      
      private static const const_1191:int = 20;
      ...
      private var var_469:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1039 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2182 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2183 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_311 = new Timer(1000,1);
         this.var_311.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_376 = new Timer(10000,1);
         this.var_376.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
         this.refreshView();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_311.reset();
            this.var_311.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         }
         this.var_311 = null;
         if(this.var_376 != null)
         {
            this.var_376.reset();
            this.var_376.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         }
         this.var_376 = null;
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_145,this.windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_45,this.onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_110,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_326,this.onWindowMoved);
         this.var_1625 = true;
         this.var_455 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2181 = _loc2_.width + const_848 + _loc6_.width + const_1191;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1192,_loc8_.width) + const_848);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_469 = param1 - this.var_2181;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_469);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_469);
         }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1039 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_455 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_455.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_455 = _loc2_.text;
            if(!this.var_558)
            {
               this.var_558 = true;
               this.var_311.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_558);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_469)
         {
      ...
      private function sendChatFromInputField(param1:int) : void
      {
         ...
         if(this._widget != null)
         {
            if(this.var_311.running)
            {
               this.var_311.reset();
            }
            if(this.var_376.running)
            {
               this.var_376.reset();
            }
