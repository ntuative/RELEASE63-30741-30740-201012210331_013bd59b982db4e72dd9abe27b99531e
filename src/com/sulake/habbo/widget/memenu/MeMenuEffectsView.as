package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuEffectsView implements IMeMenuView
   {
      ...
      public static const const_995:Number = 55;
      ...
      public function updateEffects(param1:Array) : Boolean
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            this.var_813.push(_loc6_);
            _loc6_.window.y = _loc2_ * const_995;
            _loc2_++;
         }
         _loc4_ = this._effectsContainer.height;
         _loc5_ = this.var_813.length * const_995;
      ...
      public function selectEffect(param1:EffectView) : void
      {
         ...
         {
            this._widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_712,param1.effect.type));
         }
         else
         {
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_813)
         {
            _loc1_.dispose();
            _loc1_ = null;
         }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         {
            case "back_btn":
               this._widget.changeView(MeMenuWidget.const_105);
               break;
            case "moreEffects_btn":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_991));
               break;
            case "hideEffects_btn":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_666));
               break;
            default:
