package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_881:ITextWindow;
      
      private var var_174:Timer;
      
      private var var_882:IWindow;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_880 != null)
         {
            if(this.var_163.isActive)
            {
               ...
               this.var_880.width = _loc2_ * this.var_469;
            }
            else
            {
               this.var_880.width = 0;
               this.var_174.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_881.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_881.text;
            if(this.var_163.isActive)
            {
               ...
               this.var_881.text = _loc1_;
            }
            else
            {
               this.var_881.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_882 = this._window.findChildByName("effect_hilite");
            this.var_882.visible = false;
         }
         this.var_881 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_880 = this._window.findChildByName("loader_bar");
         if(this.var_880 != null)
         {
            this.var_469 = this.var_880.width;
            this.var_174.start();
            this.onUpdate();
         }
