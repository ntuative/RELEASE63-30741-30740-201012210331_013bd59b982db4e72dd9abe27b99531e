package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_150["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_150["dance_icon"] = ["dance_white","dance_color"];
         this.var_150["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_150["effects_icon"] = ["effects_white","effects_color"];
         this.var_150["badges_icon"] = ["badges_white","badges_color"];
         this.var_150["wave_icon"] = ["wave_white","wave_color"];
         this.var_150["hc_icon"] = ["_white","_color"];
         this.var_150["settings_icon"] = ["settings_white","settings_color"];
         this.var_150["credits_icon"] = ["credits_white","credits_color"];
         this.var_150["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            this.var_150[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_150[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_150)
         {
            _loc6_ = this.var_150[_loc3_];
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1059);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1084));
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_700);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1036));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_267);
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_950));
               this._widget.hide();
               break;
            case "settings":
               this._widget.changeView(MeMenuWidget.const_766);
               break;
            case "news":
