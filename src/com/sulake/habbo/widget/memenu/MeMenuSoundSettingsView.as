package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_914:MeMenuSoundSettingsSlider;
      
      private var var_1828:BitmapData;
      
      private var var_1826:BitmapData;
      
      private var var_1827:BitmapData;
      
      private var var_1829:BitmapData;
      ...
      {
         this.var_485 = param1.volume;
         if(this.var_914 != null)
         {
            this.var_914.setValue(this.var_485);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1828 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1826 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1827 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1829 = (_loc5_.content as BitmapData).clone();
         }
         this.var_914 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_759));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_485 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1828);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1826);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_485 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1827);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1829);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_779);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_708);
         }
