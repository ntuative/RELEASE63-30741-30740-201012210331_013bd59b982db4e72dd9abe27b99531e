package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_424:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_424.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_424 = null;
         }
         if(this.var_39 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetInterstitialUpdateEvent.const_94,this.onShowInterstitial);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_94,this.onShowLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetInterstitialUpdateEvent.const_94,this.onShowInterstitial);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_94,this.onShowLoadingBar);
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_424 == null)
         {
            this.var_424 = new Sprite();
            this.var_424.addChild(new Bitmap(this.var_39));
            this.var_424.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_424.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_39;
            }
         }
         _loc2_.setDisplayObject(this.var_424);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1178 != "")
         {
            HabboWebTools.openWebPage(this.var_1178);
         }
      }
   }
}
