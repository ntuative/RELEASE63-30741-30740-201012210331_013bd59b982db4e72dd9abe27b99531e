package com.sulake.habbo.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_275)
         {
            _loc1_ = this.var_275.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_275.getWithIndex(0) as PollSession;
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      private function showPollOffer(param1:Event) : void
      {
         ...
         var _loc3_:PollSession = this.var_275.getValue(_loc2_) as PollSession;
      ...
      private function showPollContent(param1:Event) : void
      {
         ...
         {
            _loc3_ = _loc2_.id;
            _loc4_ = this.var_275.getValue(_loc3_) as PollSession;
            if(_loc4_)
            {
      ...
      {
         var _loc2_:PollSession = this.var_275.getValue(param1) as PollSession;
         if(_loc2_)
         {
            _loc2_.showThanks();
            _loc2_.dispose();
            this.var_275.remove(param1);
         }
      }
      
      public function method_3(param1:int) : void
      {
         var _loc2_:PollSession = this.var_275.getValue(param1) as PollSession;
         if(_loc2_)
         {
