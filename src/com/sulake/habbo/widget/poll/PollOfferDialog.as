package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1345:String = "POLL_OFFER_STATE_OK";
      
      public static const const_643:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_403:String = "POLL_OFFER_STATE_UNKNOWN";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     this._state = const_1345;
                     this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_670,this._id));
                     break;
                  case "poll_offer_button_cancel":
                     this._state = const_643;
                     this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_395,this._id));
                     this._widget.method_3(this._id);
                     break;
