package com.sulake.habbo.widget.poll
{
   ...
   public class PollSession implements IDisposable
   {
      ...
      {
         this.hideOffer();
         this.var_243 = new PollOfferDialog(this._id,param1,this.var_1135);
      }
      ...
      public function showContent(param1:String, param2:String, param3:Array) : void
      {
         ...
         this.var_243 = new PollContentDialog(this._id,param1,param3,this.var_1135);
      }
      ...
      {
         this.var_1135.windowManager.alert("${poll_thanks_title}",this.var_1804,0,function(param1:IAlertDialog, param2:Event):void
         {
            param1.dispose();
         });
      }
