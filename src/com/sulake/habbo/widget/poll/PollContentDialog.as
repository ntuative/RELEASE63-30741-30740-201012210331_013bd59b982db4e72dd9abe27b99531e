package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1133;
         if(this.var_1133 < this.var_906.length)
         {
            _loc1_ = this.var_906[this.var_1133] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_906.length);
                  _loc2_.text = _loc6_;
               }
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_395)
         {
            ...
            this.var_395 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_395.center();
            this.var_395.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_906[this.var_1133] as Dictionary;
