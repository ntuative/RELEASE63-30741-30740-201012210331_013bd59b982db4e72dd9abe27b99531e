package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1231:Array = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_134,this.showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_135,this.showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_318,this.update);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_134,this.showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_135,this.showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_318,this.update);
      }
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - this.var_2089;
