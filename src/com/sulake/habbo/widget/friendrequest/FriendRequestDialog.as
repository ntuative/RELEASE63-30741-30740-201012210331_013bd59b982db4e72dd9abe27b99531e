package com.sulake.habbo.widget.friendrequest
{
   ...
   public class FriendRequestDialog
   {
      ...
      public function set targetRect(param1:Rectangle) : void
      {
         ...
         if(!param1)
         {
            this._widget.ignoreRequest(this.var_1104);
            return;
         }
         if(this.var_1756 || this.var_1757)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               ...
               {
                  case "accept_button":
                     this._widget.acceptRequest(this.var_1104);
                     break;
                  case "decline_button":
                     this._widget.declineRequest(this.var_1104);
                     break;
                  case "close_button":
                     this._widget.ignoreRequest(this.var_1104);
               }
