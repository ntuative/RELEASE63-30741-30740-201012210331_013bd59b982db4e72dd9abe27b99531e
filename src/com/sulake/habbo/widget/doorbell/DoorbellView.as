   ...
   public class DoorbellView
   {
      ...
      public function update() : void
      {
         ...
         if(this.var_52 != null)
         {
            ...
            {
               this.var_52.addListItem(this.createListItem(this.var_322.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
      ...
      public function createMainWindow() : void
      {
         ...
         this._frame = (this.var_322.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this._frame == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
