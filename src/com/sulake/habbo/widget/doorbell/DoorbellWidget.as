package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1182:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_619,this.onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_115,this.onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_619,this.onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_115,this.onDoorbellHandled);
      ...
      public function addUser(param1:String) : void
      {
         ...
         if(this._users.length >= const_1182)
         {
            this.deny(param1);
            return;
         }
