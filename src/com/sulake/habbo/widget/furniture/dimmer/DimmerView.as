package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1386:XML;
      
      private var _widget:DimmerFurniWidget;
      
      private var var_610:DimmerViewColorGrid;
      
      private var var_399:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_56,HabboWindowStyle.const_34,0 | 0,new Rectangle(const_1133,const_1132,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_610 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_399 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1387 = _loc2_.light;
         if(this.var_399 != null)
         {
            this.var_399.setValue(this.var_1387);
         }
         this.var_501 = this.colors.indexOf(_loc2_.color);
         if(this.var_610 != null)
         {
            this.var_610.setSelectedColorIndex(this.var_501);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1386 = XML(_loc1_.content);
         return this.var_1386;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_399 != null)
         {
            this.var_399.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_610 != null)
         {
            this.var_610.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
