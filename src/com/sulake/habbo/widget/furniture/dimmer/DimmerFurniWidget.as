package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1233:Array = new Array(7665141,21495,15161822,15353138,15923281,8581961,0);
      
      private static const const_1234:Array = new Array(int(76.5),int(76.5));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_593,this.onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_720,this.onHide);
         param1.addEventListener(RoomWidgetDimmerStateUpdateEvent.const_60,this.onDimmerState);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_593,this.onPresets);
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_720,this.onHide);
         param1.removeEventListener(RoomWidgetDimmerStateUpdateEvent.const_60,this.onDimmerState);
      }
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         this.var_1999 = param1.presetId;
         this.var_1108 = param1.effectId;
         this._color = param1.color;
         this.var_1110 = param1.brightness;
         if(this._view != null)
         {
            this._view.update();
         }
         if(!this.validateBrightness(this.var_1110,this.var_1108))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1110,this.var_1108 == 2);
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1110,this.var_1108 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
