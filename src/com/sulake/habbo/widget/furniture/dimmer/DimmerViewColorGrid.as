package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_462.numGridItems)
         {
            return;
         }
         this.select(this.var_462.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this._view == null || this.var_462 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1656) as IWindowContainer;
            ...
            _loc3_.width = this.var_575.width;
            _loc3_.height = this.var_575.height;
            this.var_462.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_575.width,this.var_575.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_575,this.var_575.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1060.width,this.var_1060.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_854.width,this.var_854.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_854,this.var_854.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = this.var_462.getGridItemIndex(param1.target as IWindow);
