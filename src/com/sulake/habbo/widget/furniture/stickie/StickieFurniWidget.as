package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1135:int = 14;
      
      private static const const_1134:int = 500;
      
      private static const const_1133:Number = 100;
      
      private static const const_1132:Number = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_611,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_611,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1774 = param1.objectType;
         this._text = param1.text;
         this.var_899 = param1.colorHex;
      ...
      private function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow("stickieui_container","",HabboWindowType.const_56,HabboWindowStyle.const_34,0 | 0,new Rectangle(const_1133,const_1132,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null)
         {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + this.var_899);
            }
         ...
         this.setColorButtons(this._controller && this.var_1774 == "post_it");
      }
      ...
      private function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_393,this.var_342,this._text,this.var_899);
      ...
      private function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_393,this.var_342,this._text,this.var_899);
      ...
      private function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_760,this.var_342);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1134;
         if(_loc2_.numLines < const_1135)
         {
            return;
         }
