package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_841:String = "Boy";
      
      private static const const_840:String = "Girl";
       
      
      private var _window:IWindowContainer;
      
      private var var_660:IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_347,this.onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_1109,this.onUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_347,this.onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_1109,this.onUpdate);
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         this.var_2067 = param1.objectCategory;
      ...
      private function hideEditorInterface() : void
      {
         ...
         {
            _loc1_ = this.var_660 as IFrameWindow;
            if(_loc1_ != null)
            {
      ...
      {
         this.requestEditor(FigureData.MALE);
      }
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         _loc5_.setParamFlag(HabboWindowParam.const_114,true);
         this.var_660 = _loc4_;
         this.var_660.offset(100,100);
         var _loc6_:IWindow = this.var_660.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = this.onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_370,param1,this.var_342,this.var_2067,this._roomId,this._roomCategory,_loc5_);
