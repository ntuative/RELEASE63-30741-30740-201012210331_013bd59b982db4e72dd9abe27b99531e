package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private var var_343:Boolean = false;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_495,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_401,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_516,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_495,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_401,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_516,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomWidgetPresentDataUpdateEvent.const_401:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_516:
               if(!this.var_343)
               {
                  return;
               }
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_56,HabboWindowStyle.const_34,0 | 0,new Rectangle(const_1133,const_1132,2,2),null,0) as IWindowContainer;
      ...
      {
         var _loc1_:* = null;
         if(this.var_343 || this.var_342 == -1 || !this._controller)
         {
            return;
         }
         this.var_343 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_149,this.var_342);
