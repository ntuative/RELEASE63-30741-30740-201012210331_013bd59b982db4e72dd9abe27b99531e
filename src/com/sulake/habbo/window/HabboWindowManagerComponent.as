package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_385:uint = 3;
      
      private static const const_1180:uint = 1;
      ...
      private var var_790:ISkinContainer;
      ...
      private var var_1613:ProfilerOutput;
      
      private var var_1278:ProfilerAgentTask;
      
      private var var_1276:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_790 = new SkinContainer(_loc4_.content as XML,assets);
         this._windowRenderer = new WindowRenderer(this.var_790);
         this.var_176 = new Array(const_385);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_385)
         {
            this.var_176[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_229 = this.var_176[const_1180];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this.var_229.getMouseCursor().defineCustomCursorType(MouseCursorType.const_353,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this.var_229.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1462,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1613)
            {
               this.var_1613 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1613.profiler = _loc3_;
            ...
            this.var_1276 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1276);
            this.var_1029 = true;
         }
      }
      ...
      {
         var _loc3_:Dictionary = this.var_309[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_309[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_790.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_349.length > 0)
         {
            this.var_1277.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_385 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1277.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_385)
         {
         ...
         if(WindowContext.var_349.length > 0)
         {
            WindowContext.var_349.flush();
         }
         this.var_1277.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1421,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1500,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1301,param2.name + ": " + param2.toString());
            }
         }
      }
   }
