package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      private static const const_1284:String = "_alert_text_summary";
      ...
      protected var var_257:Function = null;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "_alert_button_ok":
                  ...
                  {
                     this.var_257(this,new WindowEvent(WindowEvent.const_187,null,null));
                  }
                  break;
               case "header_button_close":
                  if(this.var_257 != null)
                  {
                     this.var_257(this,new WindowEvent(WindowEvent.const_716,null,null));
                  }
            }
         }
      }
      ...
      public function set summary(param1:String) : void
      {
         ...
         if(this._window)
         {
            ITextWindow(this._window.findChildByTag("DESCRIPTION")).text = this.var_1550;
         }
      }
