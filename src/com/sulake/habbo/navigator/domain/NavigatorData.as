package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      private static const const_1570:int = 10;
       
      
      private var _navigator:HabboNavigator;
      
      private var var_181:MsgWithRequestId;
      
      private var var_595:RoomEventData;
      ...
      private var var_891:PublicRoomShortData;
      ...
      public function onRoomEnter(param1:RoomEntryInfoMessageParser) : void
      {
         ...
         {
            this.var_891 = param1.publicSpace;
            this.var_595 = null;
         }
      }
      ...
      {
         return this.var_181 != null && this.var_181 as PopularRoomTagsData != null;
      }
      
      public function get guestRoomSearchArrived() : Boolean
      {
         return this.var_181 != null && this.var_181 as GuestRoomSearchResultData != null;
      }
      
      public function get officialRoomsArrived() : Boolean
      {
         return this.var_181 != null && this.var_181 as OfficialRoomsData != null;
      }
      ...
      {
         return this.var_181 as GuestRoomSearchResultData;
      }
      
      public function get popularTags() : PopularRoomTagsData
      {
         return this.var_181 as PopularRoomTagsData;
      }
      
      public function get officialRooms() : OfficialRoomsData
      {
         return this.var_181 as OfficialRoomsData;
      }
      ...
      public function set categories(param1:Array) : void
      {
         ...
         this.var_1362 = new Array();
         for each(_loc2_ in this.var_1361)
         {
            if(_loc2_.visible)
            {
               this.var_1362.push(_loc2_);
            }
         }
      }
      ...
      {
         return this.var_1360 >= this.var_2464;
      }
