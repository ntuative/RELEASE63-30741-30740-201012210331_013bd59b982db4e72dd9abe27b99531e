package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2222:IButtonWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_1653.visible = true;
         this.var_2221.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_688.setText(param1.eventDescription);
         this.var_831.setText(this.getTagFromEvent(param1,1));
         this.var_832.setText(this.getTagFromEvent(param1,2));
      ...
      private function createEvent() : void
      {
         ...
         this.var_831.goBackToInitialState();
         this.var_832.goBackToInitialState();
         this.var_853.selection = 0;
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.addTag(_loc6_,this.var_831.getText());
         this.addTag(_loc6_,this.var_832.getText());
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1653 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2221 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1652 = ITextWindow(this.find("create_caption"));
            this.var_1654 = ITextWindow(this.find("edit_caption"));
            this.var_1313 = IButtonWindow(this.find("create_button"));
            this.var_1315 = IButtonWindow(this.find("edit_button"));
            this.var_2222 = IButtonWindow(this.find("cancel_button"));
            this.var_1314 = IButtonWindow(this.find("end_button"));
            this.var_853 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1313,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1315,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1314,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2222,this.onCancelButtonClick);
            ...
            this.var_831 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_832 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
