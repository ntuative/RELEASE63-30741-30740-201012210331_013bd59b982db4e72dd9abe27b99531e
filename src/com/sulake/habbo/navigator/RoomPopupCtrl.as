package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2015 = new RoomThumbnailRenderer(param1);
         this.var_972 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_166,this.var_113);
         if(this.var_113.ownerName != "" && this.var_113.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_166,!!this.var_113.event ? this.getEventCtg(this.var_113.categoryId) : this.getRoomCtg(this.var_113.categoryId));
         this.refreshRoomDesc(this.var_166,this.var_113);
         this.refreshExtraCont();
         this.refreshInfo(this.var_166,"trading_allowed",this.var_113.allowTrading);
         this.refreshInfo(this.var_166,"doormode_doorbell",this.var_113.doorMode == 1);
         this.refreshInfo(this.var_166,"doormode_password",this.var_113.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_166,this.var_113.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_972.refreshTags(_loc1_,this.var_113.tags);
         ...
         this.var_2015.refreshThumbnail(_loc1_,this.var_113.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_251,Tabs.const_236,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
