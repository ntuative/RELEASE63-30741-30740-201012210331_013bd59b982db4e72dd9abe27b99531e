package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_70.addEventListener(WindowKeyboardEvent.const_145,this.checkEnterPress);
         this.var_70.addEventListener(WindowEvent.const_110,this.checkMaxLen);
         this.var_2434 = this.var_70.textBackground;
         this._orgTextBackgroundColor = this.var_70.textBackgroundColor;
         this.var_2432 = this.var_70.textColor;
      }
      ...
      {
         this.var_70.textBackground = this.var_2434;
         this.var_70.textBackgroundColor = this._orgTextBackgroundColor;
         this.var_70.textColor = this.var_2432;
      }
      ...
      public function displayError(param1:String) : void
      {
         ...
         if(this.var_124 == null)
         {
            ...
            IWindowContainer(this.var_70.parent).addChild(this.var_124);
         }
         ...
         this.var_124.x += (this.var_70.width - this.var_124.width) / 2;
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_70.text = this.var_1349;
            this.var_591 = true;
         }
         else
         {
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_70.text = this.var_2433;
         this.var_591 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         if(_loc2_.length > this.var_1751)
         {
            this.var_70.text = _loc2_.substring(0,this.var_1751);
         }
      }
   }
}
