package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_970:RoomLayout;
      
      private var var_532:Timer;
      
      private var var_1504:Boolean = true;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_532 = new Timer(100);
         this.var_532.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_37 = new Array();
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_48,104,"a"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_48,94,"b"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_48,36,"c"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_48,84,"d"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_48,80,"e"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_48,80,"f"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_48,416,"i"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_48,320,"j"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_48,448,"k"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_48,352,"l"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_48,384,"m"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_48,372,"n"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_59,80,"g"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_59,74,"h"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_59,416,"o"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_59,352,"p"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_59,304,"q"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_59,336,"r"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_59,748,"u"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_59,438,"v"));
      ...
      public function dispose() : void
      {
         if(this.var_532)
         {
            this.var_532.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_532.reset();
            this.var_532 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_970.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1504 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1504 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_52 = IItemListWindow(this.var_154.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_154.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_969 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_154.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_154.desktop,this.var_154.width,this.var_154.height);
         this.var_154.x = _loc4_.x;
         this.var_154.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_969.goBackToInitialState();
         this.var_969.input.textBackgroundColor = 4294967295;
         this.var_970 = this.var_37[0];
         this.refreshRoomThumbnails();
      ...
      {
         return Boolean(this.var_969.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_969.getText();
         var _loc3_:String = "model_" + this.var_970.name;
