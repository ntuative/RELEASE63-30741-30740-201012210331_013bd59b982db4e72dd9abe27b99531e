package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_669:TextFieldManager;
      
      private var var_1020:TextFieldManager;
      ...
      private var var_1024:ICheckBoxWindow;
      
      private var var_1027:ICheckBoxWindow;
      ...
      private var var_1605:ITextWindow;
      ...
      {
         this.var_308 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_308));
         if(this.var_1021 != null)
         {
            this.var_1021.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_308)
         {
            return;
         }
         this.var_72 = param1;
      ...
      {
         if(param1 != this.var_308 || this.var_1026 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1026 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1291)
         {
            this.var_669.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1471)
         {
            this.var_669.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1408)
         {
            this.var_1020.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1487)
         {
            this.setTagError(this.var_831,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_832,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1278)
         {
            this.setTagError(this.var_831,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_832,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1331)
         {
            this.var_830.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_669.displayError("Update failed: error " + param2);
         }
      }
      ...
      {
         this.var_669.clearErrors();
         this.var_1020.clearErrors();
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_525,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_721,this.onDoorModePasswordUnselect);
         ...
         this.var_669 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1020 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_831 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_832 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_830 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1022 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1024 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1027 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         ...
         this.var_1606 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1274 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1028 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1025 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1607 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1275 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_223 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1021 = IWindowContainer(this._window.findChildByName("password_container"));
         ...
         this.var_1605 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1605.procedure = this.onSwitchView;
         this.var_1021.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1606.visible = this._inRoom;
         this.var_1607.visible = this._inRoom;
         this.var_2156.visible = this.var_450;
         this.var_2155.visible = !this.var_450;
         if(this.var_450)
         {
            this.var_1025.visible = true;
            this.var_1275.visible = false;
            this.refreshFlatControllers();
            this.var_1025.height = Util.getLowestPoint(this.var_1025) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1028.visible = true;
            this.var_1275.visible = true;
            this.var_1274.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1274.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1028.height = Util.getLowestPoint(this.var_1028) + 4;
         }
         this.var_1605.text = !!this.var_450 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1606.name,this.var_1274.name,this.var_1028.name,this.var_1025.name,this.var_1275.name,this.var_1607.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_669.setText(_loc1_.name);
         this.var_1020.setText(_loc1_.description);
         this.var_830.setText("");
         this.var_1022.setText("");
         ...
         {
            case RoomSettingsData.const_174:
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_108);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         this.setCategorySelection(_loc1_.categoryId);
         this.refreshMaxVisitors(_loc1_);
         this.setTag(this.var_831,_loc1_.tags[0]);
         this.setTag(this.var_832,_loc1_.tags[1]);
         if(this.var_1024)
         {
            if(_loc1_.allowPets)
            {
               this.var_1024.select();
            }
            else
            {
               this.var_1024.unselect();
            }
         }
         if(this.var_1027)
         {
            ...
            {
               this.var_1027.select();
            }
            else
            {
               this.var_1027.unselect();
            }
         }
         if(this.var_1023)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_669.getText();
         _loc2_.description = this.var_1020.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_174;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_108;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_418;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_108)
         {
            _loc8_ = this.var_830.getText();
            _loc9_ = this.var_1022.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_830.clearErrors();
               this.var_1022.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1024.isSelected;
         _loc2_.allowFoodConsume = this.var_1027.isSelected;
         _loc2_.allowWalkThrough = this.var_1023.isSelected;
         _loc2_.hideWalls = this.var_555.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_831,_loc2_.tags);
         this.addTag(this.var_832,_loc2_.tags);
         this.clearErrors();
         this.var_1026 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_308);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_72.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_308]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_153,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_223.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_223.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_223.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_223.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_223.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_223.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_223.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_223);
         this.var_223.findChildByName("ruler").visible = true;
         ...
         if(this.var_72.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_223,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_56,HabboWindowStyle.const_34,HabboWindowParam.const_57,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_308));
      }
