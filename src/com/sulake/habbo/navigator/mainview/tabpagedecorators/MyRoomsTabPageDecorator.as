package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2707:IWindowContainer;
      ...
      public function method_4(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_477 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_477.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_477 == null ? 0 : int(this.var_477.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         this._navigator.mainViewCtrl.startSearch(Tabs.const_274,this.getSearchTypeForIndex(_loc1_));
      }
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_661;
         }
         if(param1 == 2)
         {
            return Tabs.const_752;
         }
         if(param1 == 3)
         {
            return Tabs.const_655;
         }
         if(param1 == 4)
         {
            return Tabs.const_660;
         }
         return Tabs.const_227;
      }
   }
}
