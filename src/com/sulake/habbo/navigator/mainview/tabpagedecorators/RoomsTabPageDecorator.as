package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_303:IDropMenuWindow;
      ...
      public function method_4(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_303 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
      ...
      public function prepareRoomCategories() : void
      {
         ...
         this.var_303.procedure = null;
         this.var_303.populate(_loc1_);
         this.var_303.selection = 0;
         this.var_303.procedure = this.onChangeFilter;
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_303 == null ? 0 : int(this.var_303.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_199,Tabs.const_372);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_199,Tabs.const_563);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_199,Tabs.const_372,"" + _loc3_);
         }
      }
   }
}
