package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class EventsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function method_4(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_303 = IDropMenuWindow(_loc3_.findChildByName("eventCtgFilter"));
      ...
      private function startSearch() : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_330,Tabs.const_467,_loc1_ < 1 ? "-1" : _loc1_ + "");
      }
   }
}
