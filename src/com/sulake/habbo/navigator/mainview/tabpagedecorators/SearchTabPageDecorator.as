package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1626:TextSearchInputs;
      ...
      public function method_4(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1626 == null)
         {
            ...
            this.var_1626 = new TextSearchInputs(this._navigator,false,_loc4_);
            this.initClearResults(_loc4_);
         }
         var _loc3_:IWindowContainer = param1.getChildByName("search_header") as IWindowContainer;
         if(this._navigator.data.guestRoomSearchArrived && this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_236)
         {
            this.var_1626.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_357)
            {
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_251,Tabs.const_236,"-1",MainViewCtrl.const_694);
      }
