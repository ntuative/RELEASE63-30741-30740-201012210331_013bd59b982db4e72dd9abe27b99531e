package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1144:int = 267;
      
      private static const const_1145:int = 65;
      
      private static const const_1146:int = -70;
      ...
      private var var_1992:PublicRoomThumbs;
      
      public function OfficialRoomEntryManager(param1:HabboNavigator)
      {
         this.var_1992 = new PublicRoomThumbs();
         super();
      ...
      public function refreshEntry(param1:IWindowContainer, param2:Boolean, param3:int, param4:OfficialRoomEntryData) : void
      {
         ...
         if(param2)
         {
            ...
            if(param4.type == OfficialRoomEntryData.const_1293)
            {
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_764 || param2.type == OfficialRoomEntryData.const_673))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1145) : int(const_1144);
      ...
      {
         var _loc4_:String = this.var_1992.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1146) : 0;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         if(_loc2_.guestRoomData != null)
         {
            ...
            if(_loc2_.guestRoomData.doorMode == RoomSettingsFlatInfo.const_108)
            {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_251,Tabs.const_357,_loc2_.tag);
         }
