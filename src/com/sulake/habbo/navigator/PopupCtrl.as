package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_373 = new Timer(500,1);
         this.var_310 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1343 = param4;
         this.var_2014 = param2;
         this._popupIndentLeft = param3;
         this.var_373.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
         this.var_310.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_373)
         {
            this.var_373.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_373.reset();
            this.var_373 = null;
         }
         if(this.var_310)
         {
            this.var_310.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_310.reset();
            this.var_310 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_48 == null)
         {
            this.var_48 = IWindowContainer(this._navigator.getXmlWindow(this.var_1343));
         ...
         this.var_48.x = _loc2_.x + this.var_2014 + param1.width;
