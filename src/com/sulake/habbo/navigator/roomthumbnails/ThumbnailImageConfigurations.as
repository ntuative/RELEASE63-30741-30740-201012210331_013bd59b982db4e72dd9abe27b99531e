package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfigurations
   {
      ...
      {
         this.var_1450 = new Dictionary();
         this.var_1449 = new Dictionary();
         super();
         this._navigator = param1;
         this.var_1437 = this._navigator.getButtonImage("rico_selected");
         ...
         this.addImg(0,ThumbnailEditorModel.const_54,"rico_top0");
         this.addImg(1,ThumbnailEditorModel.const_54,"rico_top1");
         this.addImg(2,ThumbnailEditorModel.const_54,"rico_top2");
         this.addImg(3,ThumbnailEditorModel.const_54,"rico_top3");
         this.addImg(4,ThumbnailEditorModel.const_54,"rico_top4");
         this.addImg(5,ThumbnailEditorModel.const_54,"rico_top5");
         this.addImg(6,ThumbnailEditorModel.const_54,"rico_top6");
         this.addImg(7,ThumbnailEditorModel.const_54,"rico_top7");
         this.addImg(8,ThumbnailEditorModel.const_54,"rico_top8");
         this.addImg(9,ThumbnailEditorModel.const_54,"rico_top9");
         this.addImg(10,ThumbnailEditorModel.const_54,"rico_top10");
         this.addImg(11,ThumbnailEditorModel.const_54,"rico_top11");
      ...
      {
         var _loc4_:ThumbnailImageConfiguration = new ThumbnailImageConfiguration(this._navigator,param1,param2,param3,this.var_1437);
      ...
      {
         var _loc2_:Dictionary = this.var_1449[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1449[param1] = _loc2_;
         }
         return _loc2_;
      }
