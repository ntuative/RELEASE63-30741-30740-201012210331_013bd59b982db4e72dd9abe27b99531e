package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_953:IDropMenuWindow;
      
      private var var_446:ITextFieldWindow;
      
      private var var_591:Boolean = true;
      
      private var var_784:ICheckBoxWindow;
      
      private var var_1199:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_45.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_308));
         Logger.log("BEGINNING TO SHOW: " + this.var_308);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1446;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_308);
         if(param1.flatId != this.var_308)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_308);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_953 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_953);
         this.var_953.procedure = this.onSelectTemplate;
         this.var_784 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1199 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1200 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_45,WindowTracker.const_777,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_591 || this.var_446.text == "")
         {
            this.var_45.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_784.isSelected);
         this.var_45.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1489,_loc2_,this.var_446.text,"",""));
         if(this.var_1199.isSelected || this.var_1200.isSelected || this.var_784.isSelected)
         {
            this.var_45.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1199.isSelected,this.var_1200.isSelected,this.var_784.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1317);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1473);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_45.initMsg.roomMessageTemplates[this.var_953.selection];
         if(_loc3_ != null)
         {
            this.var_591 = false;
