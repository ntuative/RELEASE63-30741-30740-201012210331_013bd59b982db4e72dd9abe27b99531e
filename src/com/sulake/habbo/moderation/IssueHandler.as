package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_125:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_492:UserInfoCtrl;
      
      private var var_1122:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_125.getHighestPriorityIssue();
         this.var_492 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
         this.var_1122 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
         this.var_492.load(IWindowContainer(this._window.findChildByName("caller_user_info")),this.var_125.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_125.reportedUserId > 0)
         {
            this.var_1122.load(_loc4_,this.var_125.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_125.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = this.var_125.issues;
         var _loc5_:int = 0;
      ...
      {
         if(this.var_61 != null && this.var_61.issueManager != null && this.var_125 != null)
         {
            this.var_61.issueManager.removeHandler(this.var_125.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_125.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_125.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_125.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.releaseBundle(this.var_125.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_125.getHighestPriorityIssue().issueId;
         this.var_61.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_61,WindowTracker.const_1113,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_125.getHighestPriorityIssue();
            this.var_492 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
            this.var_492.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
