package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      public function show() : void
      {
         if(this._frame == null)
         {
            this._frame = IFrameWindow(this.var_45.getXmlWindow("start_panel"));
            ...
            this._frame.findChildByName("room_tool_but").disable();
            this._frame.findChildByName("chatlog_but").disable();
            this.var_45.disableButton(this.var_45.initMsg.cfhPermission,this._frame,"ticket_queue_but");
      ...
      {
         if(this.var_45.initMsg.chatlogsPermission)
         {
      ...
      private function onRoomToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new RoomToolCtrl(this.var_45,this._roomId),this._frame,false,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!this.var_1766 ? 0 : 1,this._roomId),this.var_45,WindowTracker.const_777,this._roomId),this._frame,false,false,true);
      }
