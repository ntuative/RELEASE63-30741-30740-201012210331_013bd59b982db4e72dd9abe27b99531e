package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         this.var_2106 = IWindowContainer(this.var_45.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1395;
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_2106.clone());
