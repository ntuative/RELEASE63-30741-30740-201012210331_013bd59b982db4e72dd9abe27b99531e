package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      {
         var _loc2_:Dictionary = this.var_1508[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1508[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
