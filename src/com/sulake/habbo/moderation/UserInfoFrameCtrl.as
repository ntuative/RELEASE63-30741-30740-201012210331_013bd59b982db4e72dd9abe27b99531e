package com.sulake.habbo.moderation
{
   ...
   public class UserInfoFrameCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1153:UserInfoCtrl;
      ...
      public function show() : void
      {
         ...
         this.var_1153 = new UserInfoCtrl(this._frame,this.var_45,"",true);
         this.var_1153.load(this._frame.content,this._userId);
         this._frame.visible = true;
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1253;
      }
