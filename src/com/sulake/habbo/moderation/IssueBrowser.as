package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1854:String = "my_issues";
      
      private const const_1855:String = "open_issues";
      
      private const const_1853:String = "picked_issues";
      
      private const const_1859:String = "closed_issues";
      ...
      private var var_1847:IIssueBrowserView;
      
      private var var_1845:IIssueBrowserView;
      
      private var var_1846:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_347 == _loc2_)
         {
            return;
         }
         if(this.var_347 != null)
         {
            this.var_347.visible = false;
         }
         this.var_347 = _loc2_;
         if(this.var_347 == null)
         {
         ...
         this.var_347.view.width = this.var_250.container.width;
         this.var_347.view.height = this.var_250.container.height;
         this.var_347.visible = true;
         this.var_347.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1854:
               ...
               {
                  this.var_1847 = new MyIssuesView(this.issueManager,this,this.var_250.container);
               }
               return this.var_1847;
            case this.const_1855:
               if(this.var_1845 == null)
               {
                  this.var_1845 = new OpenIssuesView(this.issueManager,this,this.var_250.container);
               }
               return this.var_1845;
            case this.const_1853:
               if(this.var_1846 == null)
               {
                  this.var_1846 = new PickedIssuesView(this.issueManager,this,this.var_250.container);
               }
