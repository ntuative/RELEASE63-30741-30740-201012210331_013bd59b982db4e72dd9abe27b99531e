package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1727:IMessageComposer;
      ...
      {
         this.var_1038 = IWindowContainer(this.var_45.getXmlWindow("chatlog_roomheader"));
         this.var_1037 = IWindowContainer(this.var_45.getXmlWindow("chatlog_chatline"));
         ...
         this.var_45.connection.send(this.var_1727);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(this.var_1038.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_1037.clone());
         _loc4_.color = this.var_1622[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
