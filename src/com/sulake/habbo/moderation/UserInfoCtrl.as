package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_873:int = 60;
      
      private static const const_871:int = 3600;
      
      private static const const_870:int = 86400;
      
      private static const const_872:int = 31536000;
      ...
      public function UserInfoCtrl(param1:IFrameWindow, param2:ModerationManager, param3:String, param4:Boolean = false)
      {
         ...
         this.var_1089 = param4;
      }
      
      public static function formatTime(param1:int) : String
      {
         if(param1 < 2 * const_873)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_871)
         {
            return Math.round(param1 / const_873) + " mins ago";
         }
         if(param1 < 2 * const_870)
         {
            return Math.round(param1 / const_871) + " hours ago";
         }
         if(param1 < 2 * const_872)
         {
            return Math.round(param1 / const_870) + " days ago";
         }
         return Math.round(param1 / const_872) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1090.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_45.getXmlWindow("user_info"));
            this.var_1090.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_45,WindowTracker.const_890,this._data.userId),this._callerFrame,this.var_1089,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new RoomVisitsCtrl(this.var_45,this._data.userId),this._callerFrame,this.var_1089,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new SendMsgsCtrl(this.var_45,this._data.userId,this._data.userName,this.var_1252),this._callerFrame,this.var_1089,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ModActionCtrl(this.var_45,this._data.userId,this._data.userName,this.var_1252),this._callerFrame,this.var_1089,false,true);
      }
