package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_816:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1008 = IButtonWindow(this.var_45.getXmlWindow("modact_offence"));
         this.var_1007 = IButtonWindow(this.var_45.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1559;
         ...
         this.var_1009 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1009);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_817 != null;
         if(this.var_816 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_816.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_817 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_817.offences,this.var_1008,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_45.initMsg.offenceCategories,this.var_1007,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1423;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.connection.send(new ModAlertMessageComposer(this.var_1253,this.var_446.text,this.var_1252));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_817 = this.var_45.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_816 = this.var_817.offences[_loc3_];
         this.var_446.text = this.var_816.msg;
         this.var_591 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.connection.send(new ModKickMessageComposer(this.var_1253,this.var_446.text,this.var_1252));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1009.selection < 0)
         {
            this.var_45.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_45.connection.send(new ModBanMessageComposer(this.var_1253,this.var_446.text,this.getBanLength(),this.var_1252));
         this.dispose();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1008.destroy();
            this.var_1008 = null;
         }
         if(this.var_1007 != null)
         {
            this.var_1007.destroy();
            this.var_1007 = null;
         }
         this.var_1009 = null;
         this.var_446 = null;
