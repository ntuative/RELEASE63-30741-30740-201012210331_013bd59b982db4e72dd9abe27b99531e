package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_240)
         {
            for each(_loc2_ in this.var_240 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_209 = new Array(param1.length);
         var _loc3_:int = 0;
         while(_loc3_ < this.var_240.length)
         {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_902 >= 0 && this._parts.length > this.var_902)
         {
            _loc2_ = this._parts[this.var_902];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_209[param2],param2);
         this.var_209[param2] = param1;
      ...
      public function getSelectedColorIds() : Array
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(!this.var_209 || this.var_209.length == 0)
         {
            return null;
         }
         if(!this.var_240 || this.var_240.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_240[0] as Array;
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.var_209.length)
         {
            _loc7_ = this.var_240[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > this.var_209[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_209[_loc5_]] as AvatarEditorGridColorItem;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_209[param1])
         {
            return null;
         }
         return _loc2_[this.var_209[param1]] as AvatarEditorGridColorItem;
      }
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_240.length <= param1)
         {
            return null;
         }
         return this.var_240[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_902] as AvatarEditorGridPartItem;
      }
