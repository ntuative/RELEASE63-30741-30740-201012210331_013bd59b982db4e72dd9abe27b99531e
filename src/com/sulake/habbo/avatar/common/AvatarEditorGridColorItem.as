package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_801:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_752.width,this.var_752.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_752,this.var_752.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_973.width,this.var_973.height,true,0);
            _loc5_ = this.var_973.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_801.colorTransform);
