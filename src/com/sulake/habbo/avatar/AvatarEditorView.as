package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1161:IWindowContainer;
      
      public static var var_1423:IWindowContainer;
      ...
      private var var_497:ITabSelectorWindow;
      ...
      private var var_2536:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1132 = [];
         this.var_1361 = [AvatarEditorFigureCategory.const_767,AvatarEditorFigureCategory.const_42,AvatarEditorFigureCategory.const_229,AvatarEditorFigureCategory.const_568,AvatarEditorFigureCategory.const_949,AvatarEditorFigureCategory.const_95];
         super();
         ...
         if(var_1161 == null)
         {
            ...
            var_1161 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1423 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1423 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_394 = new Timer(1000);
         this.var_394.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1361;
         }
         for each(_loc6_ in param4)
         {
            this.var_1132.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_394.stop();
            this.var_394.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_394 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1361);
         }
         if(param1.length != this.var_1132.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1132.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2535 = this.canChangeOutfit();
            this.var_394.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_497 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_497.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_497.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1132.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_497.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_497.numSelectables)
               {
                  this.var_497.getSelectableAt(_loc6_).x = this.var_497.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1361;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1798 == AvatarEditorSideCategory.const_95 || this.var_2536))
         {
         ...
         this.setViewToCategory(this.var_334);
      }
      ...
      {
         if(this.var_1798 == AvatarEditorSideCategory.const_95)
         {
            this.var_2536 = false;
            this.setSideContent(AvatarEditorSideCategory.const_649);
         }
         else
         {
            this.setSideContent(AvatarEditorSideCategory.const_95);
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_649:
               break;
            case AvatarEditorSideCategory.const_461:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_461);
               break;
            case AvatarEditorSideCategory.const_95:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_95);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_334 = param1;
         this.var_497.setSelected(this.var_497.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_496)
         {
            ...
            this.var_496 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_496.procedure = this.stripClubDialogEventProc;
            this.var_496.center();
         }
         else
         {
            this.var_496.visible = true;
            this.var_496.center();
         }
      }
