package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1196:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1195:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1049:AvatarEditorHandler;
      ...
      private var var_841:IFigureData;
      ...
      private var var_1305:IHabboAvatarEditorDataSaver = null;
      
      private var var_1638:Boolean = false;
      
      private const const_1194:int = 2;
      ...
      private function init() : void
      {
         ...
         if(!this.var_170)
         {
            ...
            this.var_570["null"] = new FigureData(this);
            this.var_570["null"] = new FigureData(this);
            _loc1_ = this.var_570["null"];
            _loc2_ = this.var_570["null"];
            _loc1_.loadAvatarData(const_1196,FigureData.MALE);
            _loc2_.loadAvatarData(const_1195,FigureData.FEMALE);
            this.var_91 = new Map();
            this.var_460 = new Map();
            this.var_91.add(AvatarEditorFigureCategory.const_767,new BodyModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_42,new HeadModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_229,new TorsoModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_568,new LegsModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_949,new HotLooksModel(this));
            this.var_460.add(AvatarEditorSideCategory.const_95,new WardrobeModel(this));
            this.var_460.add(AvatarEditorSideCategory.const_461,new ClubPromoModel(this));
            this.var_170 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         this.var_1050 = param3;
         var _loc4_:FigureData = this.var_570[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_841.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_841.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_229 == null)
            {
               this.var_229 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_56,HabboWindowStyle.const_34,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_767);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_460.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_459 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_841 = this.var_459.getFigureData(AvatarType.const_102);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1049 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_570[this.var_812];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1305 != null)
         {
            ...
            this.var_1305.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1637;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1050 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1194)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1423.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_459.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_459.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1161.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1370)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1050 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1161.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1050 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_460.getValue(AvatarEditorSideCategory.const_95);
      }
