package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1611:Number = 1.0;
      
      private var var_1609:Number = 1.0;
      
      private var var_1608:Number = 1.0;
      ...
      {
         super();
         this.var_1577 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2119 = parseInt(_loc2_,16);
         this.var_2118 = parseInt(_loc3_,16);
         ...
         this.var_1480 = new ColorTransform(this.var_1611,this.var_1609,this.var_1608,this._alphaMultiplier);
         this.var_1012 = this.generatePaletteMapForGrayscale(this.var_2118,this.var_2119);
      }
      ...
      {
         return this.var_1012.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1012.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1012.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1012.getValue("alphas") as Array;
      }
