package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_356:AvatarRenderManager;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_781:AvatarActionManager;
      
      private var var_293:FigureData;
      
      private var var_355:PartSetsData;
      
      private var var_427:AnimationData;
      
      private var var_631:AnimationManager;
      
      private var var_926:ActionDefinition;
      
      private var var_422:String;
      
      private var var_1196:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         super();
         this.var_356 = param1;
         this.var_293 = new FigureData();
         this.var_355 = new PartSetsData();
         this.var_427 = new AnimationData();
         this.var_631 = new AnimationManager();
         this.var_422 = param2;
         this.var_522 = new Dictionary();
         this.var_1196 = param3;
      }
      ...
      {
         this.var_1196.loadOffsets(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_422);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_422);
            return;
         }
         this.var_781 = new AvatarActionManager(param1,this.var_422,param2);
         this.var_926 = this.var_781.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_422);
            return false;
         }
         if(this.var_355.parse(param1))
         {
            if(this.var_422 == AvatarType.const_102)
            {
               this.var_355.getPartDefinition("ri").appendToFigure = true;
               this.var_355.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_422);
            return false;
         }
         return this.var_427.parse(param1);
      }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_422);
            return false;
         }
         return this.var_293.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_293.injectXML(param1);
      }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_631.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_293.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_293.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return this.var_631.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_631.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_781.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_781.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_781.sortActions(param1);
      }
      
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(!this.var_522[param1])
         {
            this.var_522[param1] = new Dictionary();
         }
         if(this.var_522[param1][param2])
         {
            return this.var_522[param1][param2];
         }
         this.var_522[param1][param2] = this.var_293.getMandatorySetTypeIds(param1,param2);
         return this.var_522[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_293.getDefaultPartSet(param1,param2);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return this.var_781.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_631.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_355.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_355.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1449[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_355.getActiveParts(param3.definition);
         var _loc10_:Array = new Array();
         var _loc13_:* = [0];
         var _loc14_:AnimationAction = this.var_427.getAction(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc23_ = param3.definition.state + "." + param3.actionParameter;
            _loc9_ = this.var_631.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_293.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_293.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           {
                              _loc33_ = this.var_926;
                           }
                           _loc12_ = this.var_355.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_355.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         return this.var_1196.getOffset(param1,param2,param3,param4,param5,param6);
      }
