package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1817:String = "hd-99999-99999";
      ...
      private var var_665:PaletteManager;
      ...
      private var var_1575:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_611 = RenderMode.const_1520;
         ...
         this.var_93.add(AvatarType.const_102,_loc4_);
         ...
         this.var_665 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_307.init();
         this.var_665.init();
         _loc2_ = this.var_93.getValue(AvatarType.const_102) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_93.getValue(AvatarType.const_102) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_796)
         {
            if(this.var_2113 && this.var_2114 && this.var_2115)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_93.getValue(AvatarType.const_102) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1575)
         {
            this.var_1575 = new AvatarFigureContainer(this.const_1817);
         }
         this.var_196.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1575,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_270 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_270.getKeys())
         {
            _loc4_ = this.var_270.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1405)
         {
         ...
         if(param5 != null)
         {
            ...
            this.var_270.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_270.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_270.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_93.getValue(AvatarType.const_102) as AvatarStructure;
