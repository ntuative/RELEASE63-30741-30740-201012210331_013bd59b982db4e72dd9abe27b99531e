package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_1671 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2234 = parseInt(param1.@precedence);
         this.var_2229 = String(param1.@activepartset);
         this.var_2232 = String(param1.@assetpartdefinition);
         this.var_2233 = String(param1.@lay);
         this.var_696 = String(param1.@geometrytype);
         this.var_2031 = Boolean(parseInt(param1.@main));
         this.var_2231 = Boolean(parseInt(param1.@HabboInventoryCom_no_trade_icon_png));
         this.var_2235 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "HabboInventoryCom_no_trade_icon_png")
            {
               this.var_2230 = _loc6_;
            }
            else
            {
               this.var_1671[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_361[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_692.add(param1,new Map());
         }
         var _loc4_:Map = this.var_692.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_692.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1671[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2230;
         }
         return _loc2_;
      }
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_361[param1];
         if(_loc2_ != null)
         {
