package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1734:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this._state = name_1;
         this._assets = param4;
         this.var_878 = String(param1);
         this._revision = String(param2);
         this.var_1348 = param3 + this.var_878 + ".swf";
         this.var_1348 = this.var_1348.replace("%revision%",this._revision);
         var _loc5_:AssetLibraryCollection = this._assets as AssetLibraryCollection;
         var _loc6_:IAssetLibrary = _loc5_.getAssetLibraryByUrl(this.var_878 + ".swf");
         if(_loc6_ != null)
         {
            Logger.log("[AvatarAssetDownloadLibrary] Already Downloaded by Core: " + this.var_878);
            this._state = name_2;
         }
      }
      ...
      {
         this._state = var_1734;
         var _loc1_:URLRequest = new URLRequest(this.var_1348);
      ...
      {
         var _loc1_:String = this.var_878;
