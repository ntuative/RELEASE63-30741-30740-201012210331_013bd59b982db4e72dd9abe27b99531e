package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      public function SetType(param1:XML)
      {
         ...
         this.var_2550 = parseInt(param1.@paletteid);
         this.var_609 = new Dictionary();
         this.var_609["F"] = new Dictionary();
         this.var_609["M"] = new Dictionary();
         this.var_609["F"][0] = Boolean(parseInt(param1.@mand_f_0));
         this.var_609["F"][1] = Boolean(parseInt(param1.@mand_f_1));
         this.var_609["M"][0] = Boolean(parseInt(param1.@mand_m_0));
         this.var_609["M"][1] = Boolean(parseInt(param1.@mand_m_1));
      ...
      {
         return this.var_609[param1.toUpperCase()][Math.min(param2,1)];
      }
