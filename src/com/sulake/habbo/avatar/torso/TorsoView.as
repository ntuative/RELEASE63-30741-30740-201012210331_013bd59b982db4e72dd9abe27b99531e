   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(var_62,FigureData.const_216,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_62,FigureData.const_165,_windowManager,_assetLibrary);
         ...
         if(var_62 && var_128 == "")
         {
            var_62.switchCategory(FigureData.const_165);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_jacket":
                  ...
                  break;
               case "tab_shirt":
                  this.switchCategory(FigureData.const_165);
                  break;
