package com.sulake.habbo.avatar.alias
{
   ...
   public class AssetAliasCollection
   {
      ...
      private var var_459:AvatarRenderManager;
      ...
      public function addAlias(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         ...
         this.var_525[param1] = _loc6_;
      }
      
      public function hasAlias(param1:String) : Boolean
      {
         var _loc2_:AssetAlias = this.var_525[param1] as AssetAlias;
         return _loc2_ != null;
      }
      
      public function getAliasByName(param1:String) : AssetAlias
      {
         return this.var_525[param1] as AssetAlias;
      }
      ...
      public function getAssetByName(param1:String) : IAsset
      {
         ...
         {
            _loc4_ = this.var_525[param1] as AssetAlias;
            param1 = _loc4_.link;
            _loc2_--;
         }
         ...
         if(_loc3_ == null)
         {
            this.var_459.events.dispatchEvent(new AvatarRenderAssetErrorEvent(param1));
         }
         return _loc3_;
      }
   }
