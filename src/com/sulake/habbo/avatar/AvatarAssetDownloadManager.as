package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private const const_1400:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         this.var_897 = new Timer(this.const_1846,1);
         this.var_897.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_390)
         {
            ...
            this.var_390.addEventListener(AssetLoaderEvent.const_43,this.method_5);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_390)
         {
            ...
            this.var_390.removeEventListener(AssetLoaderEvent.const_43,this.method_5);
         }
      }
      ...
      private function method_5(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_898);
            if(this.var_1371.indexOf("?") > 0)
            {
               _loc2_ = this.var_1371 + "&retry=" + this.var_898;
            }
            else
            {
               _loc2_ = this.var_1371 + "?retry=" + this.var_898;
      ...
      private function loadFigureMapData(param1:XML) : void
      {
         ...
         this.var_1773 = true;
         for each(_loc2_ in this.var_1121)
         {
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2503,this._assets);
      ...
      public function loadFigureSetData(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1773)
         {
            this.var_1121.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_500[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_500[_loc3_] = _loc6_;
            }
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         while(_loc6_ < this.var_737.length)
         {
            _loc5_ = this.var_737[_loc6_];
            if(_loc5_.libraryName == (param1.target as AvatarAssetDownloadLibrary).libraryName)
            {
               this.var_737.splice(_loc6_,1);
            }
            _loc6_++;
         }
         this.var_897.start();
      ...
      {
         var _loc1_:* = null;
         while(this.var_736.length > 0 && this.var_737.length < this.const_1400)
         {
            _loc1_ = this.var_736[0];
            _loc1_.startDownloading();
            this.var_737.push(this.var_736.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_736.indexOf(param1) == -1 && this.var_737.indexOf(param1) == -1)
         {
