package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_44:IHabboCommunicationManager;
      ...
      private var var_1963:PseudoRandom;
      ...
      private var var_191:HabboHotelView;
      
      private var var_1216:String = "";
      
      private const const_1542:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_530 = param1;
            this.var_44.initConnection(HabboConnectionType.const_228);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_18.events.addEventListener(RoomSessionEvent.const_87,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_44 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_44.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_44.addHabboConnectionMessageEvent(new HelloMessageEvent(this.onHelloEvent));
            this.var_44.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_44.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_44.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_44.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_44.addHabboConnectionMessageEvent(new StartRegistrationEvent(this.onStartRegistration));
            this.var_44.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_44.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_44.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_44.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_44.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_44.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_44.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_44.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_44 && this._habboConfiguration && this.var_18 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_191 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_191.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this._habboConfiguration.getKey("use.sso.ticket") == "1";
         this.var_530 = this._habboConfiguration.getKey("sso.ticket",null);
         this.var_1484 = this._habboConfiguration.getKey("flash.client.url","");
         this.var_1965 = this._habboConfiguration.getKey("external.variables.txt","");
         if(this.var_191 == null)
         {
            this.var_191 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_44.mode = HabboConnectionType.const_112;
            if(this.var_530)
            {
               this.var_44.initConnection(HabboConnectionType.const_228);
            }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_44.mode = HabboConnectionType.const_992;
            }
         }
         this.var_44.initConnection(HabboConnectionType.const_228);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_44.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_794);
            _loc3_ = new InitCryptoMessageComposer(this.var_44.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_1963 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_44.mode)
         {
            case HabboConnectionType.const_112:
               _loc6_ = "";
               ...
               this.var_1216 = _loc4_;
               this.var_191.loadBannerImage(_loc7_ + "?token=" + this.var_1216,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_992:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1470:
               this.var_793 = this.generateRandomHexString(30);
               this.var_429 = new DiffieHellman(new BigInteger(this._habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(this._habboConfiguration.getKey("connection.development.generator"),16));
               this.var_429.init(this.var_793);
               _loc8_ = this.var_429.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_44.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_429.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_429.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_1963);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1484,this.var_1965));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1542,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_530 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_530);
            _loc2_.send(_loc4_);
      ...
      {
         var _loc4_:IConnection = this.var_44.getHabboMainConnection(null);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_231);
      }
      ...
      private function onStartRegistration(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_200);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1217)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_182);
         }
         if(param1.type == Event.CLOSE && !this.var_1964)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1216);
         ...
         var _loc9_:IConnection = this.var_44.getHabboMainConnection(null);
         ...
         this.var_429 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_429.init(_loc14_);
            _loc15_ = this.var_429.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_793 = _loc14_;
            }
