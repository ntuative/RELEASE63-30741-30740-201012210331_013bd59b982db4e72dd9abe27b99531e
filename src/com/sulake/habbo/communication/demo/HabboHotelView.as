package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1033:Function;
      
      private var var_1031:Function;
      
      private var var_673:IAssetLibrary;
      
      private var var_1032:uint = 0;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_673.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_673.getAssetByName(_loc2_.assetName);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_30)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_506));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
            if(this._window && !this._window.disposed)
            {
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_673.loadAssetFromFile("hotel_view_banner_" + this.var_1032,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
