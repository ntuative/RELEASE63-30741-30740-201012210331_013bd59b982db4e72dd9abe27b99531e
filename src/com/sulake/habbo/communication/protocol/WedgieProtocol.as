package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1502:uint = 1;
      
      public static const const_1319:uint = 2;
       
      
      private var var_1264:IProtocolEncoder;
      
      private var var_998:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1264 = new WedgieEncoder();
         this.var_998 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1502)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_998.getID(_loc4_);
