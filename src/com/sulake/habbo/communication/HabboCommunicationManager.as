package com.sulake.habbo.communication
{
   ...
   public class HabboCommunicationManager extends Component implements IHabboCommunicationManager, IConnectionStateListener
   {
      ...
      private var var_1341:IMessageConfiguration;
      ...
      {
         this.var_1341 = new HabboMessages();
         this.var_246 = [];
         this.var_1385 = new Timer(100,1);
      ...
      {
         if(this.var_246.length == 0 || this.var_398 < 0 || this.var_398 >= this.var_246.length)
         {
            return 0;
         }
         return this.var_246[this.var_398];
      }
      ...
      private function onCoreCommunicationManagerInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_283.registerProtocolType(HabboProtocolType.const_1070,WedgieProtocol);
            this._connection = this.var_283.createConnection(HabboConnectionType.const_228,ConnectionType.const_964);
            _loc3_ = this.var_283.getProtocolInstanceOfType(HabboProtocolType.const_1070);
            this._connection.registerMessageClasses(this.var_1341);
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!_loc4_)
            {
               Core.crash("Tried to connect to an invalid host: " + this.var_33,Core.const_302);
               return;
            }
            _loc5_ = _loc3_.split(",");
      ...
      private function nextPort() : void
      {
         ...
         ++this.var_398;
         if(this.var_398 >= this.var_246.length)
         {
            ErrorReportStorage.addDebugData("ConnectionRetry","Connection attempt " + this.var_909);
            ++this.var_909;
            ...
            if(this.var_909 > _loc1_)
            {
               ...
               this.var_2553 = true;
               Core.error("Connection failed to host " + this.var_33 + " ports " + this.var_246,true,Core.const_302);
               return;
            }
            this.var_398 = 0;
         }
         this._connection.timeout = this.var_909 * 10000;
         this._connection.init(this.var_33,this.var_246[this.var_398]);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication IO Error","IOError " + param1.type + " on connect: " + param1.text + ". Port was " + this.var_246[this.var_398]);
         this.tryNextPort();
      }
      
      private function onConnect(param1:Event) : void
      {
         ErrorReportStorage.addDebugData("Connection","Connected with " + this.var_909 + " attempts");
      }
      
      private function tryNextPort() : void
      {
         this.var_1385.addEventListener(TimerEvent.TIMER,this.onTryNextPort);
         this.var_1385.start();
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication Security Error","SecurityError on connect: " + param1.text + ". Port was " + this.var_246[this.var_398]);
         this.tryNextPort();
      }
      
      public function getHabboMainConnection(param1:Function) : IConnection
      {
         return !!this.var_283 ? this.var_283.queueConnection(HabboConnectionType.const_228,param1) : null;
      }
      ...
      public function addHabboConnectionMessageEvent(param1:IMessageEvent) : void
      {
         if(this.var_283)
         {
            this.var_283.addConnectionMessageEvent(HabboConnectionType.const_228,param1);
         }
      }
      ...
      public function connectionInit(param1:String, param2:int) : void
      {
         ...
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1476,String(param2));
      }
      ...
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1412,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1394,param1 + " " + param2);
         if(this.var_126.length > 0)
         {
