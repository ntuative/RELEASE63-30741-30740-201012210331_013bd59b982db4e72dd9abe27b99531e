package com.sulake.habbo.communication.messages.parser.room.engine
{
   ...
   public class UsersMessageParser implements IMessageParser
   {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(_loc13_ == 1)
            {
               ...
               _loc14_.userType = RoomObjectTypeEnum.const_371;
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_209;
               _loc14_.figure = _loc7_;
               _loc14_.webID = _loc4_;
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_887;
               ...
               _loc14_.sex = UserMessageData.const_968;
            }
            _loc3_++;
         }
         return true;
      ...
      private function resolveSex(param1:String) : String
      {
         ...
         {
            return UserMessageData.const_1347;
         }
         return UserMessageData.const_968;
      }
