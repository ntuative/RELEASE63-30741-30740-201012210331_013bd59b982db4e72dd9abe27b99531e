package com.sulake.habbo.communication.encryption
{
   ...
   public class RC4_R27 extends RC4 implements IEncryption
   {
      ...
      private static const const_1241:String = "mWxFRJnGJ5T9Si0OMVvEBBm8laihXkN8GmH6fuv7ldZhLyGRRKCcGzziPYBaJom";
      
      private static const const_1242:int = 52;
      ...
      private static const const_829:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
       
      
      private var var_1803:IEncryption;
      
      private var var_2551:PseudoRandom;
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:ByteArray = CryptoTools.stringToByteArray(const_1241);
         var _loc4_:int = 0;
      ...
      override public function encipher(param1:ByteArray, param2:Boolean = false) : ByteArray
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:int = 0;
         if(this.var_1803 != null)
         {
            _loc7_ = new ByteArray();
            _loc8_ = new ByteArray();
            _loc6_ = this.var_2551.nextInt() % 5;
            ...
            _loc5_ = this.var_1803.encipher(_loc7_,true);
