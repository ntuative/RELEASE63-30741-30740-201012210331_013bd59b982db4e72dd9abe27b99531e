package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_886:uint = 11;
      ...
      private var var_184:IHabboFriendList;
      
      private var var_1144:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_162:IHabboHelp;
      ...
      private var var_248:LatencyTracker = null;
      
      private var var_614:LagWarningLogger = null;
      
      private var var_616:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_248 = new LatencyTracker();
         this.var_614 = new LagWarningLogger();
         this.var_616 = new ToolbarClickTracker(this);
         this.var_1393 = new Array(const_886);
         var _loc4_:int = 0;
         while(_loc4_ < const_886)
         {
            this.var_1393[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1455,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1409,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1265,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_635,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1014,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_184)
            {
               if(!this.var_184.disposed)
               {
                  Component(this.var_184).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_184).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_184).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_184).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_184).events.removeEventListener(HabboFriendListTrackingEvent.const_331,this.onFriendlistTrackingEvent);
               }
               this.var_184.release(new IIDHabboFriendList());
               this.var_184 = null;
            }
            if(this.var_162)
            {
               if(!this.var_162.disposed)
               {
                  this.var_162.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_162.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_162.release(new IIDHabboHelp());
               this.var_162 = null;
            }
            if(this._toolbar)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._configuration)
         {
            if(this.var_248 != null)
            {
               this.var_248.configuration = this._configuration;
            }
            if(this.var_249 != null)
            {
            ...
            if(this._configuration)
            {
               ...
               {
                  this.var_616.configure(this._configuration);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_794,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_231,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_200,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_506,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_248 != null)
            {
               this.var_248.communication = this._communication;
               this.var_248.connection = param1;
            }
            if(this.var_614 != null)
            {
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1297);
         }
         else if(param1.type == HabboHotelViewEvent.const_506)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1279);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_794:
               this.trackLoginStep(HabboLoginTrackingStep.const_1367,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_173:
               ...
               break;
            case HabboCommunicationEvent.const_231:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_231);
               if(this.var_248 != null)
               {
                  this.var_248.init();
               }
            ...
            case HabboCommunicationEvent.const_200:
               this.trackLoginStep(HabboLoginTrackingStep.const_200);
         }
         if(this._communication)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this._configuration)
            {
               if(this._configuration.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1393)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_977);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_977,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_184 = param2 as IHabboFriendList;
         Component(this.var_184).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_184).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_184).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_184).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_184).events.addEventListener(HabboFriendListTrackingEvent.const_331,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_162 = param2 as IHabboHelp;
         this.var_162.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_162.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2559)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1397);
            this.var_2559 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1014,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_635,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_301,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_267 = param2 as IAdManager;
         this.var_267.events.addEventListener(AdEvent.const_513,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_616)
         {
            this.var_616.track(param1.iconName);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_499 > -1 && _loc2_ < this.var_499)
         {
            ++this.var_1819;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1819);
         }
         if(this.var_499 > -1 && _loc2_ - this.var_499 > 15000)
         {
            ++this.var_1820;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1820);
         }
         this.var_499 = _loc2_;
         if(this.var_249 != null)
         {
            this.var_249.update(param1,this.var_499);
         }
         if(this.var_248 != null)
         {
            this.var_248.update(param1,this.var_499);
         }
         if(this.var_615 != null)
         {
            this.var_615.trackUpdate(param1,this,this.var_499);
         }
         if(this.var_614 != null)
         {
            this.var_614.update(this.var_499);
         }
      }
   }
}
