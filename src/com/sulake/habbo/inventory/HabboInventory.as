package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1082:IRoomSession;
      ...
      private const const_1843:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_18 != null)
         {
            this.var_18.events.removeEventListener(RoomSessionEvent.const_80,this.roomSessionEventHandler);
            this.var_18.events.removeEventListener(RoomSessionEvent.const_87,this.roomSessionEventHandler);
            this.var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_437,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_46.getValue(InventoryCategory.const_77));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_46.getValue(InventorySubCategory.const_271));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_46.getValue(InventoryCategory.const_656));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_46.getValue(InventoryCategory.const_261));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_46.getValue(InventoryCategory.const_360));
      }
      ...
      {
         return PetsModel(this.var_46.getValue(InventoryCategory.const_154));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_46.getValue(InventoryCategory.const_313) as MarketplaceModel;
      }
      ...
      public function get clubLevel() : int
      {
         ...
         {
            return HabboClubLevelEnum.const_48;
         }
      ...
      {
         this.var_375 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_18.events.addEventListener(RoomSessionEvent.const_80,this.roomSessionEventHandler);
         this.var_18.events.addEventListener(RoomSessionEvent.const_87,this.roomSessionEventHandler);
         this.var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_437,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_87:
               this.var_1082 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_437:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_375 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_18 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_46.add(InventoryCategory.const_313,_loc1_);
         ...
         this.var_46.add(InventoryCategory.const_77,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_375);
         this.var_46.add(InventoryCategory.const_261,_loc3_);
         ...
         this.var_46.add(InventoryCategory.const_656,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_375);
         this.var_46.add(InventoryCategory.const_360,_loc5_);
         ...
         this.var_46.add(InventorySubCategory.const_271,_loc6_);
         ...
         this.var_46.add(InventoryCategory.const_154,_loc8_);
         this.var_170 = true;
         if(this.var_2449)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_888.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1843);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_960));
      }
