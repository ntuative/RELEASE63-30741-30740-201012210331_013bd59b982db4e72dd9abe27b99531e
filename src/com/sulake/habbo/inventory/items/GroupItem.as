package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_625:BitmapData;
      
      protected var var_2524:int;
      
      protected var var_1426:Boolean;
      
      protected var var_1888:Boolean;
      
      protected var var_2629:BitmapData;
      
      private const const_1815:int = 8947848;
      
      private const const_1814:int = 13421772;
      
      private const const_1545:Number = 1;
      
      private const const_1544:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1340));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1889);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1544;
               _loc1_.blend = this.const_1544;
            }
            else
            {
               this._window.blend = this.const_1545;
               _loc1_.blend = this.const_1545;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1888 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2629;
               _loc5_.visible = true;
            }
            else
            {
