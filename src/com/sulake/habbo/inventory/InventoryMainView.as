package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2655:IWindowContainer;
      ...
      public function dispose() : void
      {
         ...
         if(this._toolbar)
         {
            ...
            {
               this._toolbar.events.removeEventListener(HabboToolbarEvent.const_69,this.onHabboToolbarEvent);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this._toolbar != null && this.var_971)
         {
         ...
         this._controller.inventoryViewOpened(this.var_650);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_651 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this._toolbar != null && this.var_971)
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_650);
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_109,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1505);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_651 == InventoryCategory.const_154)
            {
               this.toggleCategoryView(InventoryCategory.const_154);
            }
            else if(this.var_651 == InventoryCategory.const_77)
            {
               this.toggleCategoryView(InventoryCategory.const_77);
            }
            else if(this._controller != null)
            {
               this._controller.toggleInventoryPage(InventoryCategory.const_77);
            }
         }
      }
