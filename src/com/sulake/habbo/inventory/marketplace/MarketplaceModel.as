package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this._controller != null && this._controller.furniModel != null && this.var_189 != null)
         {
            this._controller.furniModel.removeLockFrom(this.var_189.id);
            this.var_189 = null;
         }
      }
      ...
      {
         if(this.var_189 != null || param1 == null)
         {
            return;
         }
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_189 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_189.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_189 is FloorItem ? 1 : 2;
         this.var_2049 = _loc2_;
         this.var_2046 = this.var_189.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_189.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_189);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_1539,this.var_1540);
         }
      }
      ...
      {
         if(param1 != this.var_2049 || param2 != this.var_2046)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2047);
      }
