package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_401 = new Timer(1000,1);
         this.var_401.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_375.events.addEventListener(BadgeImageReadyEvent.const_128,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_401)
            {
               this.var_401.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_401.reset();
               this.var_401 = null;
            }
            this._disposed = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_401.running);
         this.var_1148[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1148[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_375.getBadgeImage(param2.badgeId);
            this.var_1148[param2.badgeId] = _loc4_;
         }
