package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_346:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_198,this.onObjectPlaced);
         this._catalog = param7;
         this.var_556 = new Timer(const_1181,1);
         this.var_556.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2161 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_198,this.onObjectPlaced);
               }
            ...
            {
               this.var_556.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_556.stop();
               this.var_556 = null;
            }
            if(this.var_177 != null)
            {
               this.var_177.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_177.stop();
               this.var_177 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_329)
         {
         ...
         if(this.var_833 == null)
         {
            this.var_833 = this._windowManager.buildFromXML(this.var_2161) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_833.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_41,const_44];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_177 = new Timer(param1,1);
            this.var_177.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_177.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_77 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_44:
                  ...
                  break;
               case const_346:
                  this._controller.toggleInventoryPage(InventoryCategory.const_154);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_313);
      ...
      public function updateLocks() : void
      {
         ...
         var _loc7_:Array = [const_41,const_44];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_41,const_44];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_451.add(const_41,new Array());
         this.var_451.add(const_44,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_148)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_271;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_322 || _loc3_.category == FurniCategory.const_329 || _loc3_.category == FurniCategory.const_376)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1283 && param1.type == RoomEngineObjectEvent.const_198)
         {
            this.var_1283 = false;
         }
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_271:
               ...
               break;
            case InventorySubCategory.const_945:
               this.removeAllLocks();
               if(this._view != null)
               {
                  this._view.updateActionView();
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_753)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
