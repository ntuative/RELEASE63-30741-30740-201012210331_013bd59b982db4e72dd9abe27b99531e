package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_487 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            this.var_487.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var _loc3_:IWindow = this.var_487.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_39)
         {
            ...
            this.var_62.toggleItemSelection(this._category,this.var_487.getGridItemIndex(param1.window));
            this.var_601 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_601 != null && this.var_601 == param2 && !this.var_62.isTradingOpen)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_282)
         {
