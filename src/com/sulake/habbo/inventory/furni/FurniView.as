package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1858:int = 0;
      
      private const const_846:int = 1;
      
      private const const_1575:int = 2;
      
      private const const_1576:int = 3;
      
      private const const_1577:int = 42;
      
      private const const_1578:int = 120;
      ...
      private var var_740:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_498.add(FurniModel.const_41,new FurniGridView(this.var_62,FurniModel.const_41,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_498.add(FurniModel.const_44,new FurniGridView(this.var_62,FurniModel.const_44,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_498.getValue(this.var_397);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_62.getCategoryContent(this.var_397);
         if(!this.var_62.isListInited())
         {
            _loc2_ = this.const_846;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1575;
         }
         else
         {
            _loc2_ = this.const_1576;
         }
         if(this.var_2546 == _loc2_)
         {
            return;
         }
         this.var_2546 = _loc2_;
         ...
         switch(_loc2_)
         {
            case this.const_846:
               ...
               break;
            case this.const_1575:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1576:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_41,FurniModel.const_44];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_498.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_498.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_498.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_62.getGroupItemInIndex(_loc3_,this.var_397);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_329)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_148)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_740 && this.var_740.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1578)
         {
            _loc3_ = this.const_1578;
         }
         else if(_loc3_ < this.const_1577)
         {
            _loc3_ = this.const_1577;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_58)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_346);
            }
         }
      }
   }
