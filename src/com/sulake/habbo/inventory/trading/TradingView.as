package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_844:uint = 4284532064;
      
      private static const const_843:uint = 2577770;
      ...
      private var var_369:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_369 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1568 = this.createMinimizedWindow();
         }
         if(!this.var_2098)
         {
            return this.var_64;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_64)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_844) : uint(const_843);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_844) : uint(const_843);
            }
         ...
         if(this.var_64)
         {
            ...
            switch(this.var_22.state)
            {
               ...
               case TradingModel.const_324:
                  ...
                  break;
               case TradingModel.const_308:
                  _loc1_.enable();
                  _loc1_.caption = "${inventory.trading.confirm}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_445:
                  _loc1_.disable();
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_148)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_1020)
            {
            ...
            this.var_369.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_400);
            this.var_369.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_369.hideDelayed();
         }
      }
