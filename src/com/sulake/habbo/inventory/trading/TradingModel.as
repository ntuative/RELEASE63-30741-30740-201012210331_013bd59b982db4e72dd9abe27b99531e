package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1310:uint = 9;
      ...
      public static const const_445:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_49.updateItemList(this.var_718);
         this.var_49.updateItemList(this.var_1357);
      ...
      public function close() : void
      {
         if(this.var_729)
         {
            if(this._state != const_181 && this._state != const_238)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_181;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_945);
            this.var_729 = false;
         }
      ...
      {
         this.var_49.setMinimized(param1 != InventoryCategory.const_77);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_719 + " OTHER: " + this.var_1100);
         ...
         {
            case const_181:
               if(param1 == const_180 || param1 == const_238)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_279.length)
         {
            _loc2_ = this.var_279.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_49.alertPopup(TradingView.const_1039);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_718)
            {
               this.var_719 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1100 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_49.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_718)
            {
               this.var_49.alertPopup(TradingView.const_955);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_279.length < const_1310)
         {
         ...
         else
         {
            ...
            if(this.var_279.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
