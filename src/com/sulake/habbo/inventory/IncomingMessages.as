package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_77);
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_77,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_656);
         _loc2_.refreshViews();
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_360);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this._inventory.toggleInventorySubPage(InventorySubCategory.const_271);
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_148)
            {
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_154);
      ...
      {
         var _loc2_:* = null;
         if(this._inventory.isInventoryCategoryInit(InventoryCategory.const_313))
         {
