package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(this.var_1043.add(param1.id,param1))
         {
      ...
      {
         if(param1 == InventoryCategory.const_154 && this._controller.isVisible)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1631 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER,RoomObjectTypeEnum.const_209,_loc3_.figure);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1631 && param1.type == RoomEngineObjectEvent.const_198)
         {
