package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_907[_loc2_] == param1)
            {
               this.var_907.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_375.getBadgeImage(param1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = this.var_244[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < this.var_244.length)
               {
                  if((this.var_244[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(this.var_244[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
