package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1228:int = 10;
      
      private static const const_875:int = 100;
      ...
      private var var_2382:IScrollbarWindow;
      
      private var var_1742:IContainerButtonWindow;
      
      private var var_52:IItemListWindow;
      
      private var var_478:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_123 = param1;
         this.var_1742 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_52 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2382 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_123.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_875 + const_1229)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_123.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1228;
         param1.invalidate();
      }
      ...
      {
         var _loc1_:Conversation = this.var_123.conversations.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
         if(this.var_478 == null || _loc1_.id != this.var_478.id)
         {
            this.var_478 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_478.followingAllowed)
         {
            this.var_1742.enable();
         }
         else
         {
            this.var_1742.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_52.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_478.messages.length - const_875);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_478.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_478.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_123.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_650 || param3.type == Message.const_626 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_478.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_123.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_123.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_123.send(new FollowFriendMessageComposer(this.var_478.id));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_123.conversations.closeConversation();
