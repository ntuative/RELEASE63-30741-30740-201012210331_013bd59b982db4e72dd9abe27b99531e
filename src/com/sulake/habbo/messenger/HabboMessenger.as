package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_583:Conversations;
      
      private var var_232:MessengerView;
      ...
      {
         var _loc2_:Conversation = this.var_583.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            this.var_583.setSelected(_loc2_);
            this.var_232.openMessenger();
            this.var_232.refresh();
         }
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_583.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_583.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         this.var_583 = new Conversations(new ConversationsDeps(this));
         this.var_232 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_153,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_109,HabboToolbarIconEnum.MESSENGER));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_232.isMessengerOpen())
            {
               this.var_232.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_626,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1018,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_583.addMessageAndUpdateView(param1);
         if(!this.var_232.isMessengerOpen())
         {
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         this.var_583.addMessageAndUpdateView(_loc3_);
      }
