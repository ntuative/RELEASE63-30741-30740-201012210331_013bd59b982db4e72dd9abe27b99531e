package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_526:ToolbarBarMenuAnimator;
      ...
      private var var_1281:Number;
      
      private var var_1956:int = 5;
      
      private var var_2159:int;
      
      private var var_139:Number;
      
      private var var_2160:XML;
      ...
      {
         return this.var_1282.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2160.elements("menu");
         var _loc5_:int = 0;
      ...
      public function get size() : Number
      {
         ...
         {
            if(this.var_272[_loc2_].exists)
            {
               _loc1_ += this.var_1281;
            }
            _loc2_++;
         }
         return _loc1_;
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1280.length)
         {
            _loc2_ = this.var_670.indexOf(this.var_1280[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_272[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1111 + _loc3_);
                  _loc3_ += this.var_1281;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_272[this.var_670.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,param1,this._events,this.var_526);
         this.var_35.addChild(_loc2_.window);
         this.var_670.push(param1);
         this.var_272.push(_loc2_);
         return _loc2_;
      }
   }
}
