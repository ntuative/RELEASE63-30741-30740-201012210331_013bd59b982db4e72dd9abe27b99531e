package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private const const_1554:int = 10;
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_1554;
         _loc3_.y = this.const_1554;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_565)
         {
            this.var_565 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
