package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1290:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_1290 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_109,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_888,this.onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_529,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_993,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_943,this.onHideWindowEvent);
         this._state = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_69));
      }
