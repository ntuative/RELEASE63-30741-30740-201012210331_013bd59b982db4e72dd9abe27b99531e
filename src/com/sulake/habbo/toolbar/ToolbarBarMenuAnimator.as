package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1221:Number = 25;
      
      private static const const_1222:Number = 90;
      
      private static const const_874:int = 50;
      
      private static const const_1227:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1351:ToolbarView;
      ...
      {
         this.var_331 = new Array();
         this._itemList = new Object();
         this.var_589 = new Object();
         this.var_587 = new Array();
         this.var_588 = new Array();
         super();
         this._windowManager = param1;
         this.var_1351 = param2;
         this.var_706 = new Timer(const_1221);
         this.var_706.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_331[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_874 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_874 || param1.desktop.height - param1.y < const_1227;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1351.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_331.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1351.getIconLoc(param1.iconId);
      ...
      {
         return this.var_587[this.var_588.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_588[this.var_587.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_588.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_588.splice(_loc3_,1);
            this.var_587.splice(_loc3_,1);
         }
         this.var_587.push(param1.name);
         this.var_588.push(param2);
         param1.addEventListener(WindowEvent.const_326,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_208,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_589[_loc3_] == null)
            {
               this.var_589[_loc3_] = new Array();
            }
            if(this.var_589[_loc3_].indexOf(param1) < 0)
            {
               this.var_589[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_331.indexOf(param1) > -1)
         {
            if(const_195)
            {
            ...
            else
            {
               ...
               this.var_331.splice(this.var_331.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_587[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_588[_loc2_];
               if(this.var_589[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_589[_loc3_].length)
                  {
                     this.repositionWindow(this.var_589[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         if(this.var_331.length == 0)
         {
            this.var_706.stop();
         }
         var _loc7_:int = 0;
         while(_loc7_ < this.var_331.length)
         {
            _loc2_ = this._itemList[this.var_331[_loc7_]];
            if(_loc2_.active)
            {
