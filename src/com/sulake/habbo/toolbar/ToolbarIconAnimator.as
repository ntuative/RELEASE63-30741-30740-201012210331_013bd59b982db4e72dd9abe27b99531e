package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_846.push(_loc11_);
                  this.var_847.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_846.push(new XML());
               this.var_847.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_847[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1311 == true || this.var_849 == 0)
         {
            if(this.var_846.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_846.length)
               {
                  this._frame = 0;
                  ++this.var_849;
               }
      ...
      {
         return this.var_846.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1311 == false && this.var_849 == 1 && this.var_1469 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_847.length)
         {
            _loc2_ = this.var_847[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_848.width),Math.max(param2.height,this.var_848.height));
            _loc3_.copyPixels(this.var_848,this.var_848.rect,new Point(0,0));
