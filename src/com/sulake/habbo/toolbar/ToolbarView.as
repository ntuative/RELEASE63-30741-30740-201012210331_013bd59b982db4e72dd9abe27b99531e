package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1080:Boolean = true;
      
      private var var_1081:Number = 1;
      
      private var var_1344:Number = 0;
      
      private var var_1720:Number = 15;
      
      private var var_1721:Number = 5;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2670 = new Array();
         ...
         this.var_139 = this._window.width;
         this.var_206 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_56,HabboWindowStyle.const_1032,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1080 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1080)
         {
         ...
         this.var_1081 = _loc6_.toolbar.@margin_top;
         this.var_1344 = _loc6_.toolbar.@margin_bottom;
         this.var_1720 = _loc6_.toolbar.@min_group_margin;
         this.var_1721 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_259 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_236,param1,param2,this._window,this.var_259);
         this.createGroupsFromXmlList(_loc8_,this.var_585,param1,param2,this.var_206,this.var_259);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,this._events,param5,param6,this.var_139);
      ...
      {
         var _loc1_:* = null;
         while(this.var_236.length > 0)
         {
            _loc1_ = this.var_236.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(this.var_585.length > 0)
         {
            _loc1_ = this.var_585.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_139,this.var_475,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_475);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_139,this.var_475);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_139,this.var_475);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_585.length)
         {
            _loc2_ = this.var_585[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_206.x = this.var_139 + this.var_1721;
               this.var_206.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_139;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_139;
               this._window.y = 0;
               this.var_206.x = 0;
               this.var_206.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_139;
               this._window.x = 0;
               this._window.y = 0;
               this.var_206.x = 0;
               this.var_206.y = this.var_139 + this.var_1721;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_139;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_139;
               this.var_206.x = 0;
               this.var_206.y = 0;
               _loc4_ = this._window.width;
         }
         _loc4_ -= this.var_1344;
         _loc4_ -= this.var_1081;
         var _loc5_:* = 0;
         _loc2_ = 0;
         while(_loc2_ < this.var_236.length)
         {
            _loc3_ = this.var_236[_loc2_];
            _loc5_ += _loc3_.iconCount * _loc3_.defaultIconSize;
            _loc2_++;
         }
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1081;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_236.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1720,(this._window.height - _loc5_ * _loc8_ - this.var_1081 - this.var_1344) / (this.var_236.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1720,(this._window.width - _loc5_ * _loc8_ - this.var_1081 - this.var_1344) / (this.var_236.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_236.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_475;
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_139)
         {
            return "RIGHT";
         }
         if(param2 <= this.var_139)
         {
            return "TOP";
         }
         if(param2 >= _loc3_.height - this.var_139)
         {
            return "BOTTOM";
         }
         return null;
