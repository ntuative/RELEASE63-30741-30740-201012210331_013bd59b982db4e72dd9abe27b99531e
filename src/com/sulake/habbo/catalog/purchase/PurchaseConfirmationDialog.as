package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_606:IWindowContainer;
      ...
      private const const_1581:uint = 4.293848814E9;
      
      private const const_1580:uint = 4.294967295E9;
      
      private const const_1847:uint = 4.291613146E9;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_78:
                  ...
                  break;
               case ProductTypeEnum.const_253:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1650 = _loc1_.stuffTypes;
            this.var_742 = _loc1_.boxTypes;
            this.var_743 = _loc1_.ribbonTypes;
            this.var_1126 = this.var_1650[0];
            this.var_337 = this.var_742[0];
            this.var_339 = this.var_743[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_339 < 0)
         {
            this.var_339 = this.var_743.length - 1;
         }
         if(this.var_339 > this.var_743.length - 1)
         {
            this.var_339 = 0;
         }
         if(this.var_337 < 0)
         {
            this.var_337 = this.var_742.length - 1;
         }
         if(this.var_337 > this.var_742.length - 1)
         {
            this.var_337 = 0;
         }
         var _loc1_:int = this.var_742[this.var_337] * 1000 + this.var_743[this.var_339];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_87.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1126,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1378 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1650;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1126);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_742[this.var_337]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_743[this.var_339]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_87,this.var_1377,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_87.offerId,this.var_1377);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_110:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(this.var_2521 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_208)
               {
            ...
            case WindowMouseEvent.const_39:
               ...
               break;
            case WindowKeyboardEvent.const_728:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_338 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_338 + 1);
                     break;
      ...
      {
         if(this.var_242 == null || !this.var_242.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_242.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_338) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_242 == null)
         {
            this.var_242 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_606 == null)
         {
            this.var_606 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_606.procedure = this.suggestionsEventHandler;
         }
         if(this.var_242 == null || this.var_606 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_242.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_606.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_338) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_338);
         }
         this.var_338 = param1;
         if(this.var_338 < 0)
         {
            this.var_338 = _loc2_.numListItems - 1;
         }
         if(this.var_338 >= _loc2_.numListItems)
         {
            this.var_338 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_338) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1847;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1581) : uint(this.const_1580);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_242.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1126;
               }
            }
            _loc4_++;
         }
