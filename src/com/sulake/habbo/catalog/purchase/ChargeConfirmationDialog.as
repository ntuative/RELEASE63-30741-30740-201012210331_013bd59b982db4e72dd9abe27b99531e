package com.sulake.habbo.catalog.purchase
{
   ...
   public class ChargeConfirmationDialog implements IDisposable
   {
      ...
      private var var_683:ChargeInfo;
      ...
      public function refresh() : void
      {
         ...
         {
            this.showChargeInfo(this.var_683);
         }
      }
      ...
      public function showChargeInfo(param1:ChargeInfo) : void
      {
         ...
         this._catalog.windowManager.registerLocalizationParameter("catalog.charge.currentamount","charges","" + this.var_683.charges);
         var _loc2_:BalanceAndCost = new BalanceAndCost(this._catalog,this._localization,new ChargeOffer(this.var_683));
         ...
         this._catalog.windowManager.registerLocalizationParameter("catalog.charge.info","patch_size","" + this.var_683.chargePatchSize);
      ...
      private function onCharge(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._catalog.connection.send(new UseFurnitureMessageComposer(this.var_683.stuffId,2));
      }
