package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyController
   {
      ...
      private var var_207:ClubBuyConfirmationDialog;
      ...
      {
         this.closeConfirmation();
         this.var_207 = new ClubBuyConfirmationDialog(this,param1,param2);
      }
      ...
      public function getClubType() : int
      {
         ...
         {
            _loc1_ = !!this._catalog.getPurse().isVIP ? 0 : int(HabboClubLevelEnum.const_59);
         }
         return _loc1_;
      }
