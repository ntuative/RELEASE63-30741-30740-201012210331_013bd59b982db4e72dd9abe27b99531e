package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1543:IProductData;
      ...
      {
         super();
         this.var_1541 = param1.productType;
         this.var_1542 = param1.furniClassId;
         this.var_1237 = param1.extraParam;
         this.var_1238 = param1.productCount;
         this.var_1544 = param1.expiration;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(this.productType)
         {
            ...
            case ProductTypeEnum.const_78:
               _loc6_ = _loc4_.getWallItemIcon(this.productClassId,param2,this.var_1237);
               break;
