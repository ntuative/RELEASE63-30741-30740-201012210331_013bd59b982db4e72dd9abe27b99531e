   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : void
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(this.var_389.getValue(_loc5_) == null)
            {
               this.var_389.add(_loc5_,new Map());
            }
            _loc7_ = this.var_389.getValue(_loc5_) as Map;
            _loc7_.add(_loc6_,_loc3_);
         }
         _loc4_ = this.var_389.getWithIndex(this.var_280);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_730);
            if(_loc3_ == null)
            {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_389.getWithIndex(this.var_280);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_730);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_280;
         if(this.var_280 >= this.var_389.length)
         {
            this.var_280 = 0;
         }
         var _loc2_:Map = this.var_389.getWithIndex(this.var_280);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_280 < 0)
         {
            this.var_280 = this.var_389.length - 1;
         }
         var _loc2_:Map = this.var_389.getWithIndex(this.var_280);
         if(_loc2_ != null)
         {
