package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IRecyclerVisualization
   {
      ...
      private function renderSlotGraphics() : void
      {
         ...
         _loc2_ = 1;
         while(_loc2_ <= RecyclerLogic.const_178)
         {
      ...
      public function updateSlots() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < RecyclerLogic.const_178)
         {
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_25:
               if(this.var_260 != null)
               {
                  this.var_260.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(this.var_260 == null)
               {
                  this.var_260 = new CatalogObjectMover();
                  this.var_260.mainContainer = window;
                  this.var_260.roomEngine = _loc3_;
               }
               this.var_260.onMainContainerEvent(param1,param2,_loc4_);
         }
      }
