package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1005:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1005.removeEventListener(WindowKeyboardEvent.const_145,this.windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         this.var_1005 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1005 != null)
         {
            this.var_1005.addEventListener(WindowKeyboardEvent.const_145,this.windowKeyEventProcessor);
         }
      }
