package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1550:int = 2;
      
      private const const_1821:int = 40;
      
      private const const_1820:int = 10;
      
      private var var_680:Array;
      
      private var var_1299:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_456)
         {
            this.var_456.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_456 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_680 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_680 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_680));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_559)
         {
            ...
            this.var_559 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_559)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1550,_loc2_.length);
         if(!this.var_456)
         {
            this.var_456 = new Timer(25);
            this.var_456.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1044 = 0;
         this.populateList();
         this.var_456.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1044 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1044));
            ++this.var_1044;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_559 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_559.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1549);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_680.length)
         {
            _loc4_ = this.var_680[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_110)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_1820;
                  break;
               case "search_input":
                  _loc8_ = this.const_1821;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1299.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_58)
