package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_495:IItemGridWindow;
      
      private var var_1379:IScrollbarWindow;
      
      protected var var_1781:XML;
      
      private var var_2530:Array;
      ...
      {
         this.var_903 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1131 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1794 = new Point(this.var_83.x,this.var_83.y);
         this.var_495 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1379 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1793 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_495 != null)
         {
            this.var_495.visible = false;
            this.var_495.destroyGridItems();
         }
         if(this.var_1379 != null)
         {
            this.var_1379.visible = false;
         }
         ...
         this.var_903.text = _loc4_;
         this.var_1131.text = _loc5_;
         this.var_903.height = this.var_903.textHeight + 5;
         this.var_1131.y = this.var_903.y + this.var_903.height;
         this.var_1131.height = Math.max(130,this.var_1131.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_531:
                  _loc6_ = this.var_1793.clone();
                  if(this.var_495 != null)
                  {
                     this.var_495.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_495,this.var_1379,this.var_1781);
                     this.var_495.scrollV = 0;
                  }
                  break;
               case Offer.const_490:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_253:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_42,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_277,AvatarAction.const_514);
                              _loc16_.appendAction(AvatarAction.const_279,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2530)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_83 != null && true)
         {
            ...
            this.var_83.x = this.var_1794.x;
            this.var_83.y = this.var_1794.y;
            if(param3 != null)
            {
