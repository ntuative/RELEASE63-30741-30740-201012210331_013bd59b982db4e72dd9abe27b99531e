package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1130:ITextFieldWindow;
      ...
      {
         super.init();
         this.var_1130 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(this.var_1130 != null)
         {
            this.var_1130.addEventListener(WindowKeyboardEvent.const_728,this.onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(this.var_1130.text));
      }
   }
}
