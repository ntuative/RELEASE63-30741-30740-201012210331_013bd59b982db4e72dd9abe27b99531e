package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1683:String = "HabboInventoryCom_no_trade_icon_png";
      
      private var var_1395:Array;
      
      private var _activeFloorPatterns:Array;
      
      private var var_403:int = 0;
      
      private var var_503:int = 0;
      
      private var var_922:int = 0;
      
      private var _floorType:String = "HabboInventoryCom_no_trade_icon_png";
      ...
      private var var_1684:String = "1.1";
               ...
               switch(_loc4_.furnitureData.name)
               {
                  ...
                  case "landscape":
                     for each(_loc11_ in this._configuration.landscapes.pattern)
                     {
                        ...
                        {
                           this.var_921.push(_loc7_);
                           _loc8_ = true;
                        }
                     }
                     if(_loc8_)
                     {
                        this.var_1397.push(_loc2_);
                     }
                     else
                     {
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1396[this.var_405];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1683);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1395[this.var_403];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1397[this.var_402];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1684);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_920[this.var_405];
         for each(_loc1_ in this._configuration.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(this.var_404 >= 0)
               {
                  _loc9_ = _loc1_.children()[this.var_404];
                  if(_loc9_ != null)
                  {
                     this.var_1683 = _loc9_.@id;
                  }
               }
            }
         }
         ...
         var _loc5_:String = this._activeFloorPatterns[this.var_403];
         for each(_loc1_ in this._configuration.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[this.var_503];
               if(_loc11_ != null)
               {
         ...
         _loc6_ = this.var_1395[this.var_403];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_921[this.var_402];
         for each(_loc1_ in this._configuration.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_502];
               if(_loc13_ != null)
               {
                  this.var_1684 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1397[this.var_402];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_197:
               ...
               if(this.var_405 < 0)
               {
                  this.var_405 = this.var_920.length - 1;
               }
               if(this.var_405 == this.var_920.length)
               {
                  this.var_405 = 0;
               }
               this.var_404 = 0;
               this.var_923 = 0;
               _loc5_ = this.var_920[this.var_405];
               for each(_loc8_ in this._configuration.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_923 = _loc8_.children().length();
                  }
               }
            ...
            case const_196:
               ...
               if(this.var_403 < 0)
               {
                  this.var_403 = this._activeFloorPatterns.length - 1;
               }
               if(this.var_403 >= this._activeFloorPatterns.length)
               {
                  this.var_403 = 0;
               }
               this.var_503 = 0;
               this.var_922 = 0;
               _loc6_ = this._activeFloorPatterns[this.var_403];
               for each(_loc9_ in this._configuration.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_922 = _loc9_.children().length();
                  }
               }
            ...
            case const_93:
               ...
               if(this.var_402 < 0)
               {
                  this.var_402 = this.var_921.length - 1;
               }
               if(this.var_402 >= this.var_921.length)
               {
                  this.var_402 = 0;
               }
               this.var_502 = 0;
               this.var_919 = 0;
               _loc7_ = this.var_921[this.var_402];
               for each(_loc10_ in this._configuration.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_919 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1683,this.var_1684,64,this,"window_romantic_wide");
         ...
         {
            this.var_1834 = _loc2_.id;
            this.var_1833 = _loc3_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_346 != null && this.var_345 != null)
         {
            this.setRoomImage(this.var_346,this.var_345);
         }
      }
   }
}
