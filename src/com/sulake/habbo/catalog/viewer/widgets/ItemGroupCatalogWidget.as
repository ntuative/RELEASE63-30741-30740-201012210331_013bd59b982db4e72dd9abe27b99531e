package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_540[this.var_980][this.var_1529];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_980 = var_1179.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_980];
         var _loc3_:Array = this.var_540[this.var_980] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1529 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1529] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_490 || _loc1_.pricingModel == Offer.const_421)
            {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_78 || _loc3_.productType == ProductTypeEnum.const_84)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_540.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_540[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
