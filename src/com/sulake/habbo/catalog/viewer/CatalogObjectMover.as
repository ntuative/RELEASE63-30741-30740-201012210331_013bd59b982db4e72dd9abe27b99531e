package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogObjectMover implements IGetImageListener
   {
      ...
      private static const const_390:String = "CatalogOverlaySprite";
      ...
      private function getIconSprite() : Sprite
      {
         ...
         return _loc1_.getChildByName(const_390) as Sprite;
      }
      ...
      private function releaseOverlaySprite() : void
      {
         ...
         var _loc1_:Sprite = this._mainContainer.desktop.getDisplayObject() as Sprite;
         var _loc2_:Sprite = _loc1_.getChildByName(const_390) as Sprite;
         if(_loc2_ == null)
         {
            return;
         }
         _loc2_.removeChildAt(0);
         _loc1_.removeChild(_loc1_.getChildByName(const_390));
      }
   }
}
