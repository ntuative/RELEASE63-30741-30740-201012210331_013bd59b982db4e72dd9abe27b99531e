package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1516:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array, param5:int) : void
      {
         ...
         {
            if(this.var_374.pageId == param1)
            {
               if(param5 > -1)
               {
                  this.var_374.selectOffer(param5);
               }
               return;
            }
            this._container.removeChild(this.var_374.window);
            this.var_374.dispose();
         }
         var _loc6_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,this.var_1516);
         this.var_374 = _loc6_;
      ...
      {
         return this.var_374.dispatchWidgetEvent(param1);
      }
      ...
      public function getCurrentLayoutCode() : String
      {
         ...
         return this.var_374.layoutCode;
      }
   }
}
