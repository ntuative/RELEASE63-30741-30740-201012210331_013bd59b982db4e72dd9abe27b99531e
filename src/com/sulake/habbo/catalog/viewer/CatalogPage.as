package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1529:String = "ctlg_";
       
      
      protected var var_1892:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1124:ICatalogViewer;
      ...
      private var var_1249:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1003);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1003);
      }
      ...
      {
         var _loc2_:String = const_1529 + param1;
         ...
         this.var_1892 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1892) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1376) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_1249 = new ItemGridCatalogWidget(_loc1_);
            this.var_57.push(this.var_1249);
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1373) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_57.push(new ItemGroupCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1386) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1352) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1480) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1259) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1384) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1463) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1263) as IWindowContainer;
         if(_loc1_ != null)
         {
