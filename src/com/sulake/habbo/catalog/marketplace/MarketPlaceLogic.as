package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private static const const_1199:String = "poster";
       
      
      public const const_1672:int = 1;
      
      public const const_1753:int = 2;
      
      public const const_1861:int = 3;
      ...
      private var var_2579:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_168)
         {
            for each(_loc1_ in this.var_168)
            {
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_207)
         {
            this.var_207 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_207.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2577,this.var_2576,this.var_2239,this.var_2578);
      }
      ...
      {
         if(!this.var_168 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_168.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
         ...
         this.showConfirmation(this.const_1672,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = this.var_212.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_212.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_472)
            {
               this.var_212.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         if(this.var_168)
         {
            for each(_loc5_ in this.var_168)
            {
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_168.add(_loc4_.offerId,_loc6_);
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         if(this.var_212)
         {
            for each(_loc5_ in this.var_212)
            {
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
         ...
         this.var_2358 = _loc3_.creditsWaiting;
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc6_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_212.add(_loc4_.offerId,_loc6_);
         }
         if(this._visualization == null)
         {
            return;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_168.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_168.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_168.add(parser.offerId,updateItem);
            }
            this.var_168.remove(parser.requestedOfferId);
            this.showConfirmation(this.const_1753,updateItem);
            this._visualization.listUpdatedNotify();
         }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_212.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2049 || param1.furniTypeId != this.var_2046)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1199)
               {
                  _loc2_ = true;
               }
            }
