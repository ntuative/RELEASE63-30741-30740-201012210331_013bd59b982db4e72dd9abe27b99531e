package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         {
            if(_loc4_ > this.var_521)
            {
               this.var_521 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_521).toString().length - 1);
         this.var_521 = Math.ceil(this.var_521 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_521.toString();
         _loc3_.draw(_loc6_);
         this.var_947 = param1 - _loc6_.textWidth - 2;
         this.var_780 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_780);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_780 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(this.var_947 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_947,(param2 - this.var_780) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_947 + this.var_947 / -this.var_2648 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_780 - this.var_780 / this.var_521 * this.var_158[param1];
      }
