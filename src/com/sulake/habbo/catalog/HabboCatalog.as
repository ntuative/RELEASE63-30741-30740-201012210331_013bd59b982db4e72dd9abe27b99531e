package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_329:CatalogViewer;
      
      private var var_328:ICatalogNavigator;
      ...
      private var var_278:ChargeConfirmationDialog;
      ...
      private var var_2359:GiftWrappingConfiguration;
      
      private var var_1088:ClubGiftController;
      
      private var var_476:ClubBuyController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_207 == null)
            {
               this.var_207 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_207.showOffer(this,param1,param2,param3,_loc4_);
         ...
         {
            this.var_476.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_328.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_375.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_375.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_78)
         {
            _loc3_ = this.var_375.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_110.getActivityPointsForType(Purse.const_452)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_109,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_735)
         {
            if(!this.var_375.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_329.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_328 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_329 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_329.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_233,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_80:
               this.var_1729 = param1.session.isPrivateRoom;
               if(this.var_86 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_122 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1088 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_476 == null)
         {
            this.var_476 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_328.buildCatalogIndex(_loc2_);
         if(this.var_705 && this.var_705 != "")
         {
            this.var_328.openPage(this.var_705);
            this.var_705 = "";
            this.var_876 = -1;
         }
         else if(this.var_876 > -1)
         {
            this.var_328.openPageById(this.var_876,this.var_1730);
            this.var_876 = -1;
            this.var_1730 = -1;
            this.var_705 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_329.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_329 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_329.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2361 && this.var_586 != null)
         {
            this.var_586.playSound(HabboSoundTypesEnum.const_1073);
         }
         this.var_2361 = false;
         if(this.var_278 != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2360 && this.var_586 != null)
         {
            this.var_586.playSound(HabboSoundTypesEnum.const_1104);
         }
         this.var_2360 = false;
         if(this.var_278 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1088.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_329.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_122 != null)
         {
            this.var_122.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_122 != null)
         {
            this.var_122.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_122 != null)
         {
            this.var_122.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2359 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_122.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_278 == null)
         {
            this.var_278 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_278.showChargeInfo(_loc2_);
      }
