package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1138:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1208:XML;
      
      private static var var_1206:XML;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1471 == 4294967295)
            {
               this.var_1471 = _loc1_.color;
            }
            _loc1_.color = const_1138;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1425;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1432;
            }
         }
      }
      ...
      {
         this.var_52 = navigator.catalog.windowManager.buildFromXML(var_1206) as IItemListWindow;
         if(this.var_52 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1208) as IWindowContainer;
         }
         else
         {
