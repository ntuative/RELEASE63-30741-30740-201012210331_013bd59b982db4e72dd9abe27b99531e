package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2654:String = "magic.pixels";
      
      private var var_2653:String = "catalog.page.club";
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_299.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in this.var_299)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_299.indexOf(_loc6_);
            this.var_299.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
         ...
         if(this.var_299.indexOf(param1) == -1)
         {
      ...
      {
         this.openPage(this.var_2654);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2653,true);
      }
