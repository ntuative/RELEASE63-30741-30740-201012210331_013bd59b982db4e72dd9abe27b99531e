package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private var var_271:IBitmapWrapperWindow;
      ...
      {
         var _loc8_:* = null;
         this.var_271 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_271 != null && !this.var_271.disposed)
         {
            ...
            this.var_271.bitmap = new BitmapData(this.var_271.width,this.var_271.height,true,16777215);
            this.var_271.bitmap.fillRect(this.var_271.bitmap.rect,16777215);
            _loc3_ = new Point((this.var_271.width - param1.width) / 2,(this.var_271.height - param1.height) / 2);
            this.var_271.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
