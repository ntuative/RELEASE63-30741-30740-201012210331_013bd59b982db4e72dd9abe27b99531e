package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public static const const_178:int = 5;
      ...
      {
         return this.var_579 != const_858;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1667 != RecyclerStatusMessageEvent.const_951;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_579 == const_387;
      }
      ...
      {
         this.var_579 = const_857;
         this.var_106 = new Array(const_178);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_178)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_579 = const_858;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1667)
         {
            case RecyclerStatusMessageEvent.const_1495:
               this.var_579 = const_387;
               if(this._view == null)
               {
                  return;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_951:
               if(this._view == null)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1371:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_934:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1337:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_106.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_178)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_106.length < const_178)
         {
            return false;
         }
         var _loc1_:int = 0;
