package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_571:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1053,param1);
         this.var_842 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_842);
         }
      ...
      {
         return int(this.var_1502 * (Number(param1 - this._minValue) / (this.var_1053 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1502 * (this.var_1053 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_843)
         {
            if(param1.type == WindowMouseEvent.const_55 || param1.type == WindowMouseEvent.const_167)
            {
               this.var_843 = false;
            }
         }
         if(!this.var_843 || param1.type != WindowEvent.const_326)
         {
            return;
         }
         if(this.var_571 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_571) * this.var_571;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_571 != 0)
            {
               _loc3_ = this.var_842 + this.var_571;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_649 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_649.width,this.var_649.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_649,this.var_649.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_648 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_648.width,this.var_648.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_648,this.var_648.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1502 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_649 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_648 = BitmapData(_loc2_.content);
      }
   }
}
