package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1807:TriggerConfs;
      
      private var var_1808:ActionTypes;
      
      private var var_1809:ConditionTypes;
      
      private var var_247:Dictionary;
      
      private var var_58:Triggerable;
      
      private var var_746:RoomObjectHightLighter;
      
      private var var_162:UserDefinedRoomEventsHelp;
      
      private var var_1141:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1807 = new TriggerConfs();
         this.var_1808 = new ActionTypes();
         this.var_1809 = new ConditionTypes();
         this.var_247 = new Dictionary();
         super();
         this.var_89 = param1;
         this.var_746 = new RoomObjectHightLighter(param1);
         this.var_162 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_247[param1])
         {
            delete this.var_247[param1];
            this.var_746.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_58.furniLimit)
         {
            this.var_247[param1] = param2;
            this.var_746.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1141 = new SliderWindowController(this.var_89,IWindowContainer(this.find(this.var_88,"delay_slider_container")),this.var_89.assets,0,20,1);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_746.hideAll(this.var_247);
         }
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_162.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1807);
         this.refreshConfigureElement(this.var_1808);
         this.refreshConfigureElement(this.var_1809);
