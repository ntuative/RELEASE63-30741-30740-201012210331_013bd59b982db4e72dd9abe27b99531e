package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1078:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1719 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1078 = this.var_1719.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1078)
         {
            this.var_1078.procedure = this.onButtonClick;
         }
         this.var_1079 = this.var_1719.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1079)
         {
            this.var_1079.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_235 >= this._localizations.length - 1)
         {
            this.var_1079.disable();
         }
         else
         {
            this.var_1079.enable();
         }
         if(this.var_235 <= 0)
         {
            this.var_1078.disable();
         }
         else
         {
            this.var_1078.enable();
         }
      }
      ...
      {
         ++this.var_235;
         this.var_235 = Math.min(this.var_235,this._localizations.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_235;
         this.var_235 = Math.max(this.var_235,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_235][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_235][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_235][1]).value;
