package com.sulake.habbo.roomevents.userdefinedroomevents.triggerconfs
{
   ...
   public class AvatarEntersRoom implements TriggerConf
   {
      ...
      {
         this._cont = param1;
         this.getCertainAvatarRadio().addEventListener(WindowEvent.const_525,this.onCertainAvatarSelect);
         this.getCertainAvatarRadio().addEventListener(WindowEvent.const_721,this.onCertainAvatarUnselect);
      }
