package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeUI implements INameChangeUI
   {
      ...
      {
         this.var_162.sendMessage(new ChangeUserNameMessageComposer(param1));
      }
      
      public function checkName(param1:String) : void
      {
         this.var_162.sendMessage(new CheckUserNameMessageComposer(param1));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         this.var_162.localization.registerParameter("help.tutorial.name.changed","name",name);
         this.var_162.windowManager.alert("${generic.notice}","${help.tutorial.name.changed}",0,function(param1:IAlertDialog, param2:Event):void
         {
            param1.dispose();
         });
      }
      ...
      {
         if(this.var_162 == null || this.var_162.assets == null)
         {
            return null;
         }
         var _loc3_:XmlAsset = XmlAsset(this.var_162.assets.getAssetByName(param1 + "_xml"));
         if(_loc3_ == null || this.var_162.windowManager == null)
         {
            return null;
         }
         var _loc4_:ICoreWindowManager = ICoreWindowManager(this.var_162.windowManager);
