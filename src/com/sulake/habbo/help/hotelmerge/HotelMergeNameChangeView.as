package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_671)
         {
            this.var_671 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_671)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_672)
         {
            this.var_672 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_672)
            {
               return;
            }
