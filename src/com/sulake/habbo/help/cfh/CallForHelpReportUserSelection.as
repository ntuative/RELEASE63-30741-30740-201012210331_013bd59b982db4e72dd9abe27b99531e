package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpReportUserSelection extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         this.var_655 = main.component.userRegistry.getRegistry();
         if(this.var_655.length == 0)
         {
         ...
         var i:int = 0;
         while(i < this.var_655.length)
         {
            user = this.var_655.getWithIndex(i);
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc3_ < 0 || _loc3_ > this.var_655.length)
         {
            return;
         }
         var _loc4_:UserRegistryItem = this.var_655.getWithIndex(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_ > -1)
         {
            main.showUI(HabboHelpViewEnum.const_356);
         }
      }
   }
}
