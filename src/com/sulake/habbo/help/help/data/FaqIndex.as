package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_715:FaqCategory;
      ...
      {
         super();
         this.var_717 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_716 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_715 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function dispose() : void
      {
         ...
         if(this.var_140 != null)
         {
            ...
            {
               _loc2_ = this.var_140.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
      ...
      {
         var _loc4_:FaqCategory = this.var_140.getValue(param1);
         if(_loc4_ != null || !param3)
         {
            return _loc4_;
         }
         _loc4_ = new FaqCategory(param1,param2);
         this.var_140.add(param1,_loc4_);
         return _loc4_;
      }
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_715.hasItem(param1))
         {
            this.var_715.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_140.length)
         {
            _loc4_ = this.var_140.getWithIndex(_loc3_);
      ...
      {
         if(param1 >= this.var_140.length)
         {
            return null;
         }
         return this.var_140.getWithIndex(param1);
      }
      ...
      public function getCategoryTitleArray() : Array
      {
         ...
         while(_loc3_ < this.var_140.length)
         {
            _loc2_ = this.var_140.getWithIndex(_loc3_);
            if(_loc2_ != null)
            {
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_715.hasItem(param1))
         {
            return this.var_715.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < this.var_140.length)
         {
            _loc3_ = this.var_140.getWithIndex(_loc2_);
