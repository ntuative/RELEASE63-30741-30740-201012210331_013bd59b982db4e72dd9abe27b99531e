      ...
      override public function render() : void
      {
         ...
         if(container != null)
         {
            ...
            if(_loc1_ != null)
            {
               ...
               _loc1_.addEventListener(WindowKeyboardEvent.const_145,this.windowKeyEventProcessor);
               _loc1_.addEventListener(WindowEvent.const_168,this.onInputClick);
            }
