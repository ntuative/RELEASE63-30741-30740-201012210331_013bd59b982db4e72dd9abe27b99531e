package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1569:int = 0;
      ...
      {
         this.var_334 = this._defaultViewId;
         this.var_483 = new Array();
         this.var_594 = new Array();
         super();
         this._component = param1;
         this._assetLibrary = param2;
         this._windowManager = param3;
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201012210238));
         this._toolbar = param5;
         this.var_97 = new Map();
         this.var_97.add(HabboHelpViewEnum.const_1519,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_186,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_536,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_265,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_237,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_682,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_356,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_744,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_223,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_97.add(HabboHelpViewEnum.const_944,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_97.add(HabboHelpViewEnum.const_1075,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_614,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_483.length == 0 || param1 != this.var_334)
            {
               this.var_483.push(this.var_334);
            }
         }
         this.var_334 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_334);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_223:
               this.showUI(HabboHelpViewEnum.const_223);
               break;
            case CallForHelpResultEnum.const_1086:
               this.showUI(HabboHelpViewEnum.const_1075);
               break;
            case CallForHelpResultEnum.const_1019:
               this.showUI(HabboHelpViewEnum.const_944);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_97.getValue(HabboHelpViewEnum.const_186) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_407));
      }
      ...
      {
         return this.var_97.getValue(this.var_334);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1762 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1763;
         this._window.width = _loc1_.width + this.var_1762;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_483.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_334 == HabboHelpViewEnum.const_186)
         {
            return;
         }
         if(this.var_594.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_594.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_594.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_333.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_594[1],this.var_594[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_594[0],this.var_594[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_334 == HabboHelpViewEnum.const_186 || this.var_483.length == 0)
         {
            return;
         }
         if(this.var_333 == null)
         {
            ...
            this.var_333 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_333.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_333.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_333 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_333 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_333 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
