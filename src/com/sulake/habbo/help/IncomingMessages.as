   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != this._userId && _loc5_.userType == RoomObjectTypeEnum.const_371)
            {
               this._component.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
            if(_loc5_.webID == this._userId)
            {
               this.var_1941 = _loc5_.id;
            }
            _loc4_++;
         }
         this._component.tellUI(HabboHelpViewEnum.const_614);
      }
      ...
      {
         this._component.showUI(HabboHelpViewEnum.const_356);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         this._component.tellUI(HabboHelpViewEnum.const_186);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this._component.tellUI(HabboHelpViewEnum.const_237,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this._component.showUI(HabboHelpViewEnum.const_682);
         this._component.tellUI(HabboHelpViewEnum.const_682,_loc5_);
      }
