package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialMainView implements ITutorialUIView
   {
      ...
      public function TutorialMainView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         if(this.var_45.hasChangedLooks)
         {
            _loc4_.removeListItem(_loc6_);
         }
         else
         ...
         if(this.var_45.hasCalledGuideBot || !(this.var_45.hasChangedName || this.var_45.hasChangedLooks))
         {
            _loc4_.removeListItem(_loc6_);
         }
         else
         ...
         _loc6_.caption = this.var_45.myName;
      ...
      private function setButtonStateNormal(param1:IWindow) : void
      {
         ...
         {
            case "button_name":
               _loc3_ = BitmapDataAsset(this.var_45.assets.getAssetByName("tutorial_button_changename"));
               break;
            case "button_looks":
               _loc3_ = BitmapDataAsset(this.var_45.assets.getAssetByName("tutorial_button_changelooks"));
               break;
            case "button_guidebot":
               _loc3_ = BitmapDataAsset(this.var_45.assets.getAssetByName("tutorial_button_guidebot"));
         }
      ...
      private function setButtonStateOver(param1:IWindow) : void
      {
         ...
         {
            case "button_name":
               _loc3_ = BitmapDataAsset(this.var_45.assets.getAssetByName("tutorial_button_changename_over"));
               break;
            case "button_looks":
               _loc3_ = BitmapDataAsset(this.var_45.assets.getAssetByName("tutorial_button_changelooks_over"));
               break;
            case "button_guidebot":
               _loc3_ = BitmapDataAsset(this.var_45.assets.getAssetByName("tutorial_button_guidebot_over"));
         }
         if(_loc2_ != null && _loc3_ != null && _loc3_.content != null)
         {
            _loc2_.bitmap = (_loc3_.content as BitmapData).clone();
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_looks":
               switch(param1.type)
               {
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
                     this.var_45.showView(TutorialUI.const_325);
                     break;
            ...
            case "button_name":
               ...
               {
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
                     this.var_45.showView(TutorialUI.const_369);
                     break;
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                     this.setButtonStateOver(param2);
                     break;
            ...
            case "button_guidebot":
               ...
               {
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
                     this.var_45.showView(TutorialUI.const_428);
                     break;
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                     this.setButtonStateOver(param2);
                     break;
