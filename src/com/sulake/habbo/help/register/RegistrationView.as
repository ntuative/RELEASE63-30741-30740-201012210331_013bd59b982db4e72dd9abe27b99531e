package com.sulake.habbo.help.register
{
   ...
   public class RegistrationView
   {
      ...
      public function showMainView() : void
      {
         if(!this.var_17)
         {
            this.var_17 = this.createWindow("registration_xml") as IWindowContainer;
            this.var_17.procedure = this.windowEventHandler;
         }
         this.positionMainWindowInTopRight();
         this.showView(this.var_17);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_38.findChildByName("registration_email_address") as ITextFieldWindow;
            _loc4_ = this.var_38.findChildByName("registration_new_password") as ITextFieldWindow;
            _loc5_ = this.var_38.findChildByName("registration_terms_checkbox") as ICheckBoxWindow;
            _loc6_ = this.var_38.findChildByName("registration_merketing_checkbox") as ICheckBoxWindow;
            _loc7_ = this.var_38.findChildByName("registration-email-address-error") as ITextWindow;
            _loc8_ = this.var_38.findChildByName("registration-new-password-error") as ITextWindow;
            _loc7_.text = "";
            _loc8_.text = "";
