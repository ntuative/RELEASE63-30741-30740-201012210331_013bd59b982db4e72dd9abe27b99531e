package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1370:String = "%";
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_603 = this.getKey("url_prefix");
         if(this.var_603 != null && this.var_603.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_603 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function init() : void
      {
         ...
         if(!this.var_735)
         {
            ...
            _loc3_.addEventListener(AssetLoaderEvent.const_43,this.method_5);
         }
      }
      
      private function method_5(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1316);
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_603 = this.getKey("url.prefix");
         if(this.var_603.length > 0)
         {
            externalAccessDomain = this.var_603.replace("http://","");
      ...
      {
         var _loc2_:String = this.var_1119[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_1119[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_603);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         if(param4)
         {
            if(this.var_1119[param1] == null)
            {
               Logger.log(param1 + "=" + param2);
            }
         }
         if(this.var_1770.indexOf(param1) < 0 || param3)
         {
            this.var_1119[param1] = param2;
         }
         if(param3)
         {
            this.var_1770.push(param1);
         }
      }
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1370);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1370,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
