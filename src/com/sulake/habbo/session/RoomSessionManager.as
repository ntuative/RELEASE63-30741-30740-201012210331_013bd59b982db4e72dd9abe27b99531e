package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1581)
         {
            this.gotoRoom(this.var_2136,this.var_2134,this.var_1582);
            this.var_1581 = false;
            this.var_1582 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_201,_loc7_));
         return true;
      }
      
      public function startSession(param1:IRoomSession) : Boolean
      {
         if(param1.state == RoomSessionEvent.const_80)
         {
            return false;
         }
         if(param1.start())
         {
            this.var_1266 = false;
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_80,param1));
      ...
      public function disposeSession(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_87,_loc4_));
            _loc4_.dispose();
         }
      }
