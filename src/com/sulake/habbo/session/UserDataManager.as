package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1166:int = 1;
      ...
      {
         return this.getUserDataByType(param1,const_1166);
      }
      
      public function getUserDataByType(param1:int, param2:int) : IUserData
      {
         var _loc3_:* = null;
         var _loc4_:Map = this.var_658.getValue(param2);
         if(_loc4_ != null)
         {
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_809.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      public function setUserData(param1:IUserData) : void
      {
         ...
         var _loc2_:Map = this.var_658.getValue(param1.type);
         if(_loc2_ == null)
         {
            _loc2_ = new Map();
            this.var_658.add(param1.type,_loc2_);
         }
      ...
      public function removeUserDataByIndex(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_658.getValue(_loc2_.type);
            if(_loc3_ != null)
            {
      ...
      {
         this.var_809.remove(param1);
         this.var_809.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1165);
      }
