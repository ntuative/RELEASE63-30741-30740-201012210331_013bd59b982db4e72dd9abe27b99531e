package com.sulake.habbo.session.handler
{
   ...
   public class VoteHandler extends BaseHandler
   {
      ...
      private function onVoteQuestionEvent(param1:VoteQuestionMessageEvent) : void
      {
         ...
         _loc4_ = new RoomSessionVoteEvent(RoomSessionVoteEvent.const_134,_loc2_,_loc3_.question,_loc3_.choices);
      ...
      private function onVoteResultEvent(param1:VoteResultMessageEvent) : void
      {
         ...
         _loc4_ = new RoomSessionVoteEvent(RoomSessionVoteEvent.const_135,_loc2_,_loc3_.question,_loc3_.choices,_loc3_.votes,_loc3_.totalVotes);
         listener.events.dispatchEvent(_loc4_);
      }
   }
}
