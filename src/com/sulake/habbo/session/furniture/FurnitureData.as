package com.sulake.habbo.session.furniture
{
   public class FurnitureData implements IFurnitureData
   {
      ...
      public static const const_1637:String = "i";
      
      public static const const_1650:String = "s";
      
      public static const const_1598:String = "e";
      ...
      public function FurnitureData(param1:String, param2:int, param3:String, param4:int, param5:int, param6:int, param7:int, param8:int, param9:Array, param10:String, param11:String, param12:String, param13:int, param14:int)
      {
         ...
         this._id = param2;
         this._name = param3;
         this.var_2141 = param4;
         this._revision = param5;
         this.var_2140 = param6;
         this.var_2139 = param7;
         this.var_2142 = param8;
         this.var_1405 = param9;
         this._title = param10;
         this.var_1466 = param11;
         this.var_2143 = param12;
         this.var_2055 = param13;
