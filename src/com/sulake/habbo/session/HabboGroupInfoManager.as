   ...
   public class HabboGroupInfoManager
   {
      ...
      private function onHabboGroupBadges(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.length)
         {
            ...
            if(this.var_244.getValue(_loc4_) != null)
            {
               this.var_244.remove(_loc4_);
            }
            this.var_244.add(_loc4_,_loc3_.getWithIndex(_loc6_));
            _loc6_++;
         }
      }
      ...
      private function onGroupDetails(param1:IMessageEvent) : void
      {
         ...
         _loc3_.badgeId = this.var_244.getValue(_loc2_.groupId);
         this.var_1267[_loc2_.groupId] = _loc3_;
         this._sessionManager.showGroupBadgeInfo(_loc2_.groupId);
      }
      
      public function getBadgeId(param1:int) : String
      {
         return this.var_244.getValue(param1);
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         var _loc2_:HabboGroupDetails = this.var_1267[param1];
         if(_loc2_ == null)
         {
