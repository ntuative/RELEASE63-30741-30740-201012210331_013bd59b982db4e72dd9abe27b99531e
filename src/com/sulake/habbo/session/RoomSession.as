package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1818:int = 2500;
      ...
      private var var_1015:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1015 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1015.connection = param1;
         }
      }
      ...
      {
         if(this._state == RoomSessionEvent.const_201 && this._connection != null)
         {
            this._state = RoomSessionEvent.const_80;
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1269));
         this.var_1268.add(this.var_1269,getTimer());
         ++this.var_1269;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1268.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_1818)
            {
      ...
      {
         return this.var_1015 as IUserDataManager;
      }
