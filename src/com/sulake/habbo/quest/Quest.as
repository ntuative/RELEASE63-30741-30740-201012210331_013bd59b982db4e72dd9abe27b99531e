package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1708:Date;
      
      private var _localizationCode:String;
      
      private var var_182:Boolean = false;
      
      private var var_2326:uint = 2;
      
      private var var_2325:uint = 0;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1527 = param1.roomItemTypeName;
         this.var_1525 = param1.rewardCurrencyAmount;
         this.var_1708 = new Date();
         this.var_1708.setTime(param1.endDateTimeStamp);
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_182)
            {
               this.var_820.style = this.var_2325;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_182)
            {
               this.var_820.style = this.var_2326;
            }
         }
      }
