package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1584:String = "badge_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1643 = param4;
         this.var_1421 = param7;
         this.var_1987 = param5;
         this.var_1860 = param6;
         this._localizations = param10;
         this._assets = param8;
         this.var_375 = param13;
         this._communication = param12;
         param13.events.addEventListener(BadgeImageReadyEvent.const_128,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2624 = this._localizations.getBadgeName(this.var_288);
         this.var_2621 = this._localizations.getBadgeDesc(this.var_288);
         this.var_2625 = this._localizations.getAchievementNameForFacebook(this.var_288,this.var_375.userName,this.var_375.realName,this.var_1420);
         this.var_2623 = this._localizations.getAchievementDescForFacebook(this.var_288,this.var_375.userName,this.var_375.realName,this.var_1420);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2620 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this._localizations.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1643.toString());
         this._localizations.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1421.toString());
         this._localizations.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1421.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1860;
         var _loc17_:String = this.var_1860 == 0 ? "pixels" : "activitypoints";
         this._localizations.registerParameter(_loc16_,_loc17_,"" + this.var_1987);
         _loc15_.caption = this._localizations.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1584);
         ...
         if(this.var_1421 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_288,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_288,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_288,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this._localizations.registerParameter(param1,"badge_name",this.var_2624);
         this._localizations.registerParameter(param1,"badge_desc",this.var_2621);
         this._localizations.registerParameter(param1,"badge_name_fb",this.var_2625);
         this._localizations.registerParameter(param1,"badge_desc_fb",this.var_2623);
         this._localizations.registerParameter(param1,"level",this.var_1420.toString());
         this._localizations.registerParameter(param1,"name",this.var_375.userName);
         return this._localizations.registerParameter(param1,"realname",this.var_375.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_375.events.removeEventListener(BadgeImageReadyEvent.const_128,this.onBadgeImageReady);
            this.var_375 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_288)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1584);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_288,this._feedTitleFb,this.var_2620,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2622));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_288,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_288,"client.skip_post"));
               this.dispose();
               return;
         }
      }
