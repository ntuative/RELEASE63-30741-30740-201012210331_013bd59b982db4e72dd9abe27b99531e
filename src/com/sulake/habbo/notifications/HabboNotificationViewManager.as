package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_555:int = 4;
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_2268,this.var_357,this._toolbar);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_561 < 540;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = const_555;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_203.length)
         {
            _loc3_ = this.var_203[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_561 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_561 + const_555;
            _loc2_++;
         }
         return _loc1_;
      }
