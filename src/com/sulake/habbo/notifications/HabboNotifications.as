package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1187:String = "pixelbalance";
      
      private static const const_1188:String = "badges";
      
      private static const const_1190:String = "selectbadge";
      
      private static const const_1189:String = "inventory";
      
      private static const const_1185:String = "selectfurni";
      
      private static const const_1183:String = "credits";
      
      private static const const_1184:String = "friendlist";
      ...
      private var var_676:IHabboToolbar;
      ...
      private var var_453:HabboNotificationViewManager;
      
      private var var_200:HabboAlertDialogManager;
      
      private var var_677:ParkBusDialogManager;
      
      private var var_2170:Boolean;
      
      private var var_835:ClubGiftNotification;
      
      private var var_834:ClubEndingNotification;
      
      private var var_836:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_837);
         }
         var _loc6_:Map = this.var_837["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_676)
         {
            this.var_676.release(new IIDHabboToolbar());
            this.var_676 = null;
         }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_837["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1035.push(_loc8_);
         return this.var_1035.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1035.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_200 = new HabboAlertDialogManager(this._windowManager,this._localization);
      ...
      {
         this.var_676 = IHabboToolbar(param2);
         this.var_676.events.addEventListener(HabboToolbarEvent.const_69,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_69)
         {
            ...
            this.var_453 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_837["styles"],this.var_837["view"],this.var_676);
            ...
            registerUpdateReceiver(this.var_453,1);
            registerUpdateReceiver(this,2);
            this.var_375.events.addEventListener(BadgeImageReadyEvent.const_128,this.onBadgeImage);
            this.var_676.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1291[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_375);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1291[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1291[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1342);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_375.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1022);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1022);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1511);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_459.createAvatarImage(param2,AvatarScaleType.const_46);
         if(_loc7_ != null)
         {
            _loc7_.setDirection(AvatarSetType.const_42,3);
            _loc4_ = _loc7_.getCroppedImage(AvatarSetType.const_42);
            _loc7_.dispose();
         }
         if(param3 == "")
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = this.var_375.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_78)
               {
                  _loc9_ = this.var_375.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_375.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1488,_loc5_);
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_78:
               ...
               break;
            case CatalogPageMessageProductData.const_253:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1361);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1516)
         {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_836 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function onInfoFeedEnable(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1618 = !_loc2_.enabled;
         }
      }
      
      public function update(param1:uint) : void
      {
         if(this.var_453.isSpaceAvailable() && this.var_1035.length > 0)
         {
            this.var_453.showItem(this.getNextItemFromQueue());
         }
      }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1186:
               if(this._inventory != null && this._inventory.hasRoomSession)
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_154);
               }
               break;
            case const_1185:
               break;
      ...
      {
         if(param1 != null && this.var_453 != null)
         {
            this.var_453.replaceIcon(param1);
         }
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_200 == null)
         {
            return;
         }
         this.var_200.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_200.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_200.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_200.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_200.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_677 == null)
         {
            this.var_677 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_677 != null)
         {
            this.var_677.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_459.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_46);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setDirection(AvatarSetType.const_32,3);
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_42);
         _loc4_.dispose();
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_927,_loc5_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_459.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_46);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2170)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1028);
            this.var_2170 = true;
      ...
      {
         if(param2.type == WindowEvent.const_187 || param2.type == WindowEvent.const_716)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_835 && this.var_835.visible)
         {
            return;
         }
         this.var_835 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1028,_loc6_);
      }
   }
}
