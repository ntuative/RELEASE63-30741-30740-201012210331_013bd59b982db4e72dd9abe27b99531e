package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1706:int = "F".charCodeAt(0);
      
      public static const const_1757:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_637 = param1.online;
         this.var_1714 = param1.followingAllowed && param1.online;
         this.var_546 = param1.figure;
         this.var_1806 = param1.motto;
         this.var_1464 = param1.lastAccess;
         this.var_1228 = param1.categoryId;
         this.var_1462 = param1.realName;
