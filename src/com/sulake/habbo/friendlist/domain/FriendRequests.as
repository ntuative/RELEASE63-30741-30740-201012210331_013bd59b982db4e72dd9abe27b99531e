package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      private var var_360:IFriendRequestsDeps;
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         for each(_loc4_ in _loc2_)
         {
            ...
            if(this.var_360.view != null)
            {
               this.var_360.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         this.refreshShading();
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         _loc2_.state = FriendRequest.const_1103;
         this.var_360.view.refreshRequestEntry(_loc2_);
      }
      ...
      {
         this._requests.push(param1);
         this.var_360.view.addRequest(param1);
      }
      ...
      public function refreshShading() : void
      {
         ...
         {
            _loc1_ = !_loc1_;
            this.var_360.view.refreshShading(_loc2_,_loc1_);
         }
      }
