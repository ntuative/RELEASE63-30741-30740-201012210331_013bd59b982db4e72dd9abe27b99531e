package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1579:String = "no_reqs_info";
      ...
      private var var_1824:IContainerButtonWindow;
      ...
      {
         this.var_1824 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1825 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1825.procedure = this.onDismissAllButtonClick;
         this.var_1824.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_336;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_317;
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_336 && _loc4_.state != FriendRequest.const_317)
            {
               _loc4_.state = FriendRequest.const_317;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_336 && _loc4_.state != FriendRequest.const_317)
            {
               ...
               _loc4_.state = FriendRequest.const_336;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1824,_loc1_);
