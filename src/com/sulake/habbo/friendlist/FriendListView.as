package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1561:String = "noconvinfo";
      
      private static const const_1562:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1350:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1350 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_879 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_227 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1350.prepare(this.var_879);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1030,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_980,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_692,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_789,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_692,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_789,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1349 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1349.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1737 == -1 ? 0 : int(this.var_17.height - this.var_1737);
         var _loc4_:int = this.var_1735 == -1 ? 0 : int(this.var_17.width - this.var_1735);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_227.y = Util.getLowestPoint(this.var_17.content);
         this.var_227.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_889,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_692,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1030,false);
         ...
         this.var_1737 = this.var_17.height;
         this.var_1735 = this.var_17.width;
