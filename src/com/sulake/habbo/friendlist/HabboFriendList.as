package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_143:String = "face";
      ...
      private var var_960:IAvatarRenderManager;
      
      private var var_642:ISessionDataManager;
      
      private var var_1959:FriendListLookAndFeel;
      
      private var var_383:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1473:OpenedToWebPopup;
      
      private var var_1958:int;
      
      var var_91:FriendCategories;
      
      private var var_297:FriendRequests;
      
      private var var_1474:AvatarSearchResults;
      ...
      {
         this.var_1959 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_91 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1474 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_527.stop();
            this.var_527.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_527 = null;
         }
         ...
         if(this.var_123)
         {
            this.var_123.release(new IIDHabboMessenger());
            this.var_123 = null;
         }
         ...
         if(this.var_960)
         {
            this.var_960.release(new IIDAvatarRenderManager());
            this.var_960 = null;
         }
         if(this.var_893)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1473 = new OpenedToWebPopup(this);
         }
         this.var_1473.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_297.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_284,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_960.createAvatarImage(param1,AvatarScaleType.const_81,null,this);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_42);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_123 = param2 as IHabboMessenger;
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_960 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_893 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_297 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_91.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_1023,this.getText("friendlist.friends")));
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_358,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_91.addFriend(new Friend(_loc4_));
         }
         this.var_383 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_527)
         {
            this.var_527 = new Timer(120000);
            this.var_527.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_527.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_109,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_91.findCategory(FriendCategory.const_358);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_383.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_297.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_297.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_383.findTab(FriendListTab.const_90).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_297.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_383.findTab(FriendListTab.const_90);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1474.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_383.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_642 || !this.var_297)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_642.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_297.vipLimit;
         }
         else if(this.var_642.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_297.clubLimit;
         }
         if(_loc2_ > this.var_297.limit)
         {
            this.var_297.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_143) as IBitmapWrapperWindow;
