package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      public function processRoomCanvasMouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomObject, param3:IRoomGeometry) : void
      {
         ...
         if(_loc5_ != RoomObjectCategoryEnum.const_68)
         {
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_129:
               this.handleObjectStateChange(param1 as RoomObjectStateChangeEvent,param2,param3);
               break;
            case RoomObjectStateChangeEvent.const_584:
            ...
            case RoomObjectRoomAdEvent.const_394:
            case RoomObjectRoomAdEvent.const_350:
            case RoomObjectRoomAdEvent.const_377:
               this.handleObjectRoomAdEvent(param1,param2,param3);
               break;
            case RoomObjectRoomActionEvent.const_440:
            case RoomObjectRoomActionEvent.const_1035:
            case RoomObjectRoomActionEvent.const_482:
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            case RoomObjectMouseEvent.const_222:
               ...
               break;
            case RoomObjectMouseEvent.const_464:
               this.handleRoomObjectMouseMove(param1,param2,param3);
               break;
            case RoomObjectMouseEvent.const_486:
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  if(_loc10_ != null)
                  {
                     if(_loc12_)
                     {
                        this.setMouseEventId(RoomObjectCategoryEnum.const_68,MouseEvent.CLICK,_loc10_);
                     }
                     if(_loc13_)
                     {
         ...
         if(_loc8_ == RoomObjectCategoryEnum.const_68)
         {
            ...
            if(_loc14_ != _loc10_ && _loc15_ != _loc10_)
            {
               ...
               if(_loc16_ != null)
               {
                  _loc16_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_492,param2,param3,-1,RoomObjectCategoryEnum.const_152));
               }
      ...
      private function handleRoomObjectMouseMove(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(this._roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               {
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_480);
               }
               _loc8_.getEventHandler().processUpdateMessage(_loc10_);
            }
         }
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc8_ == RoomObjectCategoryEnum.const_27)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_687,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
         ...
         if(_loc6_ == null)
         {
            ...
            if(_loc5_.category == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE)
            {
               if(_loc6_ != null)
               {
                  ...
                  {
                     _loc10_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_751);
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_732));
               break;
            case RoomObjectFurnitureActionEvent.const_405:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_812));
               break;
            case RoomObjectFurnitureActionEvent.const_530:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_469));
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_466:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_567));
               break;
            case RoomObjectFurnitureActionEvent.const_477:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_469));
         }
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc6_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_264);
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_338);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_264);
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_338);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc8_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_264);
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_653);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_1027);
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_300,param2);
         }
      }
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = this._roomEngine.getRoomObject(roomId,roomCategory,this.var_1384,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            ...
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_431));
            }
            else
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_480));
            }
         }
      }
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_751);
         }
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER && _loc3_.typeId == RoomObjectTypeEnum.const_209)
               {
         ...
         {
            this._roomEngine.events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_198,param1,param2,_loc4_,_loc5_));
         }
      }
