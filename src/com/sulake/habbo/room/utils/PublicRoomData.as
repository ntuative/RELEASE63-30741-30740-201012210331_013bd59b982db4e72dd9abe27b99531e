package com.sulake.habbo.room.utils
{
   ...
   public class PublicRoomData
   {
      ...
      private var var_792:Map = null;
      
      public function PublicRoomData(param1:String)
      {
         super();
         this._type = param1;
         this.var_792 = new Map();
      }
      ...
      {
         var _loc2_:PublicRoomWorldData = this.var_792.getValue(param1) as PublicRoomWorldData;
         if(_loc2_ != null)
         {
            return _loc2_.scale;
         }
