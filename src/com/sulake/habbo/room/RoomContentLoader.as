package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_763:String = "RCL_LOADER_READY";
      
      private static const const_310:String = "RCL_PUBLICROOM_";
      
      private static const const_1548:int = 0;
      
      private static const const_846:int = 1;
      
      private static const name_2:int = 2;
      
      private static const const_384:String = "place_holder";
      
      private static const const_548:String = "wall_place_holder";
      
      private static const const_1175:String = const_384;
      
      private static const ROOM_CONTENT:String = "room";
      
      private static const const_847:String = "tile_cursor";
      
      private static const const_845:String = "selection_arrow";
      ...
      private var var_1258:IEventDispatcher = null;
      ...
      private var var_175:PublicRoomData = null;
      ...
      private var var_2101:Array;
      
      private var var_2103:Array;
      ...
      public function RoomContentLoader()
      {
         this.var_551 = [];
         this._wallItems = [];
         this.var_2101 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2103 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_846)
         {
            return;
         }
         this.var_1258 = param1;
         this.var_2104 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2105 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2099 = param2.getKey("public.room.dynamic.download.url","");
         this.var_2100 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         this._state = const_846;
         this.initFurniData();
      }
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = this.var_375.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_449.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_449.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         {
            _loc1_ = this.var_370.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc4_ = this.var_370.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_661.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_550.add(_loc3_,_loc4_);
            ...
            _loc8_ = this.var_552.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_552.remove(_loc7_);
               this.var_552.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2102)
         {
            ...
            {
               this.var_1258.dispatchEvent(new Event(const_763));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_447 != null)
         {
            this.var_447.remove(param2);
            this.var_447.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_448 != null)
         {
            _loc2_ = this.var_448.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_175 != null && (this.var_175.type == param1 || this.var_175.hasWorldType(param1)))
         {
      ...
      {
         return [const_384,const_548,ROOM_CONTENT,const_847,const_845];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_550.getValue(param1) as String;
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_661.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_175 != null && this.var_175.hasWorldType(const_310 + param1))
         {
            return this.var_175.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_176 || param1 == RoomObjectVisualizationEnum.const_66 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            ...
            return int(this.var_552.getValue(param1));
         }
         return 0;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               {
                  _loc10_ = this.var_2100;
                  _loc10_ = _loc10_.replace(/%typeid%/,_loc7_[_loc9_]);
                  _loc8_.push(this.var_2099 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1257.getValue(param1) != null)
         {
            this.var_175 = this.var_1257.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2101.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1438);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2103.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = this.getVisualizationXML(_loc5_);
               _loc8_ = this.extractPublicRoomFromXML(_loc5_,_loc7_);
               this.var_1257.add(_loc5_,_loc8_);
               this.var_175 = _loc8_;
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_473,_loc5_);
         }
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_662.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_662.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_449.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_662.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_449.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_449.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_211 && _loc5_ != RoomObjectLogicEnum.const_176)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_484.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_370.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_370.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_370[_loc2_] != null)
         {
            _loc3_ = this.var_370.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      {
         if(this.getObjectCategory(const_310 + param1) == RoomObjectCategoryEnum.const_68)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_175.getWorldHeightScale(const_310 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_175 != null)
         {
            return this.var_175.getWorldScale(const_310 + param1);
         }
         return 32;
      }
