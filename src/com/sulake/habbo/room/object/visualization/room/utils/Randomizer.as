package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1717:int = 16777216;
      
      private static var _randomizer:Randomizer = null;
       
      
      private var var_1851:int = 1;
      
      private var var_1852:int = 16777216;
      
      private var var_2681:int = 69069;
      
      private var var_2682:int = 5;
      ...
      {
         var _loc1_:int = this.var_2681 * this.var_1851 + this.var_2682;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1852;
         this.var_1851 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1852 * param2);
      }
   }
}
