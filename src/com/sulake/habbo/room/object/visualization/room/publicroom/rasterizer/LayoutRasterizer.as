package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1186:IGraphicAssetCollection;
      ...
      private var var_1312:LayoutRasterizerData = null;
      ...
      {
         if(param1 != this.var_851)
         {
            this.var_851 = param1;
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1312 = this.var_37.getValue(this.var_851);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2220 = new Vector3d(-0.5,0.5,0);
         this.var_852 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2220);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1058.x = _loc3_.x;
         this.var_1058.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_37.getValue(this.var_851);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1651 = RoomObjectVariableEnum.const_1080;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1651 = RoomObjectVariableEnum.const_905;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1059 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1059 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_37.getValue(this.var_851);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2218 && param3 == this.var_2219)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1059 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1059 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1651);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_402;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1312.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_1186.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1058.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1058.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_378.indexOf(_loc10_) >= 0 && this.var_852)
            {
               param1 = this.var_378.indexOf(_loc10_);
               if(this.var_574[param1] != "")
               {
                  _loc9_ = this.var_1186.getAsset(this.var_574[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_573[param1] != -1)
               {
                  param2.alpha = this.var_573[param1];
               }
               this.var_378.splice(param1,1);
               this.var_574.splice(param1,1);
               this.var_573.splice(param1,1);
      ...
      {
         this.var_852 = true;
         var _loc3_:int = this.var_378.indexOf(param1);
         if(_loc3_ < 0)
         {
            this.var_378.push(param1);
            this.var_574.push(param2);
            this.var_573.push(-1);
         }
         else
         {
            this.var_574[_loc3_] = param2;
         }
      }
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_378.push(param1);
            this.var_574.push("");
            this.var_573.push(param2);
         }
         else
         {
            this.var_573[_loc3_] = param2;
         }
      }
   }
}
