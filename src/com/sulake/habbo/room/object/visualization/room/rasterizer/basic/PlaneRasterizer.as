package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_541:String = "HabboInventoryCom_no_trade_icon_png";
       
      
      private var var_1186:IGraphicAssetCollection = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_120 != null)
         {
            ...
            {
               _loc2_ = this.var_120.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc3_ = this.var_315.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
      ...
      private function resetMaterials() : void
      {
         ...
         while(_loc1_ < this.var_315.length)
         {
            _loc2_ = this.var_315.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      private function resetTextures() : void
      {
         ...
         {
            _loc2_ = this.var_178.getWithIndex(_loc1_) as PlaneTexture;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return this.var_178.getValue(param1) as PlaneTexture;
      }
      
      protected function getMaterial(param1:String) : PlaneMaterial
      {
         return this.var_315.getValue(param1) as PlaneMaterial;
      }
      
      protected function getPlane(param1:String) : Plane
      {
         return this.var_120.getValue(param1);
      }
      ...
      protected function addPlane(param1:String, param2:Plane) : Boolean
      {
         ...
         if(this.var_120.getValue(param1) == null)
         {
            this.var_120.add(param1,param2);
            return true;
         }
         return false;
      }
      ...
      private function parseTextures(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            {
               _loc6_ = _loc5_.@id;
               if(this.var_178.getValue(_loc6_) == null)
               {
                  ...
                  this.var_178.add(_loc6_,_loc7_);
               }
            }
            _loc4_++;
         }
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc4_,["id"]))
            {
               ...
               while(_loc8_ < _loc7_.length())
               {
                  ...
                  this.var_315.add(_loc5_,_loc6_);
                  _loc8_++;
               }
            }
            _loc3_++;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc19_ < _loc7_.length)
               {
                  ...
                  _loc21_ = this.var_1186.getAsset(_loc20_);
                  if(_loc21_ != null)
                  {
                     _loc8_.push(_loc21_);
                  }
