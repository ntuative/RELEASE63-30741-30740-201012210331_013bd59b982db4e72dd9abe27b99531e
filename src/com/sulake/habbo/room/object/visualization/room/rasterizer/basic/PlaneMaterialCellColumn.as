package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellColumn
   {
      ...
      public static const const_581:int = 0;
      ...
      public function render(param1:int, param2:IVector3d) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_29 != null)
            {
               if(this.var_29.height == param1 && Vector3d.isEqual(this.var_644,param2))
               {
                  return this.var_29;
               }
               this.var_29.dispose();
