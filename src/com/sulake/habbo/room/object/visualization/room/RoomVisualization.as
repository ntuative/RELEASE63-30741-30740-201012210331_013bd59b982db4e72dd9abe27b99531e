package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1458:int = 16777215;
      
      public static const const_1509:int = 13421772;
      
      private static const const_882:int = 16777215;
      
      private static const const_880:int = 13421772;
      
      private static const const_879:int = 10066329;
      
      private static const const_881:int = 10066329;
      
      public static const const_1298:int = 16777215;
      
      public static const const_1484:int = 13421772;
      ...
      private var var_734:Rectangle = null;
      ...
      private var var_1684:String = null;
      
      private var var_2495:String = null;
      
      private var var_1118:uint = 16777215;
      
      private var var_2494:int = 255;
      
      private var var_2496:int = 255;
      
      private var var_2497:int = 255;
      ...
      private const const_1845:int = 250;
      
      private var var_1557:int = -1;
      
      private var var_1287:Number = 0.0;
      
      private var var_2166:Number = 0.0;
      
      private var var_2169:Number = 0.0;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_734 = super.boundingRectangle;
         }
         return new Rectangle(this.var_734.x,this.var_734.y,this.var_734.width,this.var_734.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1011);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_158)
            {
               ...
               {
                  _loc13_.color = const_880;
               }
               else
               {
                  _loc13_.color = const_879;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1419)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_107,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1845 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_336.length)
            {
               _loc10_ = this.var_602[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_336[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_93)
               {
                  if(this.var_1769)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2497 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2496 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2494 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1557)
         {
            this.var_1557 = param1.updateId;
            this.var_734 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1287 || _loc3_.y != this.var_2166 || _loc3_.z != this.var_2169 || param1.scale != this.var_2167))
            {
               this.var_1287 = _loc3_.x;
               this.var_2166 = _loc3_.y;
               this.var_2169 = _loc3_.z;
               this.var_2167 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1021);
            if(_loc3_ != this.var_2495)
            {
            ...
            if(_loc4_ != this.var_1118)
            {
               this.var_1118 = _loc4_;
               this.var_2497 = this.var_1118 & 255;
               this.var_2496 = this.var_1118 >> 8 & 255;
               this.var_2494 = this.var_1118 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_942));
            if(_loc5_ != this.var_1769)
            {
               this.var_1769 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_214 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_750);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_676);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_663);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_770));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_765));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_677));
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_336;
         if(this.var_336.length == 0)
         {
            _loc6_ = this.var_120;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_336.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_336.push(_loc12_);
                        this.var_602.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1479;
      }
         ...
         while(_loc8_ < this.var_491.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_120.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_107 || _loc3_.type == RoomPlane.const_93)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_107 || _loc3_.type == RoomPlane.const_93 && _loc12_ == RoomPlaneBitmapMaskData.const_257)
                              {
