   ...
   public class PlaneVisualizationLayer implements IDisposable
   {
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean) : BitmapData
      {
         ...
         if(this._material != null)
         {
            if(_loc9_)
            {
               _loc10_ = this._material.render(null,param2,param3,param4,param5,this.offset,this.align == const_101);
            }
            else
            {
               _loc10_ = this._material.render(param1,param2,param3,param4,param5,this.offset,this.align == const_101);
            }
