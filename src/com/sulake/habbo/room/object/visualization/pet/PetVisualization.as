package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private const const_1824:int = 3;
      ...
      private var var_1663:Number = NaN;
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_465.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_465.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_380 = new ExperienceData(this.var_578);
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_1665 = param1.getNumber(RoomObjectVariableEnum.const_489) > 0;
            this.var_1320 = param1.getString(RoomObjectVariableEnum.const_281);
            this.var_230 = param1.getString(RoomObjectVariableEnum.const_425);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_809);
            this.var_1663 = param1.getNumber(RoomObjectVariableEnum.const_379);
            this.var_1332 = param1.getNumber(RoomObjectVariableEnum.const_911);
            this.var_1949 = param1.getNumber(RoomObjectVariableEnum.const_1054);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_175);
            if(this.var_546 != _loc3_)
            {
               this.var_546 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_350 != param1.getUpdateID() || this.var_1557 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1663;
            if(isNaN(this.var_1663))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_1660 || param3)
            {
               this.var_1660 = _loc4_;
               _loc4_ -= 112.5;
               _loc4_ = (_loc4_ + 360) % 360;
               this.var_55.setDirectionAngle(AvatarSetType.const_32,_loc4_);
            }
            if(_loc5_ != this.var_1664 || param3)
            {
               this.var_1664 = _loc5_;
               _loc5_ -= 112.5;
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         var _loc3_:IAvatarImage = this.var_465.getValue(_loc2_) as IAvatarImage;
         if(_loc3_ == null)
         {
            _loc3_ = this.var_578.getAvatar(this.var_546,param1,this);
            if(_loc3_ != null)
            {
               this.var_465.add(_loc2_,_loc3_);
            }
         }
         return _loc3_;
      }
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc9_ || _loc6_ != var_215 || this.var_55 == null)
         {
            if(_loc6_ != var_215)
            {
               var_215 = _loc6_;
         ...
         var _loc11_:Boolean = this.var_872 || this.var_1069 > 0 || this.var_1692;
         this.var_380.alpha = 0;
         if(this.var_1332 > 0)
         {
            _loc12_ = param2 - this.var_1332;
            if(_loc12_ < AvatarAction.const_1096)
            {
               this.var_380.alpha = int(Math.sin(_loc12_ / 0 * 0) * 255);
               this.var_380.setExperience(this.var_1949);
               this.var_1069 = this.const_1824;
            }
            else
            {
               this.var_1332 = 0;
            ...
            if(_loc13_ != null)
            {
               ...
               {
                  _loc13_.asset = this.var_380.image;
                  _loc13_.offsetX = -20;
                  _loc13_.offsetY = -80;
                  _loc13_.alpha = this.var_380.alpha;
         ...
         if(_loc10_ || _loc11_)
         {
            ...
            _loc13_ = getSprite(this.const_854);
            if(_loc13_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1320 != null && this.var_1320 != "")
         {
            param1.appendAction(AvatarAction.const_277,this.var_1320);
         }
