   ...
   public class AnimationSizeData extends SizeData
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_330 != null)
         {
            ...
            {
               _loc2_ = this.var_330.getWithIndex(_loc1_) as AnimationData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineAnimations(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            this.var_330.add(_loc7_,_loc8_);
            _loc5_++;
         }
         return true;
      }
      ...
      {
         if(this.var_330.getValue(param1) != null)
         {
            return true;
         }
         return false;
      ...
      {
         var _loc2_:AnimationData = this.var_330.getValue(param1) as AnimationData;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc5_:* = null;
         var _loc4_:AnimationData = this.var_330.getValue(param2) as AnimationData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc6_:AnimationData = this.var_330.getValue(param2) as AnimationData;
         if(_loc6_ != null)
         {
