   ...
   public class AnimationLayerData
   {
      ...
      public function calculateLength() : void
      {
         ...
         while(_loc1_ < this.var_199.length)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_371 += _loc2_.frameCount;
            }
            _loc1_++;
         }
      }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         if(!this.var_1602)
         {
            _loc4_ = param1 / this.var_371;
            param1 %= this.var_371;
            if(this._loopCount > 0 && _loc4_ >= this._loopCount || this._loopCount <= 0 && this.var_371 == 1)
            {
               param1 = this.var_371 - 1;
               _loc3_ = true;
            }
            _loc5_ = 0;
            _loc6_ = 0;
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:Boolean, param4:int) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc10_ = false;
            if(!this.var_1602 && !param2.isRandom)
            {
