package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_274.assign(param2);
         this.var_273 = new Vector3d();
         this.var_273.assign(param3);
         this.var_675 = new Vector3d();
         this.var_675.assign(param2);
         this.var_674 = new Vector3d();
         this.var_674.assign(param3);
      ...
      {
         if(param1 != this.var_2165)
         {
            if(!param1)
            {
               this.var_274.assign(this.var_675);
               this.var_273.assign(this.var_674);
            }
            else
            {
               this.var_274.assign(this.var_675);
               this.var_274.mul(this.var_674.length / this.var_675.length);
               this.var_273.assign(this.var_674);
               this.var_273.mul(this.var_675.length / this.var_674.length);
            }
            this.var_1557 = -1;
            this.var_1287 = this.var_1287 - 1;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = Number(this.var_274.length * param1.scale);
            _loc6_ = Number(this.var_273.length * param1.scale);
            if(_loc5_ < 1)
            {
               _loc5_ = 1;
            }
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_75 == null && this.var_1034 != null || this.var_274 == null || this.var_273 == null || this.var_557 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1557)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1287 || _loc4_.y != this.var_2166 || _loc4_.z != this.var_2169 || param1.scale != this.var_2167))
            {
               this.var_1287 = _loc4_.x;
               this.var_2166 = _loc4_.y;
               this.var_2169 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1034);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_135.z - _loc7_,this.var_103.z - _loc7_,this.var_81.z - _loc7_,this.var_104.z - _loc7_);
               this.var_2168 = _loc8_;
