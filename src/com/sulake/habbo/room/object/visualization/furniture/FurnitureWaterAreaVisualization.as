package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1160:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_978)
            {
      ...
      {
         if(this.var_2026 == param1 && this.var_2025 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(_loc2_,_direction,param1) == const_1160)
            {
               this.var_1521 = _loc2_;
               this.var_2026 = param1;
               this.var_2025 = _direction;
               return this.var_1521;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_978.indexOf(_loc2_) < 0)
            {
               this.var_978.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_439 + 2;
         var _loc4_:int = this.var_539 + 2;
         var _loc5_:int = 0;
         ...
         this.var_1520 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_365.length)
         {
            if(this.var_365[_loc5_] == true)
            {
               this.var_1520 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_538[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_538[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_439 == 0 || this.var_539 == 0)
         {
            ...
            this.var_439 = _loc2_.getNumber(RoomObjectVariableEnum.const_264);
            this.var_539 = _loc2_.getNumber(RoomObjectVariableEnum.const_338);
         }
         this.var_365 = [];
         this.var_538 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_439 * 2 + this.var_539 * 2)
         {
            this.var_365.push(false);
            this.var_538.push(ShoreMaskCreatorUtility.const_73);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_439 + 2;
         var _loc2_:int = this.var_539 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_65,getSize(param3),this.var_365,this.var_538,assetCollection);
      }
