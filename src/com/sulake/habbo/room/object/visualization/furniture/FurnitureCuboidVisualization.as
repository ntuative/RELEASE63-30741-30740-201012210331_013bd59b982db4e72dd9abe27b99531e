   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_120 != null)
         {
            ...
            {
               _loc2_ = this.var_120[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc3_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_264);
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_338);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_653);
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         while(_loc5_ < this.var_120.length)
         {
            ...
            _loc9_ = this.var_120[_loc5_] as FurniturePlane;
            if(_loc9_ != null)
            {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + this.var_1479;
               }
