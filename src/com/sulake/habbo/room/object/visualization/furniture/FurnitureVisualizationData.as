package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public static const const_908:Array = new Array("a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z");
      ...
      private var var_795:SizeData = null;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         if(_loc2_ < this._sizes.length)
         {
            this.var_795 = this.var_261.getValue(String(this._sizes[_loc2_])) as SizeData;
         }
         else
         {
            this.var_795 = null;
