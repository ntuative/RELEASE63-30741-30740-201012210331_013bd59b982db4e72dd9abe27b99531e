   ...
   public class AnimationData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_100 != null)
         {
            ...
            {
               _loc2_ = this.var_100.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function getStartFrame() : int
      {
         ...
         return Math.random() * this.var_371;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         this.var_100.add(param1,_loc6_);
         var _loc11_:int = _loc6_.frameCount;
         if(_loc11_ > this.var_371)
         {
            this.var_371 = _loc11_;
         }
         return true;
      }
      ...
      {
         var _loc3_:AnimationLayerData = this.var_100.getValue(param1) as AnimationLayerData;
         if(_loc3_ != null)
         {
      ...
      {
         var _loc5_:AnimationLayerData = this.var_100.getValue(param1) as AnimationLayerData;
         if(_loc5_ != null)
         {
