package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1534:Number = Math.sqrt(0.5);
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_1475 != spriteCount)
         {
            createSprites(this.var_1475);
         }
         var _loc4_:Boolean = false;
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_1043:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_899:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_350 != _loc3_.getUpdateID() || param1 != var_215 || param2 != this.var_2638)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(var_214 != _loc3_.getUpdateID())
         {
            this.var_2639 = _loc3_.getNumber(RoomObjectVariableEnum.const_250);
            ...
            this.var_1178 = _loc3_.getString(RoomObjectVariableEnum.const_319);
            if(this.var_1178 == null || this.var_1178.indexOf("http") != 0)
            {
               this.var_1178 = null;
            }
            var_214 = _loc3_.getUpdateID();
            return true;
         }
         return false;
      }
      ...
      {
         if(this.var_2381 != param1 || this.var_2380 != param2)
         {
            this.var_883 = [];
            this.var_884 = [];
            this.var_710 = [];
            ...
            this.var_1475 = this._data.getLayerCount(param2) + 1;
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param1 >= FurnitureVisualizationData.const_908.length)
         {
            return "";
         }
         var _loc3_:String = this.var_883[param1];
         var _loc4_:Boolean = this.var_884[param1];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param1 < spriteCount - 1)
            {
               _loc6_ = FurnitureVisualizationData.const_908[param1];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_883[param1] = _loc3_;
            this.var_884[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_712[param1] != null && !this.var_1740)
         {
