package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1712:Number = 0.0;
      
      private var var_1076:Number = 0.0;
      
      private var var_121:Number = 0.0;
      
      private var var_783:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_138.push(_loc4_);
            _loc3_++;
         }
         this._width = param1;
         this._height = param2;
         this.var_474 = this._width;
         this.var_473 = -1;
         this.var_472 = this._height;
         this.var_471 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         {
            _loc4_ = this.var_138[param2] as Array;
            _loc4_[param1] = param3;
            if(param3 >= 0)
            {
               if(param1 < this.var_474)
               {
                  this.var_474 = param1;
               }
               if(param1 > this.var_473)
               {
                  this.var_473 = param1;
               }
               if(param2 < this.var_472)
               {
                  this.var_472 = param2;
               }
            ...
            {
               if(param1 == this.var_474 || param1 == this.var_473)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_472;
               ...
               if(param2 == this.var_472 || param2 == this.var_471)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_474;
                  while(_loc8_ < this.var_473)
                  {
      ...
      public function getTileHeight(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_138[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         var _loc7_:* = null;
         var _loc8_:int = 0;
         var _loc2_:Point = findEntranceTile(this.var_138);
         var _loc3_:int = 0;
         if(_loc2_ != null)
         {
         ...
         this.var_783 = getFloorHeight(this.var_138);
         if(!param1)
         {
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < this.var_138.length)
         {
            _loc4_ = this.var_138[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      {
         var _loc11_:* = null;
         this.addPlane(RoomPlaneData.const_158,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_268,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -this.var_1076);
         this.addPlane(RoomPlaneData.const_158,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_158,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_121) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_158,Vector3d.sum(param1,Vector3d.product(param3,-this.var_121 / param3.length)),Vector3d.product(param3,(param3.length + this.var_121) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_1076 / param2.length);
               this.addPlane(RoomPlaneData.const_158,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      {
         if(param1 == null || this.var_138 == null || param1 == this.var_138)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > this.var_138.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = this.var_138[_loc3_] as Array;
      ...
      {
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_160,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_160,_loc13_,new Vector3d(0,0,-this.var_121),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_121,param8);
                  }
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param9,this.var_121,param9);
                  }
               }
            }
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_160,_loc13_,new Vector3d(0,0,-this.var_121),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,0,this.var_121,param9);
                  }
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param8,this.var_121,param8);
                  }
               }
            }
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_160,_loc13_,new Vector3d(0,0,-this.var_121),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_121,param11);
                  }
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param10,this.var_121,param10);
                  }
               }
            }
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_160,_loc13_,new Vector3d(0,0,-this.var_121),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,0,this.var_121,param10);
                  }
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param11,this.var_121,param11);
                  }
               }
            }
         }
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_120[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1006;
         }
         var _loc2_:RoomPlaneData = this.var_120[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_120[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
