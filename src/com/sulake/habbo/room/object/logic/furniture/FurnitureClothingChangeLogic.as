package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureClothingChangeLogic extends FurnitureLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         var _loc2_:String = object.getModel().getString(RoomObjectVariableEnum.const_86);
      ...
      private function updateClothingData(param1:String) : void
      {
         ...
         if(param1 != null && param1.length > 0)
         {
            ...
            if(_loc2_.length > 0)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_989,_loc2_[0]);
            }
            if(_loc2_.length > 1)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_997,_loc2_[1]);
            }
         }
      }
