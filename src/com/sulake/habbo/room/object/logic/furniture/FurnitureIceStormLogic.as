package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_1469 = _loc2_;
            this.var_2202 = param1.extra;
            this.var_1051 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1051 > 0 && param1 >= this.var_1051)
         {
            this.var_1051 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1469,String(this.var_1469),this.var_2202);
