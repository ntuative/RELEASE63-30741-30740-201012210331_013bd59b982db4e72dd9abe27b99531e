package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureStickieLogic extends FurnitureLogic
   {
      ...
      private function setColorIndexFromItemData() : void
      {
         ...
         if(object != null)
         {
            _loc1_ = object.getModel().getString(RoomObjectVariableEnum.const_86);
            ...
            object.getModelController().setNumber(RoomObjectVariableEnum.const_250,_loc3_ + 1);
         }
      }
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  _loc5_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_449,_loc3_,_loc4_);
                  if(_loc5_ != null)
                  {
