package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         super();
         moveUpdateInterval = const_576;
         this.var_1700 = new Vector3d();
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.state > 0)
            {
               moveUpdateInterval = const_576 / this.getUpdateIntervalValue(_loc3_.state);
            }
            else
            {
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1700.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1700).length == 0)
            {
