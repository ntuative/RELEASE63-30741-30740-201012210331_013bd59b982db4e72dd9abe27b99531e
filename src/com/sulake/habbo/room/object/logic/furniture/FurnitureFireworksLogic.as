   ...
   public class FurnitureFireworksLogic extends FurnitureLogic
   {
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               ...
               {
                  case "start_stop":
                     _loc6_ = new RoomObjectStateChangeEvent(RoomObjectStateChangeEvent.const_129,_loc3_,_loc4_,1);
                     break;
                  case "reset":
                     _loc6_ = new RoomObjectStateChangeEvent(RoomObjectStateChangeEvent.const_129,_loc3_,_loc4_,2);
               }
         }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.setString(RoomObjectVariableEnum.const_990,String(_loc2_));
            }
         }
      }
   }
