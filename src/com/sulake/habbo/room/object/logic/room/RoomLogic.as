package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1558:int = 255;
      
      private var var_1404:uint = 16777215;
      
      private var var_1841:int = 255;
      
      private var var_1151:uint = 16777215;
      
      private var var_1843:int = 255;
      
      private var var_1150:int = 0;
      
      private var var_1842:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_770,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_765,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_677,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1150)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1558;
            if(_loc2_ - this.var_1150 >= this.var_1842)
            {
               _loc3_ = this.var_1151;
               _loc4_ = this.var_1843;
               this.var_1150 = 0;
            }
            else
            {
               _loc7_ = this.var_1404 >> 16 & 255;
               _loc8_ = this.var_1404 >> 8 & 255;
               _loc9_ = this.var_1404 & 255;
               _loc10_ = this.var_1151 >> 16 & 255;
               _loc11_ = this.var_1151 >> 8 & 255;
               _loc12_ = this.var_1151 & 255;
               _loc13_ = (_loc2_ - this.var_1150) / this.var_1842;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1841 + (this.var_1843 - this.var_1841) * _loc13_;
               this._color = _loc3_;
               this.var_1558 = _loc4_;
            }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_704:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_570:
               param2.setString(RoomObjectVariableEnum.const_750,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_648:
               param2.setString(RoomObjectVariableEnum.const_663,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_522:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_257)
               {
                  _loc5_ = "null";
               }
               this.var_491.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_572:
               _loc4_ = this.var_491.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_491.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1021,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1099:
               param2.setNumber(RoomObjectVariableEnum.const_770,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1058:
               param2.setNumber(RoomObjectVariableEnum.const_765,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_677,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_942,int(param1.bgOnly));
         this.var_1404 = this._color;
         this.var_1841 = this.var_1558;
         this.var_1151 = _loc3_;
         this.var_1843 = _loc4_;
         this.var_1150 = getTimer();
         this.var_1842 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_520,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1355,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1387,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1457,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_520,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_160)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_158 || _loc13_ == RoomPlaneData.const_268)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
