package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1852:String = "type_sound_machine";
      
      private const const_1583:String = "type_jukebox";
      
      private var var_586:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_671,this.onSongFinishedPlayingEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_732,this.onSoundMachinePlayEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_812,this.onSoundMachineStopEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_567,this.onJukeboxInitEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_469,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_671,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_89)
            {
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_732,this.onSoundMachinePlayEvent);
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_812,this.onSoundMachineStopEvent);
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_567,this.onJukeboxInitEvent);
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_469,this.onDisposeEvent);
               this.var_89 = null;
            }
            if(this.var_406)
            {
      ...
      {
         this.startPlaying(this.const_1852);
      }
      ...
      {
         this.startPlaying(this.const_1583);
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_406[this.var_284] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_406.getValue(this.var_284) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_284 = param1;
         var _loc2_:IHabboSound = this.var_406.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_586.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_586.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_284)
         {
            _loc6_ = this.var_406[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1835 == this.const_1583)
         {
            this.var_76.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_620.indexOf(param1) == -1)
         {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_620 = this.var_620.splice(this.var_620.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_406[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_586.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_406.add(_loc3_.id,_loc7_);
            }
