   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_157,this.onFigureUpdate);
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_141,this.onPetInfo);
         ...
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_157,this.onFigureUpdate);
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_141,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_726.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_726.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_746);
         _loc1_.push(RoomWidgetUserActionMessage.const_793);
         _loc1_.push(RoomWidgetUserActionMessage.const_742);
         _loc1_.push(RoomWidgetUserActionMessage.const_404);
         _loc1_.push(RoomWidgetUserActionMessage.const_699);
         _loc1_.push(RoomWidgetUserActionMessage.const_791);
         _loc1_.push(RoomWidgetUserActionMessage.const_616);
         _loc1_.push(RoomWidgetUserActionMessage.const_773);
         _loc1_.push(RoomWidgetUserActionMessage.const_573);
         _loc1_.push(RoomWidgetFurniActionMessage.const_296);
         _loc1_.push(RoomWidgetFurniActionMessage.const_585);
         _loc1_.push(RoomWidgetFurniActionMessage.const_578);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_731);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_810);
         _loc1_.push(RoomWidgetUserActionMessage.const_504);
         _loc1_.push(RoomWidgetUserActionMessage.const_802);
         _loc1_.push(RoomWidgetUserActionMessage.const_539);
         _loc1_.push(RoomWidgetUserActionMessage.const_1436);
         _loc1_.push(RoomWidgetPetCommandMessage.const_784);
         _loc1_.push(RoomWidgetPetCommandMessage.const_817);
         _loc1_.push(RoomWidgetUserActionMessage.const_448);
         _loc1_.push(RoomWidgetUserActionMessage.const_348);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_504)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_348 || param1.type == RoomWidgetUserActionMessage.const_448 || param1.type == RoomWidgetUserActionMessage.const_539)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_448:
               ...
               break;
            case RoomWidgetUserActionMessage.const_746:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1082,_loc3_.name);
               this._container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_793:
            ...
            case RoomWidgetUserActionMessage.const_742:
               ...
               break;
            case RoomWidgetUserActionMessage.const_404:
               this._container.roomSession.kickUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_699:
               this._container.roomSession.banUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_791:
               this._container.roomSession.assignRights(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_616:
               this._container.roomSession.removeRights(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_773:
            ...
            case RoomWidgetUserActionMessage.const_348:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_731:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_810:
            ...
            case RoomWidgetUserActionMessage.const_504:
               ...
               break;
            case RoomWidgetUserActionMessage.const_802:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_803);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_355);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_916);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_915);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_209)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_371)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_887)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_505);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_221)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_207)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_727);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1306;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1034;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1037;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1401);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_726.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_46);
            this.var_726.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_727);
