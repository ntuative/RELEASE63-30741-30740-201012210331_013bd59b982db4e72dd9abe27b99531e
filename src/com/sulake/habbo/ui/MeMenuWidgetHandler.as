   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_651,this.onFigureUpdate);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_510,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_651,this.onFigureUpdate);
            this._container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_164,this.onCreditBalance);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_960,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1040,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_510,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1224)
            {
               ...
               this.var_1224 = _loc3_;
               this.var_1497 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1497;
            }
         }
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_888,HabboToolbarIconEnum.MEMENU);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_806);
         _loc1_.push(RoomWidgetDanceMessage.const_596);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_639);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_602);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_787);
         _loc1_.push(RoomWidgetStopEffectMessage.const_735);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1381);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_948);
         _loc1_.push(RoomWidgetToolbarMessage.const_583);
         _loc1_.push(RoomWidgetToolbarMessage.const_748);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_332);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1437);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1112);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_672);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_725);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_759);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1335);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_779);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_708);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_579);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_370);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_725:
               ...
               break;
            case RoomWidgetWaveMessage.const_806:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_596:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_639:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_712:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_787:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_950)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_179,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_602:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_991:
                        this._catalog.openCatalogPage(CatalogPageName.const_1304,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1036:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_261);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1505:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_77);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1454:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_735:
            ...
            case RoomWidgetNavigateToRoomMessage.const_948:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_672:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_583:
               ...
               break;
            case RoomWidgetToolbarMessage.const_748:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_529,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_332:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_524));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_759:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_365,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_779:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_365,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_708:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_365,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_579:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_453));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_370:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_739));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_589));
      }
