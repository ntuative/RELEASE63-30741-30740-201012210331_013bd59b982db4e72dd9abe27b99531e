package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_1107:Number = 0.0;
      
      private var var_724:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_384 != null)
         {
            ...
            {
               _loc2_ = this.var_384.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_685,RoomWidgetChatSelectAvatarMessage.const_683];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_685:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_683:
      ...
      {
         return [RoomSessionChatEvent.const_166];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_166:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_209)
                           {
                              _loc13_ = this.var_384.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_209:
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          _loc13_ = _loc17_.getCroppedImage(AvatarSetType.const_42);
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_209)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_384.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    this.var_385.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1107 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1107);
            }
            if(this.var_724 == null)
            {
               ...
               this.var_482.y = 0;
               this.var_482.z = 0;
               this.var_724 = _loc4_.getScreenPoint(this.var_482);
               this.var_1107 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_482.x = 0;
            this.var_482.y = 0;
            this.var_482.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_482);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_724.x || _loc8_.y != this.var_724.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_724,_loc5_));
