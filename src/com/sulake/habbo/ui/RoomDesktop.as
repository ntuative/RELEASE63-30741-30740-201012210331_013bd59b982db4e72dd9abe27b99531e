package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1002:IRoomWidgetFactory = null;
      
      private var var_375:ISessionDataManager = null;
      
      private var var_18:IRoomSessionManager = null;
      
      private var var_459:IAvatarRenderManager = null;
      ...
      private var var_2604:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_185 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_320,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_473,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_680,this.onRoomContentLoaded);
         }
      }
      ...
      {
         this.var_185.setLayout(param1,this._windowManager);
         if(this._toolbar != null)
         {
            this.var_185.toolbarSize = this._toolbar.size;
            this.var_185.toolbarOrientation = this._toolbar.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_504.length)
            {
               _loc6_ = this.var_504.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_320,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_473,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_680,this.onRoomContentLoaded);
         }
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_30 != null)
         {
            this.var_753 = this._roomEngine.loadRoomResources(this.var_30.roomResources);
            if(this.var_753.length > 0)
            {
               this.var_1848 = false;
               this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_94));
            }
         }
         if(this.var_267 != null && this.var_30.state == RoomSessionEvent.const_201)
         {
            this.var_1849 = !this.var_267.showInterstitial();
         }
      ...
      {
         if(this.var_753 == null || this.var_753.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_753.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_753.splice(_loc2_,1);
         }
         if(this.var_753.length == 0)
         {
            this.var_1848 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1002.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_185.addWidgetWindow(_loc2_.mainWindow);
         ...
         switch(param1)
         {
            ...
            case RoomWidgetEnum.const_526:
               ...
               break;
            case RoomWidgetEnum.const_785:
               _loc3_ = new ConversionPointWidgetHandler();
         }
         if(_loc3_ != null)
         {
            _loc3_.container = this;
            if(!this.var_504.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
            _loc6_ = null;
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_755.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_755.add(_loc9_,_loc6_);
                  }
                  else
                  {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = this.var_754.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_754.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc3_);
               }
            }
         ...
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,this.var_185.roomViewRect);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_755.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_691:
               ...
               if(this.var_815 != null && _loc3_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER)
               {
                  _loc7_ = this.var_30.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_371)
                  {
                     this.var_815.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_492:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_244,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_687:
               if(!this.var_30.isRoomController && !this.var_375.isAnyRoomController)
               {
                  return;
               }
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_509:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_112,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineEvent.const_438:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_1049,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc21_:* = null;
         var _loc2_:Rectangle = this.var_185.roomViewRect;
         var _loc3_:int = _loc2_.width;
         var _loc4_:int = _loc2_.height;
         var _loc5_:int = 0;
         if(this.var_285.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_571);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_662);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_729);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_594);
         ...
         this.var_185.addRoomView(_loc9_);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2604);
      ...
      {
         var _loc3_:IWindowContainer = this.var_185.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getRoomViewRect() : Rectangle
      {
         ...
         return this.var_185.roomViewRect;
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            this._roomEngine.handleRoomCanvasMouseEvent(this.var_285[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this._roomEngine.modifyRoomCanvas(this.var_30.roomId,this.var_30.roomCategory,this.var_285[0],_loc2_.width,_loc2_.height);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.var_185.toolbarOrientation = param1.orientation;
         }
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1850) / 1000);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < this.var_504.length)
         {
            _loc2_ = this.var_504.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         if(this.var_18 != null && this.var_30 != null && this.var_1849 && this.var_1848)
         {
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_478:
               ...
               this.var_213 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_378,WindowStyle.const_701,WindowParam.const_88) as IToolTipWindow;
               this.var_213.setParamFlag(WindowParam.const_28,false);
