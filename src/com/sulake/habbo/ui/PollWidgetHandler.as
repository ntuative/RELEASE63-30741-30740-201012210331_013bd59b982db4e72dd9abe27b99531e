package com.sulake.habbo.ui
{
   ...
   public class PollWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetPollMessage.ANSWER,RoomWidgetPollMessage.const_395,RoomWidgetPollMessage.const_670];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPollMessage.const_670:
               this._container.roomSession.sendPollStartMessage(_loc2_.id);
               break;
            case RoomWidgetPollMessage.const_395:
